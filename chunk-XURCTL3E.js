import"./chunk-LQ6M4NCU.js";var o=`<tui-doc-page
    header="InputDateTime"
    package="KIT"
    type="components"
>
    <ng-template pageTab>
        <code>InputDateTime</code>
        =
        <code>Textfield</code>
        +
        <code>Calendar</code>
            ...
            <ng-template #description>
                @switch ($index) {
                    @case (1) {
                        ...
                        <code>Calendar</code>
                        specific properties: disable adjacent months days, adds circled colored markers to some days,
                        control initial opened month and etc. Explore
                        <a
                            target="_blank"
                            tuiLink
                        ...
                        >
                            ...
                            <div>
                                ...
                                <code>&lt;input tuiInputDateTime\xA0/&gt;</code>
                                and
                    ...
                    @case (4) {
                        By default component works with our internal types called
                        <code>TuiDay</code>
                        and
                        <code>TuiTime</code>
                    ...
                    @case (6) {
                        Use
                        <code>[tuiTimeFormat]</code>
                        directive (or
                        <code>tuiTimeFormatProvider</code>
                        ) to customize time part: pass
                        <code>dayPeriod</code>
                        with a tuple of two locale-specific markers to switch to a 12-hour format and
                        <code>separators</code>
                        to replace the characters between time segments.
                    }
                    @case (7) {
                        @if (!isMobile) {
                            <div tuiNotification>
                                Open this on a mobile device or enable emulation in DevTools and refresh the page to
                                explore this example!
                            </div>
                        }
                        <p>
                            You can use several different approaches to optimize UX on mobile devices when tapping the
                            icon.
                        </p>
                    }
                    @case (8) {
                        Individual disabled dates still can be typed in manually or picked on mobile in native picker
                        but control will be automatically marked as invalid
                    }
                    @case (9) {
    ...
    <ng-template pageTab>
            ...
            <ng-template>
                ...
                >
                    ...
                    <input
                        ...
                        [tuiTimeFormat]="{dayPeriod: timeFormatDoc.dayPeriod(), separators: timeFormatDoc.separators()}"
                    />
        ...
        <table tuiDocAPI>
            <tr
                ...
                [items]="timeModeVariants"
                [(value)]="timeMode"
            >
                time format mode for SS and MS support
            </tr>

            <tr
                name="[min]"
                tuiDocAPIItem
                type="TuiDay | [TuiDay, TuiTime] | null"
                [items]="dates"
                [(value)]="min"
            >
                min date
