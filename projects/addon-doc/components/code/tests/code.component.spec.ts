...
describe('TuiDocCodeComponent', () => {
    ...
    <div class="t-code-actions">
        <button tuiappearance="" tuiicons="" tuiiconbutton="" appearance="icon" size="xs" class="t-copy-button" data-appearance="icon" style="--t-icon-start: url(assets/taiga-ui/icons/copy.svg); --t-icon-end: url();" data-size="xs">
        </button>
\t
