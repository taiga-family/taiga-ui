...
describe('TuiDocCodeComponent', () => {
    ...
    <div class="t-code-actions">
        <button tuiappearance="" tuiicons="" type="button" tuiiconbutton="" appearance="outline-grayscale" size="s" title="Copy" class="t-copy-button" data-appearance="outline-grayscale" style="--t-icon-start: url(assets/taiga-ui/icons/copy.svg);" data-size="s">
        </button>
\t
