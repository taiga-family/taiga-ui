...
describe('TuiDocCodeComponent', () => {
    ...
    <div class="t-code-actions">
        <button tuiappearance="" tuiicons="" tuiiconbutton="" appearance="icon" size="xs" class="t-copy-button _icon-start" data-appearance="icon" style="--t-mask-start: url(assets/taiga-ui/icons/copy.svg); --t-mask-end: url();" data-size="xs">
        </button>
\t
