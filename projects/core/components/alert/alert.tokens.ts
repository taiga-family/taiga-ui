...
export const TUI_ALERT_POSITION = new InjectionToken<string>('TUI_ALERT_POSITION', {
    factory: () => (inject(TUI_IS_MOBILE) ? '1rem 1rem 0 auto' : '2rem 3rem 0 auto'),
});

export const TUI_ALERTS = new InjectionToken('TUI_ALERTS', {
 ...
 */
export const TUI_ALERTS_GROUPED = new InjectionToken('TUI_ALERTS_GROUPED', {
    factory: () =>
        combineLatest([
