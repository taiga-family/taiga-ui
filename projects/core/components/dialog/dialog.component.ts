...
@Component({
    ...
    host: {
        '[style.margin]': 'context.position',
        '[style.border-radius]': 'context.border.radius',
        '[style.border-width]': 'context.border.width',
        '[style.border-style]': 'context.border.style',
        '[style.border-color]': 'context.border.color',
    },
})
