 ...
 * i18n 'clear' word
 */
export const TUI_CLEAR_WORD = new InjectionToken('TUI_CLEAR_WORD', {
 ...
 */
export const TUI_NOTHING_FOUND_MESSAGE = new InjectionToken('TUI_NOTHING_FOUND_MESSAGE', {
 ...
 */
export const TUI_DEFAULT_ERROR_MESSAGE = new InjectionToken('TUI_DEFAULT_ERROR_MESSAGE', {
