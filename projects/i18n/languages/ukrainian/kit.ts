...
export const TUI_UKRAINIAN_LANGUAGE_KIT: LanguageKit = {
    ...
    unavailablePdf: `Цей PDF-файл не можна показати. Можливо, ваш браузер налаштовано на завантаження файлів замість їх попереднього перегляду, або виникла проблема з підключенням.`,
};
