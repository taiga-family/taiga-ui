...
describe(`InputRange`, () => {
    ...
    describe(`Keyboard interactions`, () => {
        beforeEach(() => {
            cy.tuiVisit(`components/input-range/API?min=-100&max=100&quantum=5`);
    ...
    describe(`Rounding numbers (to the nearest step which satisfies quantum) (min=0 | max=10 | quantum=2.5)`, () => {
        beforeEach(() => {
            cy.tuiVisit(`components/input-range/API?min=0&max=10&quantum=2.5`);
            initializeAliases(`#demo-content tui-input-range`, [0, 10]);
        });
    ...
    describe(`Range interactions`, () => {
        describe(`click on the sliders' track`, () => {
            beforeEach(() => {
                cy.tuiVisit(`components/input-range/API?min=-100&max=100&quantum=10`);
                initializeAliases(`#demo-content tui-input-range`, [0, 10]);
            });
        ...
        describe(`click on a thumb`, () => {
            beforeEach(() => {
                cy.tuiVisit(`components/input-range/API?min=0&max=10&quantum=1`);
                initializeAliases(`#demo-content tui-input-range`, [0, 10]);
            });
    ...
    describe(`Very long placeholder`, () => {
        it(`basic case`, () => {
            ...
            cy.tuiVisit(`components/input-range/API`);
        ...
        it(`with \`pluralize\``, () => {
            ...
            cy.tuiVisit(`components/input-range/API?pluralize$=1`);
    ...
    describe(`Mobile version`, () => {
        beforeEach(() => {
            cy.viewport(`iphone-x`);
            cy.tuiVisit(`components/input-range/API?min=-20&max=20&quantum=5`, {
                pseudoMobile: true,
            });
            initializeAliases(`#demo-content tui-input-range`, [0, 10]);
        });
    ...
    function initializeAliases(
        ...
        [expectedLeftValue, expectedRightValue]: readonly [number, number],
    ): void {
