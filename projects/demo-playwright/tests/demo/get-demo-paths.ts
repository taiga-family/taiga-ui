...
import type {TuiDocPageRoute, TuiDocPages} from '@taiga-ui/addon-doc';

function flatPages(pages: TuiDocPages): readonly TuiDocPageRoute[] {
    return pages.reduce(
        (prev: readonly TuiDocPageRoute[], next) => [
            ...prev,
