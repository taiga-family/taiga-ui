...
export class TuiMobileCalendar implements AfterViewInit {
    ...
    private initYearScroll(): void {
        const {yearsScrollRef: yearsScrollRefInput} = this;
        const yearsScrollRef = yearsScrollRefInput();
    ...
    private initMonthScroll(): void {
        const {monthsScrollRef: monthsScrollRefInput} = this;
        const monthsScrollRef = monthsScrollRefInput();
