...
export class ExampleTuiRatingComponent {
    ...
    protected control = new FormControl(5);
    protected colorVariants = ['var(--tui-accent)', '#faaf00', 'pink'];
    protected color = this.colorVariants[0];
    protected sizeVariants = [null, '10px', '50px', '4rem'];
    protected size = this.sizeVariants[0];
    protected gapVariants = [null, '10px', '4rem'];
    protected gap = this.gapVariants[0];

    protected iconNormalVariants = [
    ...
    protected iconNormal = this.iconNormalVariants[0];

    protected iconFilledVariants = [
    ...
    protected iconFilled = this.iconFilledVariants[0];
