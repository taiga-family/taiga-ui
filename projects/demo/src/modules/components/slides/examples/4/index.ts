...
@Component({
    standalone: true,
    imports: [NgIf, NgSwitch, NgSwitchCase, TuiAppBar, TuiAvatar, TuiButton, TuiCard, TuiCell, TuiFloatingContainer, TuiHeader, TuiProgressBar, TuiRepeatTimes, TuiSlides, TuiSurface, TuiTitle],
