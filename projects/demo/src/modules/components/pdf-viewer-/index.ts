...
export default class Page {
    ...
    protected readonly example2 = {
        ...
        'actions-content.component.ts':
            import('./examples/2/actions-content/index.ts?raw'),
        'actions-content.component.html':
            import('./examples/2/actions-content/index.html?raw'),
