...
@Component({
    standalone: true,
    imports: [FormsModule, NgFor, TuiAvatar, TuiBadge, TuiBadgedContent, TuiCardLarge, TuiCell, TuiConnected, TuiDataListWrapper, TuiIcon, TuiNotification, TuiSelectModule, TuiSurface, TuiSwitch, TuiTextfieldControllerModule, TuiTitle],
