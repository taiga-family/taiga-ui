...
export class ExampleTuiAvatarComponent {
    ...
    protected fallback: TuiSafeHtml | null = this.fallbackVariants[0];

    protected text = 'daenerys targaryen';
    ...
    protected size = this.sizeVariants[3];

    protected border = 'var(--tui-base-01)';

    protected color = 'var(--tui-text-01)';

    protected background = 'var(--tui-secondary-active)';
}
