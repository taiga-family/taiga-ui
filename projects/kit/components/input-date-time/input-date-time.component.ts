        ...
        TuiFocusableElementAccessor
{
    ...
    public get computedMin(): TuiDay | [TuiDay, TuiTime] {
        return this.toTuiDay(this.min, this.options.min);
    }

    public get computedMax(): TuiDay | [TuiDay, TuiTime] {
        return this.toTuiDay(this.max, this.options.max);
    }

    public get fillerLength(): number {
    ...
    public get calendarValue(): TuiDay | null {
        return this.value[0];
    }

    public get calendarMinDay(): TuiDay {
        const min = this.computedMin;

        return Array.isArray(min) ? min[0] : min;
    }

    public get calendarMaxDay(): TuiDay {
