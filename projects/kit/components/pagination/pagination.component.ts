    ...
    implements TuiFocusableElementAccessor
{
    ...
    public get buttonSize(): TuiSizeXS {
    ...
    public elementIsFocusable(index: number): boolean {
    ...
    public getElementMode(index: number): TuiAppearance {
        return this.index === index ? TuiAppearance.Primary : TuiAppearance.Flat;
    }

    public getSmallElementMode(index: number, mode: TuiBrightness | null): TuiAppearance {
    ...
    public onElementKeyDownArrowLeft(element: TuiButtonComponent): void {
    ...
    public onElementKeyDownArrowRight(element: TuiButtonComponent): void {
    ...
    public onArrowClick(direction: TuiHorizontalDirection): void {
