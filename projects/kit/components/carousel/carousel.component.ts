...
@Component({
    ...
    host: {
        ...
        '(touchstart)': 'draggable ? onTransitioned(false) : (0)',
        '(touchend)': 'draggable ? onTransitioned(true): (0)',
        '(mousedown)': 'draggable ? onTransitioned(false): (0)',
        '(document:mouseup.silent)': 'draggable ?onTransitioned(true): (0)',
    },
})
