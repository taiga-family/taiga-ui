...
import {TUI_INPUT_DATE_VALUE_TRANSFORMER} from '@taiga-ui/kit/components';
...
describe('InputDate + TUI_INPUT_DATE_VALUE_TRANSFORMER', () => {
    ...
    configureTestSuite(() => {
        TestBed.configureTestingModule({
            ...
            providers: [
                {
                    provide: TUI_INPUT_DATE_VALUE_TRANSFORMER,
