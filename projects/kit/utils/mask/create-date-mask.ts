...
const TWO_DIGITS = new Array(2).fill(TUI_DIGIT_REGEXP) as ReadonlyArray<RegExp | string>;
const FOUR_DIGITS = new Array(4).fill(TUI_DIGIT_REGEXP) as ReadonlyArray<RegExp | string>;
