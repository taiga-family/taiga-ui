...
describe('Axes', () => {
    ...
    class Test {
        public readonly defaultValues = viewChild<TuiAxes>('defaultValues');
        public readonly customValues = viewChild<TuiAxes>('customValues');
    ...
    describe('axisYLabels', () => {
        ...
        it('empty labels falls back to non-breaking space', () => {
            expect(testComponent.defaultValues()?.fallbackLabel).toBe(
                CHAR_NO_BREAK_SPACE,
            );
        });
    });
