...
import {combineLatest, ReplaySubject, withLatestFrom} from 'rxjs';
...
export class TuiAccordionComponent implements AfterViewInit {
    ...
    public ngAfterViewInit(): void {
        combineLatest([this.directives.changes, this.expands.changes])
            .pipe(withLatestFrom(this.toggle$), takeUntilDestroyed(this.destroyRef))
