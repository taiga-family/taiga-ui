...
export const MIGRATION_WARNINGS: readonly MigrationWarning[] = [
    ...
    },
    {
        ...
        moduleSpecifier: '@taiga-ui/core',
        message:
            'TuiPluralizePipeModule has been deleted in 3.0, please use Angular built-in pipe https://angular.io/api/common/I18nPluralPipe',
    },
    {
    ...
    },
    {
        ...
        message:
            'Use MultiSelect (@taiga-ui/kit) with icon "tuiIconSearchLarge": https://taiga-ui.dev/components/multi-select/API?tuiTextfieldIconLeft=tuiIconSearchLarge',
    },
    {
        name: 'TuiCarouselModule',
        moduleSpecifier: '@taiga-ui/proprietary-core',
        message:
            'Proprietary Carousel is outdated and has different API. Use new version of the same module from @taiga-ui/kit. Also, check new API: https://taiga-ui.dev/components/carousel/API',
    },
    {
