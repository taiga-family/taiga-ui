const MAPPING = {
    'text-h1': ['font: var(--tui-font-heading-h1)'],
    'text-h2': ['font: var(--tui-font-heading-h2)'],
    'text-h3': ['font: var(--tui-font-heading-h3)'],
    'text-h4': ['font: var(--tui-font-heading-h4)'],
    'text-h5': ['font: var(--tui-font-heading-h5)'],
    'text-h6': ['font: var(--tui-font-heading-h6)'],
    'text-body-xl-bold': ['font: var(--tui-font-legacy-body-xl)', 'font-weight: bold'],
    'text-body-xl': ['font: var(--tui-font-legacy-body-xl)'],
    'text-body-xs': ['font: var(--tui-font-body-xs)'],
    'text-caption-l-bold': [
        'font-size: 0.8125rem',
        'font-weight: bold',
        'font-family: var(--tui-font-family-text), var(--tui-font-family-fallback)',
