...
export class TestComponent {
    ...
    ngOnInit() {
        console.log(document.querySelector('[automation-id="tui-textarea__counter"]'));
    }
}`;

const TEMPLATE_BEFORE = `
<tui-text-area class="text-area"></tui-text-area>
`;

const TEMPLATE_AFTER = `
<tui-textarea class="text-area"></tui-textarea>
`;
