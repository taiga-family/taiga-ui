...
export const TUI_IS_IOS = new InjectionToken('TUI_IS_IOS', {
    factory: () => isIos(inject(WA_NAVIGATOR)),
});

export const TUI_IS_ANDROID = new InjectionToken('TUI_IS_ANDROID', {
...
export const TUI_IS_TOUCH = new InjectionToken('TUI_IS_TOUCH', {
    factory: () => {
 ...
 */
export const TUI_IS_CYPRESS = new InjectionToken('TUI_IS_CYPRESS', {
 ...
 */
export const TUI_IS_E2E = new InjectionToken('TUI_IS_E2E', {
