...
<svg height="64px" viewBox="0 0 64 64" width="64px" xmlns="http://www.w3.org/2000/svg">
    <linearGradient
        gradientUnits="userSpaceOnUse"
        data-id='r4wzZI4nTYpRSYqL7WQ95a_MOCK_ID'
    ...
    <path d="M37 14.854A2 2 0 1 0 37 18.854A2 2 0 1 0 37 14.854Z" fill='url("#r4wzZI4nTYpRSYqL7WQ95a_MOCK_ID")' />
    <linearGradient
        gradientUnits="userSpaceOnUse"
    ...
    <path d="M27 14.854A2 2 0 1 0 27 18.854A2 2 0 1 0 27 14.854Z" fill="url('#r4wzZI4nTYpRSYqL7WQ95b_MOCK_ID')" />
    <linearGradient
        gradientUnits="userSpaceOnUse"
