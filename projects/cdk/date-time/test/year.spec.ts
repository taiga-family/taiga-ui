...
describe(`TuiYear`, () => {
    ...
    describe(`prototype`, () => {
        describe(`getter`, () => {
            ...
            describe(`yearStartDaysOffset returns`, () => {
                it(`5 if year is 0`, () => {
                    expect(new TuiYear(0).yearStartDaysOffset).toBe(5);
                });

                it(`0 if year is 1`, () => {
                    expect(new TuiYear(1).yearStartDaysOffset).toBe(0);
                });

                it(`1 if year is 2`, () => {
                    expect(new TuiYear(2).yearStartDaysOffset).toBe(1);
                });

                it(`2 if year is 3`, () => {
                    expect(new TuiYear(3).yearStartDaysOffset).toBe(2);
                });

                it(`3 if year is 4`, () => {
                    expect(new TuiYear(4).yearStartDaysOffset).toBe(3);
                });

                it(`5 if year is 5`, () => {
                    expect(new TuiYear(5).yearStartDaysOffset).toBe(5);
                });

                it(`2 if year is 20`, () => {
                    expect(new TuiYear(20).yearStartDaysOffset).toBe(2);
                });

                it(`5 if year is 1200`, () => {
                    expect(new TuiYear(1200).yearStartDaysOffset).toBe(5);
                });

                it(`5 if year is 2000`, () => {
                    expect(new TuiYear(2000).yearStartDaysOffset).toBe(5);
                });

                it(`0 if year is 2001`, () => {
                    expect(new TuiYear(2001).yearStartDaysOffset).toBe(0);
                });

                it(`0 if year is 2018`, () => {
                    expect(new TuiYear(2018).yearStartDaysOffset).toBe(0);
                });

                it(`2 if year is 2020`, () => {
                    expect(new TuiYear(2020).yearStartDaysOffset).toBe(2);
                });

                it(`4 if year is 2100`, () => {
                    expect(new TuiYear(2100).yearStartDaysOffset).toBe(4);
                });

                it(`1 if year is 2104`, () => {
                    expect(new TuiYear(2104).yearStartDaysOffset).toBe(1);
                });

                it(`6 if year is 1995`, () => {
                    expect(new TuiYear(1995).yearStartDaysOffset).toBe(6);
                });

                it(`4 if year is 1334`, () => {
                    expect(new TuiYear(1334).yearStartDaysOffset).toBe(4);
                });

                it(`0 if year is 3421`, () => {
                    expect(new TuiYear(3421).yearStartDaysOffset).toBe(0);
                });
            });
        });
