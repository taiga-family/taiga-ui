    ...
    <ng-template pageTab>
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td class="td">
                    <tui-doc-copy cdkCopyToClipboard="var(--tui-font-text-xl)">--tui-font-text-xl</tui-doc-copy>
                </td>
            ...
            <tr>
                ...
                <td class="td">
                    <tui-doc-copy cdkCopyToClipboard="var(--tui-font-text-l)">--tui-font-text-l</tui-doc-copy>
                </td>
                <td class="td">normal</td>
            ...
            <tr>
                ...
                <td class="td">
                    <tui-doc-copy cdkCopyToClipboard="var(--tui-font-text-ui-l)">--tui-font-text-ui-l</tui-doc-copy>
                </td>
                <td class="td">normal</td>
            ...
            <tr>
                ...
                <td class="td">
                    <tui-doc-copy cdkCopyToClipboard="var(--tui-font-text-m)">--tui-font-text-m</tui-doc-copy>
                </td>
                <td class="td">normal</td>
                <td class="td">{{ computedFontSize('tui-text_body-m') ?? '16px' }}</td>
            ...
            <tr>
                ...
                <td class="td">
                    <tui-doc-copy cdkCopyToClipboard="var(--tui-font-text-ui-m)">--tui-font-text-ui-m</tui-doc-copy>
                </td>
                <td class="td">normal</td>
                <td class="td">{{ computedFontSize('tui-text_body-m-2') ?? '16px' }}</td>
            ...
            <tr>
                ...
                <td class="td">
                    <tui-doc-copy cdkCopyToClipboard="var(--tui-font-text-s)">--tui-font-text-s</tui-doc-copy>
                </td>
                <td class="td">normal</td>
            ...
            <tr>
                ...
                <td class="td">
                    <tui-doc-copy cdkCopyToClipboard="var(--tui-font-text-ui-s)">--tui-font-text-ui-s</tui-doc-copy>
                </td>
                <td class="td">normal</td>
            ...
            <tr>
                ...
                <td class="td">
                    <tui-doc-copy cdkCopyToClipboard="var(--tui-font-text-xs)">--tui-font-text-xs</tui-doc-copy>
                </td>
                <td class="td">normal</td>
                <td class="td">{{ computedFontSize('tui-text_body-xs') ?? '11px' }}</td>
                <td class="td">16px (1.45)</td>
            </tr>
        </table>
    </ng-template>
</tui-doc-page>
