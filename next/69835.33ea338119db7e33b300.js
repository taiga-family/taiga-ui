...
let TuiLegendItemExample1 = /*#__PURE__*/(() => {
  class TuiLegendItemExample1 {
    constructor() {
      ...
      this.sum = (0,cdk/* tuiSum */.smb)(...this.value);
...
class TuiLegendItemExample2 {
  constructor(alertService) {
    ...
    this.sum = (0,cdk/* tuiSum */.smb)(...this.data);
  ...
  onClick(index) {
    if (this.isEnabled(index)) {
      this.alertService.open(`Category spendings: ${(0,core/* tuiFormatNumber */.lx_)(this.data[index])} ₽`, {
...
TuiLegendItemExample2.ɵfac = function TuiLegendItemExample2_Factory(t) {
  return new (t || TuiLegendItemExample2)(fesm2015_core/* ɵɵdirectiveInject */.Y36(core/* TuiAlertService */.J9F));
};
...
TuiLegendItemExample2.ɵcmp = /*@__PURE__*/fesm2015_core/* ɵɵdefineComponent */.Xpm({
  ...
  styles: ["[_nghost-%COMP%]{--tui-chart-0: #c779d0;--tui-chart-1: #feac5e;--tui-chart-2: #ff5f6d;--tui-chart-3: #4bc0c8;--tui-chart-4: #9795cd}.chart[_ngcontent-%COMP%]{pointer-events:none}.wrapper[_ngcontent-%COMP%]{display:flex;align-items:center;margin-top:1rem}@media screen and (max-width: 47.9625em){.wrapper[_ngcontent-%COMP%]{flex-direction:column}}.disable[_ngcontent-%COMP%]{transition-property:transform,color;transition-duration:.3s;transition-duration:var(--tui-duration, .3s);transition-timing-function:ease-in-out;margin-left:.25rem;will-change:transform;color:var(--tui-text-02);pointer-events:auto}.disable[_ngcontent-%COMP%]:hover{color:var(--tui-text-01)}.disable_rotated[_ngcontent-%COMP%]{transform:rotate(45deg)}.legend[_ngcontent-%COMP%]{margin:0 0 0 2rem;justify-content:center}@media screen and (max-width: 47.9625em){.legend[_ngcontent-%COMP%]{margin:2rem 0 0}}.item[_ngcontent-%COMP%]{margin:0 .5rem .75rem 0}"],
  changeDetection: 0
});

(0,tslib_es6/* __decorate */.gn)([cdk/* tuiPure */.UMq], TuiLegendItemExample2.prototype, "getValue", null);
...
let ExampleTuiLegendItemModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiLegendItemModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, addon_charts/* TuiLegendItemModule */.Gn, addon_charts/* TuiRingChartModule */.R7, addon_commerce/* TuiMoneyModule */.DC, core/* TuiPrimitiveCheckboxModule */.fBj, core/* TuiSvgModule */.EIu, core/* TuiNotificationModule */.HiG, tinkoff_ng_polymorpheus/* PolymorpheusModule */.wq, cdk/* TuiHoveredModule */.VE3, public_api/* TuiAddonDocModule */.fV, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiLegendItemComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiLegendItemModule, {
    ...
    imports: [common/* CommonModule */.ez, addon_charts/* TuiLegendItemModule */.Gn, addon_charts/* TuiRingChartModule */.R7, addon_commerce/* TuiMoneyModule */.DC, core/* TuiPrimitiveCheckboxModule */.fBj, core/* TuiSvgModule */.EIu, core/* TuiNotificationModule */.HiG, tinkoff_ng_polymorpheus/* PolymorpheusModule */.wq, cdk/* TuiHoveredModule */.VE3, public_api/* TuiAddonDocModule */.fV, router/* RouterModule */.Bz],
