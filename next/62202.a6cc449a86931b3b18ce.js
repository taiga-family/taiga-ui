...
let TuiBarChartExample1 = /*#__PURE__*/(() => {
  class TuiBarChartExample1 {
    ...
    getHeight(max) {
      return max / (0,cdk/* tuiCeil */.BrH)(max, -3) * 100;
    }
...
let TuiBarChartExample2 = /*#__PURE__*/(() => {
  class TuiBarChartExample2 {
    constructor() {
      ...
      this.hint = ({
        $implicit
      }) => this.value.reduce((result, set) => `${result}$${(0,core/* tuiFormatNumber */.lx_)(set[$implicit])}\n`, ``).trim();
    }
  ...
  TuiBarChartExample2.ɵcmp = /*@__PURE__*/fesm2015_core/* ɵɵdefineComponent */.Xpm({
    ...
    decls: 5,
    vars: 11,
    consts: [[1, "flex"], [1, "axes", 3, "axisXLabels", "axisYLabels"], [3, "max", "value", "tuiHintContent"], ["tuiHintAppearance", "onDark", 3, "max", "value", "collapsed", "tuiHintContent"]],
    template: function TuiBarChartExample2_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        fesm2015_core/* ɵɵproperty */.Q6J("axisXLabels", ctx.labelsX)("axisYLabels", ctx.labelsY);
        fesm2015_core/* ɵɵadvance */.xp6(1);
        fesm2015_core/* ɵɵproperty */.Q6J("max", 10000)("value", ctx.value)("tuiHintContent", ctx.hint);
        fesm2015_core/* ɵɵadvance */.xp6(1);
        fesm2015_core/* ɵɵproperty */.Q6J("axisXLabels", ctx.labelsX)("axisYLabels", ctx.labelsY);
        fesm2015_core/* ɵɵadvance */.xp6(1);
        fesm2015_core/* ɵɵproperty */.Q6J("max", 10000)("value", ctx.value)("collapsed", true)("tuiHintContent", ctx.hint);
      }
    },
    directives: [axes_component/* TuiAxesComponent */.v, bar_chart_component/* TuiBarChartComponent */.g, hint_options_directive/* TuiHintOptionsDirective */.b],
...
let ExampleTuiBarChartModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiBarChartModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, router/* RouterModule */.Bz, addon_charts/* TuiAxesModule */.Ep, addon_charts/* TuiBarChartModule */.dd, core/* TuiHintModule */.goS, core/* TuiNotificationModule */.HiG, core/* TuiLinkModule */.jzK, addon_commerce/* TuiMoneyModule */.DC, public_api/* TuiAddonDocModule */.fV, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiBarChartComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiBarChartModule, {
    ...
    imports: [common/* CommonModule */.ez, router/* RouterModule */.Bz, addon_charts/* TuiAxesModule */.Ep, addon_charts/* TuiBarChartModule */.dd, core/* TuiHintModule */.goS, core/* TuiNotificationModule */.HiG, core/* TuiLinkModule */.jzK, addon_commerce/* TuiMoneyModule */.DC, public_api/* TuiAddonDocModule */.fV, router/* RouterModule */.Bz],
