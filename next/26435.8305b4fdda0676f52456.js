...
let TuiElasticStickyExample1 = /*#__PURE__*/(() => {
  class TuiElasticStickyExample1 {
    ngAfterViewInit() {
      ...
      this.scale$ = this.elasticSticky.tuiElasticSticky.pipe((0,map/* map */.U)(scale => (0,cdk/* tuiClamp */.Kiv)(scale, 0.5, 1)), (0,startWith/* startWith */.O)(1), (0,distinctUntilChanged/* distinctUntilChanged */.x)());
    }
  ...
  TuiElasticStickyExample1.ɵcmp = /*@__PURE__*/fesm2015_core/* ɵɵdefineComponent */.Xpm({
    ...
    viewQuery: function TuiElasticStickyExample1_Query(rf, ctx) {
      if (rf & 1) {
        fesm2015_core/* ɵɵviewQuery */.Gf(addon_mobile/* TuiElasticStickyDirective */.XK, 5);
      }
...
let ExampleTuiElasticStickyModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiElasticStickyModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, addon_commerce/* TuiMoneyModule */.DC, core/* TuiScrollbarModule */.Jyu, addon_mobile/* TuiElasticStickyModule */.TL, public_api/* TuiAddonDocModule */.fV, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiElasticStickyComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiElasticStickyModule, {
    ...
    imports: [common/* CommonModule */.ez, addon_commerce/* TuiMoneyModule */.DC, core/* TuiScrollbarModule */.Jyu, addon_mobile/* TuiElasticStickyModule */.TL, public_api/* TuiAddonDocModule */.fV, router/* RouterModule */.Bz],
