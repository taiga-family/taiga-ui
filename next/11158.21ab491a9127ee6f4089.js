...
let TuiErrorExample1 = /*#__PURE__*/(() => {
  class TuiErrorExample1 {
    constructor() {
      this.enabled = false;
      this.error = new cdk/* TuiValidationError */.T8v(`An error`);
    }
...
let ExampleTuiErrorComponent = /*#__PURE__*/(() => {
  class ExampleTuiErrorComponent {
    ...
    get error() {
      ...
      return new cdk/* TuiValidationError */.T8v(this.errorContent || ``);
    }
...
let ExampleTuiErrorModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiErrorModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, fesm2015_forms/* FormsModule */.u5, kit/* TuiToggleModule */.YMv, core/* TuiErrorModule */.Shu, core/* TuiLinkModule */.jzK, tinkoff_ng_polymorpheus/* PolymorpheusModule */.wq, cdk/* TuiMapperPipeModule */.I1h, public_api/* TuiAddonDocModule */.fV, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiErrorComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiErrorModule, {
    ...
    imports: [common/* CommonModule */.ez, fesm2015_forms/* FormsModule */.u5, kit/* TuiToggleModule */.YMv, core/* TuiErrorModule */.Shu, core/* TuiLinkModule */.jzK, tinkoff_ng_polymorpheus/* PolymorpheusModule */.wq, cdk/* TuiMapperPipeModule */.I1h, public_api/* TuiAddonDocModule */.fV, router/* RouterModule */.Bz],
