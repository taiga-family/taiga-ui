  ...
  class TuiTableExample3 {
    constructor() {
      ...
      this.pythons = [{
        ...
        quantity: 1,
        unit: this.units[0],
        date: cdk/* TuiDay.currentLocal */.TU1.currentLocal()
      }, {
        name: `Foot`,
        price: 29.95,
        quantity: 5,
        unit: this.units[2],
        date: cdk/* TuiDay.currentLocal */.TU1.currentLocal().append({
          day: -42
        })
      }, {
        name: `Shed`,
      ...
      this.totalSorter = (a, b) => (0,addon_table/* tuiDefaultSort */.A2)(a.price * a.quantity, b.price * b.quantity);
    }
...
const TODAY = cdk/* TuiDay.currentLocal */.TU1.currentLocal();
...
let TuiTableExample4 = /*#__PURE__*/(() => {
  class TuiTableExample4 {
    constructor() {
      ...
      this.request$ = (0,combineLatest/* combineLatest */.aj)([this.sorter$, this.direction$, this.page$, this.size$, (0,cdk/* tuiControlValue */.EKY)(this.minAge)]).pipe( // zero time debounce for a case when both key and direction change
      ...
      this.total$ = this.request$.pipe((0,filter/* filter */.h)(cdk/* tuiIsPresent */.PcC), (0,map/* map */.U)(({
        length
      }) => length), (0,startWith/* startWith */.O)(1));
      this.data$ = this.request$.pipe((0,filter/* filter */.h)(cdk/* tuiIsPresent */.PcC), (0,map/* map */.U)(users => users.filter(cdk/* tuiIsPresent */.PcC)), (0,startWith/* startWith */.O)([]));
    }
    ...
    isMatch(value) {
      return !!this.search && (0,cdk/* TUI_DEFAULT_MATCHER */.LQM)(value, this.search);
    }
...
function sortBy(key, direction) {
  return (a, b) => key === `age` ? direction * (0,addon_table/* tuiDefaultSort */.A2)(getAge(a), getAge(b)) : direction * (0,addon_table/* tuiDefaultSort */.A2)(a[key], b[key]);
}
...
function getAge({
  ...
  const offset = (0,cdk/* tuiToInt */.HWE)(months > 0 || !months && days > 9);
  return years + offset;
}
...
const _5_TODAY = cdk/* TuiDay.currentLocal */.TU1.currentLocal();
...
let ExampleTuiTableModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiTableModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, fesm2015_forms/* FormsModule */.u5, fesm2015_forms/* ReactiveFormsModule */.UX, scrolling/* ScrollingModule */.Cl, ng_web_apis_intersection_observer/* IntersectionObserverModule */.$v, core/* TuiNotificationModule */.HiG, core/* TuiScrollbarModule */.Jyu, addon_table/* TuiTableModule */.jz, kit/* TuiInputModule */.QfL, kit/* TuiTextAreaModule */.U1B, kit/* TuiInputNumberModule */._Hh, kit/* TuiInputCountModule */.$HZ, kit/* TuiSelectModule */.Jyo, kit/* TuiInputDateModule */.hr9, core/* TuiDataListModule */.pcV, kit/* TuiDataListWrapperModule */.zXW, core/* TuiFormatNumberPipeModule */.acE, cdk/* TuiValidatorModule */.op3, core/* TuiSvgModule */.EIu, core/* TuiButtonModule */.fNO, core/* TuiLinkModule */.jzK, kit/* TuiTagModule */.d38, kit/* TuiAccordionModule */.iKB, core/* TuiLoaderModule */.dSp, cdk/* TuiLetModule */.WDk, addon_table/* TuiTablePaginationModule */.y3, core/* TuiTextfieldControllerModule */.cnw, core/* TuiHostedDropdownModule */.jhF, kit/* TuiArrowModule */.MtS, addon_table/* TuiReorderModule */.tk, public_api/* TuiAddonDocModule */.fV, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiTableComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiTableModule, {
    ...
    imports: [common/* CommonModule */.ez, fesm2015_forms/* FormsModule */.u5, fesm2015_forms/* ReactiveFormsModule */.UX, scrolling/* ScrollingModule */.Cl, ng_web_apis_intersection_observer/* IntersectionObserverModule */.$v, core/* TuiNotificationModule */.HiG, core/* TuiScrollbarModule */.Jyu, addon_table/* TuiTableModule */.jz, kit/* TuiInputModule */.QfL, kit/* TuiTextAreaModule */.U1B, kit/* TuiInputNumberModule */._Hh, kit/* TuiInputCountModule */.$HZ, kit/* TuiSelectModule */.Jyo, kit/* TuiInputDateModule */.hr9, core/* TuiDataListModule */.pcV, kit/* TuiDataListWrapperModule */.zXW, core/* TuiFormatNumberPipeModule */.acE, cdk/* TuiValidatorModule */.op3, core/* TuiSvgModule */.EIu, core/* TuiButtonModule */.fNO, core/* TuiLinkModule */.jzK, kit/* TuiTagModule */.d38, kit/* TuiAccordionModule */.iKB, core/* TuiLoaderModule */.dSp, cdk/* TuiLetModule */.WDk, addon_table/* TuiTablePaginationModule */.y3, core/* TuiTextfieldControllerModule */.cnw, core/* TuiHostedDropdownModule */.jhF, kit/* TuiArrowModule */.MtS, addon_table/* TuiReorderModule */.tk, public_api/* TuiAddonDocModule */.fV, router/* RouterModule */.Bz],
