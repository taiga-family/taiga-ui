...
let TuiPreviewExample1 = /*#__PURE__*/(() => {
  class TuiPreviewExample1 {
    ...
    onSwipe(swipe) {
      if (swipe.direction === `left`) {
        this.index = (0,cdk/* tuiClamp */.Kiv)(this.index + 1, 0, this.length - 1);
      }
  ...
  TuiPreviewExample1.ɵfac = function TuiPreviewExample1_Factory(t) {
    return new (t || TuiPreviewExample1)(fesm2015_core/* ɵɵdirectiveInject */.Y36(addon_preview/* TuiPreviewDialogService */.iK), fesm2015_core/* ɵɵdirectiveInject */.Y36(core/* TuiAlertService */.J9F));
  };
...
let TuiPreviewExample3 = /*#__PURE__*/(() => {
  class TuiPreviewExample3 {
    constructor(previewDialogService) {
      ...
      this.item$ = this.index$$.pipe((0,map/* map */.U)(index => this.items[index]), (0,filter/* filter */.h)(cdk/* tuiIsPresent */.PcC));
...
let ExampleTuiPreviewModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiPreviewModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, tinkoff_ng_polymorpheus/* PolymorpheusModule */.wq, core/* TuiButtonModule */.fNO, addon_preview/* TuiPreviewModule */.E6, core/* TuiNotificationModule */.HiG, public_api/* TuiAddonDocModule */.fV, core/* TuiSvgModule */.EIu, core/* TuiLoaderModule */.dSp, cdk/* TuiSwipeModule */.zq, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiPreviewComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiPreviewModule, {
    ...
    imports: [common/* CommonModule */.ez, tinkoff_ng_polymorpheus/* PolymorpheusModule */.wq, core/* TuiButtonModule */.fNO, addon_preview/* TuiPreviewModule */.E6, core/* TuiNotificationModule */.HiG, public_api/* TuiAddonDocModule */.fV, core/* TuiSvgModule */.EIu, core/* TuiLoaderModule */.dSp, cdk/* TuiSwipeModule */.zq, router/* RouterModule */.Bz],
