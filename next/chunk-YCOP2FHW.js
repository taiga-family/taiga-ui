import"./chunk-42JZD6NG.js";var e=`<label tuiLabel>
    <input
        tuiSwitch
        type="checkbox"
        [(ngModel)]="loading"
...
<span [style.font]="'var(--tui-font-legacy-body-xl)'">Shimmer</span>
...
<span [style.font]="'var(--tui-font-legacy-body-xl)'">Skeleton</span>
