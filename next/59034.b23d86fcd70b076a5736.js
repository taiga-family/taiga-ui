...
let TuiRingChartExample2 = /*#__PURE__*/(() => {
  class TuiRingChartExample2 {
    constructor() {
      ...
      this.total = (0,cdk/* tuiSum */.smb)(...this.value);
      this.index = NaN;
    }
...
let ExampleTuiRingChartModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiRingChartModule.ɵinj = /*@__PURE__*/core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, router/* RouterModule */.Bz, addon_charts/* TuiRingChartModule */.R7, addon_commerce/* TuiMoneyModule */.DC, tinkoff_ng_polymorpheus/* PolymorpheusModule */.wq, public_api/* TuiAddonDocModule */.fV, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiRingChartComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiRingChartModule, {
    ...
    imports: [common/* CommonModule */.ez, router/* RouterModule */.Bz, addon_charts/* TuiRingChartModule */.R7, addon_commerce/* TuiMoneyModule */.DC, tinkoff_ng_polymorpheus/* PolymorpheusModule */.wq, public_api/* TuiAddonDocModule */.fV, router/* RouterModule */.Bz],
