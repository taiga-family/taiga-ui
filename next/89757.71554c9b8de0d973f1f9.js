...
// EXTERNAL MODULE: ./projects/addon-editor/index.ts + 10 modules
var addon_editor = __webpack_require__(44482);
...
let ExampleSmilesToolComponent = /*#__PURE__*/(() => {
  ...
  ExampleSmilesToolComponent.ɵfac = function ExampleSmilesToolComponent_Factory(t) {
    return new (t || ExampleSmilesToolComponent)(fesm2015_core/* ɵɵdirectiveInject */.Y36(addon_editor/* TuiTiptapEditorService */.$3));
  };
...
let TuiEditorExample1 = /*#__PURE__*/(() => {
  class TuiEditorExample1 {
    constructor() {
      this.builtInTools = [addon_editor/* TuiEditorTool.Undo */._2.Undo];
  ...
  TuiEditorExample1.ɵcmp = /*@__PURE__*/fesm2015_core/* ɵɵdefineComponent */.Xpm({
    ...
    features: [fesm2015_core/* ɵɵProvidersFeature */._Bn([{
      provide: addon_editor/* TUI_EDITOR_EXTENSIONS */.Wf,
...
let TuiEditorExample2 = /*#__PURE__*/(() => {
  class TuiEditorExample2 {
    constructor(imageLoader, http, destroy$) {
      ...
      this.http = http;
      this.builtInTools = [addon_editor/* TuiEditorTool.Undo */._2.Undo, addon_editor/* TuiEditorTool.Img */._2.Img];
  ...
  TuiEditorExample2.ɵfac = function TuiEditorExample2_Factory(t) {
    return new (t || TuiEditorExample2)(fesm2015_core/* ɵɵdirectiveInject */.Y36(addon_editor/* TUI_IMAGE_LOADER */.p7), fesm2015_core/* ɵɵdirectiveInject */.Y36(http/* HttpClient */.eN), fesm2015_core/* ɵɵdirectiveInject */.Y36(cdk/* TuiDestroyService */.a31));
  };
  ...
  TuiEditorExample2.ɵcmp = /*@__PURE__*/fesm2015_core/* ɵɵdefineComponent */.Xpm({
    ...
    features: [fesm2015_core/* ɵɵProvidersFeature */._Bn([cdk/* TuiDestroyService */.a31, {
      ...
      useFactory: injector => [Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 15632)).then(m => m.StarterKit), Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 31471)).then(m => m.createImageEditorExtension(injector))]
    }])],
    decls: 4,
    vars: 3,
...
let TuiEditorExample4 = /*#__PURE__*/(() => {
  ...
  TuiEditorExample4.ɵcmp = /*@__PURE__*/fesm2015_core/* ɵɵdefineComponent */.Xpm({
    ...
    features: [fesm2015_core/* ɵɵProvidersFeature */._Bn([{
      provide: addon_editor/* TUI_EDITOR_EXTENSIONS */.Wf,
      useValue: addon_editor/* defaultEditorExtensions */.PD
    }, {
      provide: addon_editor/* TUI_EDITOR_CONTENT_PROCESSOR */.F1,
      useValue: addon_editor/* tuiLegacyEditorConverter */.Er
    }])],
    decls: 9,
    vars: 3,
...
let TuiEditorExample5 = /*#__PURE__*/(() => {
  class TuiEditorExample5 {
    constructor() {
      this.builtInTools = [addon_editor/* TuiEditorTool.Undo */._2.Undo, addon_editor/* TuiEditorTool.Group */._2.Group];
      this.control = new fesm2015_forms/* FormControl */.NI(``);
  ...
  TuiEditorExample7.ɵcmp = /*@__PURE__*/fesm2015_core/* ɵɵdefineComponent */.Xpm({
    ...
    features: [fesm2015_core/* ɵɵProvidersFeature */._Bn([cdk/* TuiDestroyService */.a31, {
      ...
      useFactory: injector => [Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 15632)).then(({
        StarterKit
      }) => StarterKit), Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 31471)).then(({
        createImageEditorExtension
      }) => createImageEditorExtension(injector))]
    }, {
      provide: addon_editor/* TUI_EDITOR_MIN_IMAGE_WIDTH */.kB,
      useValue: 150
    }, {
      provide: addon_editor/* TUI_EDITOR_MAX_IMAGE_WIDTH */.VE,
      useValue: 400
    }, {
      provide: addon_editor/* TUI_IMAGE_LOADER */.p7,
...
let ExampleEditorComponent = /*#__PURE__*/(() => {
  class ExampleEditorComponent extends control/* AbstractExampleTuiControl */.b {
    constructor() {
      ...
      this.control = new fesm2015_forms/* FormControl */.NI();
      this.toolsVariants = [addon_editor/* defaultEditorTools */.aU, [addon_editor/* TuiEditorTool.Bold */._2.Bold, addon_editor/* TuiEditorTool.Italic */._2.Italic, addon_editor/* TuiEditorTool.Strikethrough */._2.Strikethrough, addon_editor/* TuiEditorTool.HR */._2.HR]];
  ...
  ExampleEditorComponent.ɵcmp = /*@__PURE__*/fesm2015_core/* ɵɵdefineComponent */.Xpm({
    ...
    consts: function () {
      ...
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG_EXTERNAL_8752995704195016078$$PROJECTS_DEMO_SRC_MODULES_COMPONENTS_EDITOR_EDITOR_COMPONENT_TS___27 = goog.getMsg(" Example text shown on empty focused input ");
        i18n_26 = MSG_EXTERNAL_8752995704195016078$$PROJECTS_DEMO_SRC_MODULES_COMPONENTS_EDITOR_EDITOR_COMPONENT_TS___27;
      } else {
        i18n_26 = $localize`:␟4451dd975ad87c22f3e58059c2d38ee4dce01d18␟8752995704195016078: Example text shown on empty focused input `;
      }
      ...
      return [["header", "Editor", "package", "ADDON-EDITOR", "type", "components"], ["pageTab", ""], ["pageTab", "DI tokens"], i18n_0, ["tuiLink", "", "href", "https://www.tiptap.dev/"], ["tuiLink", "", "routerLink", "/icon-set", "fragment", "sanitizer"], ["status", "warning", 1, "tui-space_top-4"], i18n_2, ["id", "custom-tool", "heading", i18n_4, 3, "content"], [1, "tui-list", "tui-space_bottom-6"], i18n_6, [1, "tui-list__item"], ["tuiLink", "", "target", "_blank", "href", "https://tiptap.dev/api/introduction"], ["id", "resizable-image", "heading", i18n_8, 3, "content"], ["id", "preview-image", "heading", i18n_10, 3, "content"], ["id", "custom-processing", "heading", i18n_12, 3, "content"], ["id", "draggable-groups", "heading", i18n_14, 3, "content"], ["id", "nested-groups", "heading", i18n_16, 3, "content"], ["id", "upload-images", "heading", i18n_18, 3, "content"], [3, "formControl", "focusable", "exampleText", "readOnly", "tools", "pseudoInvalid", "pseudoFocus", "pseudoHover"], [1, "tui-example", 3, "content"], ["documentationPropertyName", "", "documentationPropertyType", "boolean", 3, "documentationPropertyValue", "documentationPropertyValueChange"], ["documentationPropertyName", "ngModel", "documentationPropertyMode", "input", "documentationPropertyType", "string", 3, "documentationPropertyValue", "documentationPropertyValueChange"], ["documentationPropertyName", "exampleText", "documentationPropertyMode", "input", "documentationPropertyType", "string", 3, "documentationPropertyValue", "documentationPropertyValueChange"], ["documentationPropertyName", "max-height", "documentationPropertyMode", "input", "documentationPropertyType", "string", 3, "documentationPropertyValue", "documentationPropertyValueChange"], ["documentationPropertyName", "tools", "documentationPropertyMode", "input", "documentationPropertyType", "ReadonlyArray<TuiEditorTool>", 3, "documentationPropertyValues", "documentationPropertyValue", "documentationPropertyValueChange"], i18n_20, i18n_22, i18n_24, i18n_26, i18n_28, [1, "b-demo-steps"], i18n_30, ["filename", "myComponent.module.ts", 3, "code"], i18n_32, ["filename", "myComponent.template.html", 3, "code"], i18n_34, ["filename", "myComponent.component.ts", 3, "code"], i18n_36, [3, "code"], i18n_38, [1, "tui-space_bottom-5"]];
    },
...
let ExampleSmilesToolModule = /*#__PURE__*/(() => {
  ...
  ExampleSmilesToolModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, core/* TuiButtonModule */.fNO, core/* TuiHostedDropdownModule */.jhF, cdk/* TuiActiveZoneModule */.Ah6, core/* TuiDropdownModule */.dpK]]
  });
...
let ImagePreviewExampleModule = /*#__PURE__*/(() => {
  ...
  ImagePreviewExampleModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, addon_preview/* TuiPreviewModule */.E6, core/* TuiButtonModule */.fNO, tinkoff_ng_polymorpheus/* PolymorpheusModule */.wq, addon_editor/* TuiEditorImagePreviewModule */.BN], addon_editor/* TuiEditorImagePreviewModule */.BN, addon_editor/* TuiEditorImagePreviewModule */.BN]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(ImagePreviewExampleModule, {
    ...
    imports: [common/* CommonModule */.ez, addon_preview/* TuiPreviewModule */.E6, core/* TuiButtonModule */.fNO, tinkoff_ng_polymorpheus/* PolymorpheusModule */.wq, addon_editor/* TuiEditorImagePreviewModule */.BN],
    exports: [addon_editor/* TuiEditorImagePreviewModule */.BN, addon_editor/* TuiEditorImagePreviewModule */.BN, ImagePreviewExampleComponent]
  });
})();
...
let ExampleTuiEditorModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiEditorModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, fesm2015_forms/* FormsModule */.u5, fesm2015_forms/* ReactiveFormsModule */.UX, addon_editor/* TuiEditorModule */.T_, addon_editor/* TuiEditorSocketModule */.GK, core/* TuiNotificationModule */.HiG, core/* TuiButtonModule */.fNO, inherited_documentation_module/* InheritedDocumentationModule */.f, public_api/* TuiAddonDocModule */.fV, core/* TuiLinkModule */.jzK, core/* TuiSvgModule */.EIu, ExampleSmilesToolModule, ImagePreviewExampleModule, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleEditorComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiEditorModule, {
    ...
    imports: [common/* CommonModule */.ez, fesm2015_forms/* FormsModule */.u5, fesm2015_forms/* ReactiveFormsModule */.UX, addon_editor/* TuiEditorModule */.T_, addon_editor/* TuiEditorSocketModule */.GK, core/* TuiNotificationModule */.HiG, core/* TuiButtonModule */.fNO, inherited_documentation_module/* InheritedDocumentationModule */.f, public_api/* TuiAddonDocModule */.fV, core/* TuiLinkModule */.jzK, core/* TuiSvgModule */.EIu, ExampleSmilesToolModule, ImagePreviewExampleModule, router/* RouterModule */.Bz],
