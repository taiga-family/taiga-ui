...
let ExampleTuiRadioListComponent = /*#__PURE__*/(() => {
  class ExampleTuiRadioListComponent extends control/* AbstractExampleTuiControl */.b {
    constructor() {
      ...
      this.disabledItemHandlerVariants = [cdk/* ALWAYS_FALSE_HANDLER */.IyD, cdk/* ALWAYS_TRUE_HANDLER */.YeN, item => item.name === `Advanced`];
...
let ExampleTuiRadioListModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiRadioListModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, fesm2015_forms/* FormsModule */.u5, kit/* TuiRadioListModule */.Ltw, fesm2015_forms/* ReactiveFormsModule */.UX, core/* TuiButtonModule */.fNO, inherited_documentation_module/* InheritedDocumentationModule */.f, tinkoff_ng_polymorpheus/* PolymorpheusModule */.wq, public_api/* TuiAddonDocModule */.fV, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiRadioListComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiRadioListModule, {
    ...
    imports: [common/* CommonModule */.ez, fesm2015_forms/* FormsModule */.u5, kit/* TuiRadioListModule */.Ltw, fesm2015_forms/* ReactiveFormsModule */.UX, core/* TuiButtonModule */.fNO, inherited_documentation_module/* InheritedDocumentationModule */.f, tinkoff_ng_polymorpheus/* PolymorpheusModule */.wq, public_api/* TuiAddonDocModule */.fV, router/* RouterModule */.Bz],
