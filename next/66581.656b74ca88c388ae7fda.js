...
// EXTERNAL MODULE: ./projects/kit/pipes/field-error/index.ts + 1 modules
var field_error = __webpack_require__(96087);
  ...
  class TuiFieldErrorPipeExample3 {
    constructor() {
      ...
      this.companyValidator = field => field.value ? {
        inn: new cdk/* TuiValidationError */.T8v(this.bigErrorContent)
      } : null;
    }
    ...
    getSecretValidator() {
      return field => field.value && (secretRegexTen.test(field.value) || secretRegexTwelve.test(field.value)) ? null : {
        secret: new cdk/* TuiValidationError */.T8v(this.errorContent)
      };
    }
  ...
  class TuiFieldErrorPipeExample4 {
    ...
    getPhoneLengthValidator() {
      return field => field.value.length !== 12 ? {
        length: new cdk/* TuiValidationError */.T8v(this.phoneErrorContent)
      } : null;
    }
    ...
    getPhoneArrayValidator() {
      return array => array.controls.length < 2 || !!array.controls.filter(item => item.errors).length && array.controls.length ? {
        length: new cdk/* TuiValidationError */.T8v(`You should add at least 2 phone number`)
      } : null;
    }
...
function asyncValidatorFn(isCypress) {
  return field => {
    return field.value && _5_latinChars.test(field.value) ? (0,of.of)(null) : (0,of.of)({
      error: new cdk/* TuiValidationError */.T8v(`Only latin letters allowed`)
...
let TuiFieldErrorPipeExample5 = /*#__PURE__*/(() => {
  ...
  TuiFieldErrorPipeExample5.ɵfac = function TuiFieldErrorPipeExample5_Factory(t) {
    return new (t || TuiFieldErrorPipeExample5)(fesm2015_core/* ɵɵdirectiveInject */.Y36(fesm2015_forms/* FormBuilder */.qu), fesm2015_core/* ɵɵdirectiveInject */.Y36(cdk/* TUI_IS_CYPRESS */.B4V));
  };
...
let ExampleTuiFieldErrorModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiFieldErrorModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, fesm2015_forms/* ReactiveFormsModule */.UX, public_api/* TuiAddonDocModule */.fV, core/* TuiTextfieldControllerModule */.cnw, core/* TuiErrorModule */.Shu, field_error/* TuiFieldErrorPipeModule */.Yu, core/* TuiLabelModule */.U8r, core/* TuiHintModule */.goS, kit/* TuiInputModule */.QfL, core/* TuiButtonModule */.fNO, kit/* TuiInputPhoneModule */.Kjg, kit/* TuiInputCountModule */.$HZ, core/* TuiLinkModule */.jzK, addon_table/* TuiTableModule */.jz, core/* TuiHintModule */.goS, kit/* TuiInputNumberModule */._Hh, addon_commerce/* TuiCurrencyPipeModule */.wc, tinkoff_ng_polymorpheus/* PolymorpheusModule */.wq, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiFieldErrorPipeComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiFieldErrorModule, {
    ...
    imports: [common/* CommonModule */.ez, fesm2015_forms/* ReactiveFormsModule */.UX, public_api/* TuiAddonDocModule */.fV, core/* TuiTextfieldControllerModule */.cnw, core/* TuiErrorModule */.Shu, field_error/* TuiFieldErrorPipeModule */.Yu, core/* TuiLabelModule */.U8r, core/* TuiHintModule */.goS, kit/* TuiInputModule */.QfL, core/* TuiButtonModule */.fNO, kit/* TuiInputPhoneModule */.Kjg, kit/* TuiInputCountModule */.$HZ, core/* TuiLinkModule */.jzK, addon_table/* TuiTableModule */.jz, core/* TuiHintModule */.goS, kit/* TuiInputNumberModule */._Hh, addon_commerce/* TuiCurrencyPipeModule */.wc, tinkoff_ng_polymorpheus/* PolymorpheusModule */.wq, router/* RouterModule */.Bz],
