...
let TuiZoomExample1 = /*#__PURE__*/(() => {
  class TuiZoomExample1 {
    constructor() {
      ...
      this.scale$ = this.delta$.pipe((0,scan/* scan */.R)((scale, next) => (0,cdk/* tuiClamp */.Kiv)(scale + next, 0.5, 3), 1), (0,startWith/* startWith */.O)(1));
...
let ExampleTuiZoomModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiZoomModule.ɵinj = /*@__PURE__*/core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, cdk/* TuiZoomModule */.RRg, public_api/* TuiAddonDocModule */.fV, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiZoomComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiZoomModule, {
    ...
    imports: [common/* CommonModule */.ez, cdk/* TuiZoomModule */.RRg, public_api/* TuiAddonDocModule */.fV, router/* RouterModule */.Bz],
