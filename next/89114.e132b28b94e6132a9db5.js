  ...
  class TuiInputDateTimeExample1 {
    constructor() {
      this.testForm = new fesm2015_forms/* FormGroup */.cw({
        testValue: new fesm2015_forms/* FormControl */.NI([new cdk/* TuiDay */.TU1(2017, 2, 15), null])
      });
    }
...
let TuiInputDateTimeExample3 = /*#__PURE__*/(() => {
  class TuiInputDateTimeExample3 {
    constructor() {
      this.control = new fesm2015_forms/* FormControl */.NI([new cdk/* TuiDay */.TU1(2017, 2, 15), new cdk/* TuiTime */.qDo(12, 30)]);
    }
...
let ExampleDateTimeTransformer = /*#__PURE__*/(() => {
  class ExampleDateTimeTransformer {
    ...
    fromControlValue(controlValue) {
      ...
      return day ? [cdk/* TuiDay.normalizeParse */.TU1.normalizeParse(day), time ? cdk/* TuiTime.fromString */.qDo.fromString(time) : null] : [null, null];
    }
...
let TuiInputDateTimeExample4 = /*#__PURE__*/(() => {
  ...
  TuiInputDateTimeExample4.ɵcmp = /*@__PURE__*/fesm2015_core/* ɵɵdefineComponent */.Xpm({
    ...
    features: [fesm2015_core/* ɵɵProvidersFeature */._Bn([{
      provide: kit/* TUI_DATE_TIME_VALUE_TRANSFORMER */.Mu,
...
let ExampleTuiInputDateTimeComponent = /*#__PURE__*/(() => {
  class ExampleTuiInputDateTimeComponent extends control/* AbstractExampleTuiControl */.b {
    constructor() {
      super(...arguments);
      this.today = cdk/* TuiDay.currentLocal */.TU1.currentLocal();
      ...
      this.minVariants = [cdk/* TUI_FIRST_DAY */.nNo, new cdk/* TuiDay */.TU1(2017, 2, 5), new cdk/* TuiDay */.TU1(1900, 0, 1), [this.today.append({
        day: -1
      }), new cdk/* TuiTime */.qDo(12, 20)]];
      this.min = this.minVariants[0];
      this.maxVariants = [cdk/* TUI_LAST_DAY */.OyN, new cdk/* TuiDay */.TU1(2017, 11, 11), new cdk/* TuiDay */.TU1(2020, 2, 5), new cdk/* TuiDay */.TU1(2300, 0, 1), [this.today.append({
        day: +1
      }), new cdk/* TuiTime */.qDo(16, 20)]];
      this.max = this.maxVariants[0];
      this.defaultActiveYearMonthVariants = [cdk/* TuiMonth.currentLocal */.qld.currentLocal(), new cdk/* TuiMonth */.qld(2020, 2), new cdk/* TuiMonth */.qld(2017, 2)];
      ...
      this.itemsVariants = [[], [new kit/* TuiNamedDay */.AIQ(cdk/* TUI_LAST_DAY.append */.OyN.append({
        year: -1
      }), `Unill today`)]];
...
let ExampleTuiInputDateTimeModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiInputDateTimeModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[public_api/* TuiAddonDocModule */.fV, inherited_documentation_module/* InheritedDocumentationModule */.f, fesm2015_forms/* ReactiveFormsModule */.UX, fesm2015_forms/* FormsModule */.u5, common/* CommonModule */.ez, core/* TuiLinkModule */.jzK, kit/* TuiInputDateTimeModule */.DAN, core/* TuiHintModule */.goS, core/* TuiTextfieldControllerModule */.cnw, core/* TuiNotificationModule */.HiG, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiInputDateTimeComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiInputDateTimeModule, {
    ...
    imports: [public_api/* TuiAddonDocModule */.fV, inherited_documentation_module/* InheritedDocumentationModule */.f, fesm2015_forms/* ReactiveFormsModule */.UX, fesm2015_forms/* FormsModule */.u5, common/* CommonModule */.ez, core/* TuiLinkModule */.jzK, kit/* TuiInputDateTimeModule */.DAN, core/* TuiHintModule */.goS, core/* TuiTextfieldControllerModule */.cnw, core/* TuiNotificationModule */.HiG, router/* RouterModule */.Bz],
