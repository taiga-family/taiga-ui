...
let TuiMonthExample2 = /*#__PURE__*/(() => {
  class TuiMonthExample2 {
    constructor() {
      this.value = null;
      this.max = new cdk/* TuiMonth */.qld(2021, 7);
      this.min = new cdk/* TuiMonth */.qld(2019, 7);
    }

    onMonthClick(month) {
      if (this.value === null || !this.value.isSingleMonth) {
        this.value = new cdk/* TuiMonthRange */.dtp(month, month);
        return;
      }

      this.value = cdk/* TuiMonthRange.sort */.dtp.sort(this.value.from, month);
    }
...
let ExampleTuiCalendarMonthComponent = /*#__PURE__*/(() => {
  class ExampleTuiCalendarMonthComponent {
    constructor(alertService) {
      ...
      this.maxVariants = [cdk/* TUI_LAST_DAY */.OyN, new cdk/* TuiMonth */.qld(2020, 2), new cdk/* TuiMonth */.qld(2023, 0), new cdk/* TuiMonth */.qld(2019, 4)];
      ...
      this.valueVariants = [cdk/* TuiDay.currentLocal */.TU1.currentLocal(), new cdk/* TuiMonthRange */.dtp(cdk/* TuiDay.currentLocal */.TU1.currentLocal(), cdk/* TuiDay.currentLocal */.TU1.currentLocal().append({
        month: 3
      })), new cdk/* TuiMonth */.qld(2007, 2)];
      this.value = null;
      this.yearVariants = [cdk/* TuiDay.currentLocal */.TU1.currentLocal(), new cdk/* TuiYear */.F4U(2007)];
  ...
  ExampleTuiCalendarMonthComponent.ɵfac = function ExampleTuiCalendarMonthComponent_Factory(t) {
    return new (t || ExampleTuiCalendarMonthComponent)(fesm2015_core/* ɵɵdirectiveInject */.Y36(core/* TuiAlertService */.J9F));
  };
...
let ExampleTuiCalendarMonthModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiCalendarMonthModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, router/* RouterModule */.Bz, core/* TuiLinkModule */.jzK, kit/* TuiCalendarMonthModule */.mlC, public_api/* TuiAddonDocModule */.fV, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiCalendarMonthComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiCalendarMonthModule, {
    ...
    imports: [common/* CommonModule */.ez, router/* RouterModule */.Bz, core/* TuiLinkModule */.jzK, kit/* TuiCalendarMonthModule */.mlC, public_api/* TuiAddonDocModule */.fV, router/* RouterModule */.Bz],
