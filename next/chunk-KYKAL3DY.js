    ...
    <ng-template pageTab>
        ...
        >
            <ng-template #dropdownMobileDescription>
                @if (!isMobile) {
                    <tui-notification class="tui-space_bottom-2">
    ...
    <ng-template pageTab>
        ...
        <table tuiDocAPI>
            ...
            <tbody
                ...
                tuiDocTextfield
            >
                <!--TODO: create the inherited documentation for Textfield [content] prop)-->
                <tr
                    name="[content]"
                    tuiDocAPIItem
                    type="PolymorpheusContent"
                    [items]="textfieldContentVariants()"
                    [(value)]="textfieldContent"
                >
                    A template for custom view of textfield value.

                    <p>
                        We strongly recommend to unset this property on focus \u2013 otherwise, it breaks UX on attempt to
                        edit field by keyboard!
                    </p>
                </tr>
            </tbody>
