...
let ExampleTuiFilterModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiFilterModule.ɵinj = /*@__PURE__*/core/* ɵɵdefineInjector */.cJS({
    imports: [[cdk/* TuiFilterPipeModule */.pLW, addon_commerce/* TuiMoneyModule */.DC, common/* CommonModule */.ez, public_api/* TuiAddonDocModule */.fV, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiFilterComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiFilterModule, {
    ...
    imports: [cdk/* TuiFilterPipeModule */.pLW, addon_commerce/* TuiMoneyModule */.DC, common/* CommonModule */.ez, public_api/* TuiAddonDocModule */.fV, router/* RouterModule */.Bz],
