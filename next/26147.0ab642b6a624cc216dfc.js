...
var finalize = __webpack_require__(68939);
...
function TuiInputFilesExample1_tui_input_files_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    fesm2015_core/* ɵɵelementStart */.TgZ(0, "tui-input-files", 5);
...
function TuiInputFilesExample1_tui_file_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const file_r6 = ctx.ngIf;
    fesm2015_core/* ɵɵproperty */.Q6J("file", file_r6);
  }
}
...
function TuiInputFilesExample1_tui_file_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    fesm2015_core/* ɵɵelementStart */.TgZ(0, "tui-file", 7);
    fesm2015_core/* ɵɵlistener */.NdJ("removed", function TuiInputFilesExample1_tui_file_4_Template_tui_file_removed_0_listener() {
      ...
      return ctx_r10.clearRejected();
    });
    fesm2015_core/* ɵɵelementEnd */.qZA();
  }

  if (rf & 2) {
    const file_r9 = ctx.ngIf;
    fesm2015_core/* ɵɵproperty */.Q6J("file", file_r9);
  }
}

function TuiInputFilesExample1_tui_file_6_Template(rf, ctx) {
  if (rf & 1) {
    fesm2015_core/* ɵɵelement */._UZ(0, "tui-file", 8);
  }

  if (rf & 2) {
    const file_r12 = ctx.ngIf;
...
let TuiInputFilesExample1 = /*#__PURE__*/(() => {
  class TuiInputFilesExample1 {
    constructor() {
      ...
      this.loadingFiles$ = new Subject/* Subject */.xQ();
      this.loadedFiles$ = this.control.valueChanges.pipe((0,switchMap/* switchMap */.w)(file => file ? this.makeRequest(file) : (0,of.of)(null)));
    }
    ...
    makeRequest(file) {
      ...
      return (0,timer/* timer */.H)(1000).pipe((0,map/* map */.U)(() => {
        if (Math.random() > 0.5) {
          return file;
        }
        ...
        this.rejectedFiles$.next(file);
        return null;
      }), (0,finalize/* finalize */.x)(() => this.loadingFiles$.next(null)));
    }
  ...
  TuiInputFilesExample1.ɵcmp = /*@__PURE__*/fesm2015_core/* ɵɵdefineComponent */.Xpm({
    ...
    decls: 8,
    vars: 10,
    consts: [["accept", "image/*", 3, "formControl", "reject", 4, "ngIf"], [1, "tui-space_top-1"], [3, "file", "removed", 4, "ngIf"], ["state", "error", 3, "file", "removed", 4, "ngIf"], ["state", "loading", 3, "file", 4, "ngIf"], ["accept", "image/*", 3, "formControl", "reject"], [3, "file", "removed"], ["state", "error", 3, "file", "removed"], ["state", "loading", 3, "file"]],
    template: function TuiInputFilesExample1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        fesm2015_core/* ɵɵtemplate */.YNc(6, TuiInputFilesExample1_tui_file_6_Template, 1, 1, "tui-file", 4);
      ...
      if (rf & 2) {
        ...
        fesm2015_core/* ɵɵproperty */.Q6J("ngIf", fesm2015_core/* ɵɵpipeBind1 */.lcZ(3, 4, ctx.loadedFiles$));
        fesm2015_core/* ɵɵadvance */.xp6(2);
        fesm2015_core/* ɵɵproperty */.Q6J("ngIf", fesm2015_core/* ɵɵpipeBind1 */.lcZ(5, 6, ctx.rejectedFiles$));
        fesm2015_core/* ɵɵadvance */.xp6(2);
        fesm2015_core/* ɵɵproperty */.Q6J("ngIf", fesm2015_core/* ɵɵpipeBind1 */.lcZ(7, 8, ctx.loadingFiles$));
      }
    },
