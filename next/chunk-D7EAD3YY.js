import"./chunk-B4AJQJMI.js";var t=`<tui-doc-page [header]="\`Guide to update Taiga UI v\${tuiMajor - 1}\xA0->\xA0v\${tuiMajor}\`">
    <div
        appearance="custom"
        tuiCardLarge
    >
        <header tuiHeader>
            <h1 tuiTitle>Before you update</h1>
        </header>
    ...
    >
        <header tuiHeader>
            <h1 tuiTitle>Update to the new version</h1>
        </header>
    ...
    >
        <header tuiHeader>
            <h1 tuiTitle>Troubleshooting</h1>
        </header>
