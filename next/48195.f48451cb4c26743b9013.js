...
function createControlValidator(handler) {
  return ({
    ...
    const invalidTags = value ? value.filter(handler) : cdk/* EMPTY_ARRAY */.LZ8;
    return invalidTags.length > 0 ? {
      tags: new cdk/* TuiValidationError */.T8v(`Some tags are invalid`)
    } : null;
  };
}
...
class TuiInputTagExample4 {
  ...
  filterBy(search, value) {
    return ITEMS.filter(item => (0,cdk/* TUI_DEFAULT_MATCHER */.LQM)(item, search) && !value.includes(item));
  }
...
(0,tslib_es6/* __decorate */.gn)([cdk/* tuiPure */.UMq], TuiInputTagExample4.prototype, "filterBy", null);
...
let ExampleTuiInputTagComponent = /*#__PURE__*/(() => {
  class ExampleTuiInputTagComponent extends control/* AbstractExampleTuiControl */.b {
    constructor() {
      ...
      this.tagValidatorVariants = [cdk/* ALWAYS_TRUE_HANDLER */.YeN, item => item === `test`, item => item !== `mail`];
      this.tagValidator = this.tagValidatorVariants[0];
      this.inputHidden = false;
      this.disabledItemHandlerVariants = [cdk/* ALWAYS_FALSE_HANDLER */.IyD, item => String(item)[0] === `T`];
...
let ExampleTuiInputTagModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiInputTagModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, fesm2015_forms/* FormsModule */.u5, fesm2015_forms/* ReactiveFormsModule */.UX, inherited_documentation_module/* InheritedDocumentationModule */.f, core/* TuiDataListModule */.pcV, kit/* TuiDataListWrapperModule */.zXW, core/* TuiLinkModule */.jzK, kit/* TuiInputTagModule */.cB5, core/* TuiErrorModule */.Shu, kit/* TuiFieldErrorPipeModule */.YuV, core/* TuiDropdownModule */.dpK, core/* TuiTextfieldControllerModule */.cnw, core/* TuiHintModule */.goS, public_api/* TuiAddonDocModule */.fV, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiInputTagComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiInputTagModule, {
    ...
    imports: [common/* CommonModule */.ez, fesm2015_forms/* FormsModule */.u5, fesm2015_forms/* ReactiveFormsModule */.UX, inherited_documentation_module/* InheritedDocumentationModule */.f, core/* TuiDataListModule */.pcV, kit/* TuiDataListWrapperModule */.zXW, core/* TuiLinkModule */.jzK, kit/* TuiInputTagModule */.cB5, core/* TuiErrorModule */.Shu, kit/* TuiFieldErrorPipeModule */.YuV, core/* TuiDropdownModule */.dpK, core/* TuiTextfieldControllerModule */.cnw, core/* TuiHintModule */.goS, public_api/* TuiAddonDocModule */.fV, router/* RouterModule */.Bz],
