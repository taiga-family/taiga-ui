...
(0,tslib_es6/* __decorate */.gn)([(0,cdk/* tuiRequiredSetter */.NH)(quantity => Number.isInteger(quantity) && quantity >= 5, `Should be integer number more than min value`)], ExampleTuiRequiredSetterDemoComponent.prototype, "quantity", null);
...
let ExampleTuiRequiredSetterModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiRequiredSetterModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, fesm2015_forms/* FormsModule */.u5, kit/* TuiInputCountModule */.$HZ, core/* TuiButtonModule */.fNO, public_api/* TuiAddonDocModule */.fV, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiRequiredSetterComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiRequiredSetterModule, {
    ...
    imports: [common/* CommonModule */.ez, fesm2015_forms/* FormsModule */.u5, kit/* TuiInputCountModule */.$HZ, core/* TuiButtonModule */.fNO, public_api/* TuiAddonDocModule */.fV, router/* RouterModule */.Bz],
