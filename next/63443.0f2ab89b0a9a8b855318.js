  ...
  class TuiInputMonthRangeExample3 {
    constructor() {
      ...
      this.disabledItemHandler = (item, context) => {
        return !!context && !!context.value && context.value instanceof cdk.TuiMonthRange && !!context.value.isSingleMonth && item.month < context.value.from.month + 2;
      };
    }
...
let ExampleTuiInputMonthRangeModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiInputMonthRangeModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[public_api/* TuiAddonDocModule */.fV, inherited_documentation_module/* InheritedDocumentationModule */.f, fesm2015_forms/* ReactiveFormsModule */.UX, fesm2015_forms/* FormsModule */.u5, common/* CommonModule */.ez, core.TuiLinkModule, core.TuiButtonModule, kit.TuiInputMonthRangeModule, core.TuiTextfieldControllerModule, core.TuiHintModule, core.TuiNotificationModule, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiInputMonthRangeComponent))]]
  });
