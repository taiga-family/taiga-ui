import"./chunk-B4AJQJMI.js";var i=`<tui-doc-page [header]="\`Migration Guide (v\${tuiMajor - 1}\xA0->\xA0v\${tuiMajor})\`">
    <section>
        <h2>Prerequisites</h2>
        <ul class="tui-list">
    ...
    <section>
        ...
        <h3 class="tui-space_bottom-0">Nx CLI</h3>
        <p tuiNotification>
            Ensure your Nx version is compatible with
            <a
                href="https://nx.dev/docs/technologies/angular/guides/angular-nx-version-matrix#nx-and-angular-version-compatibility-matrix"
                target="_blank"
                tuiLink
            >
                Angular v{{ ngMajor }}+
            ...
            and
            <a
                href="https://nx.dev/docs/reference/nodejs-typescript-compatibility#nodejs-compatibility-matrix"
                target="_blank"
                tuiLink
            >
                installed Node.js
    ...
    <section>
        ...
        <ul class="tui-list">
            ...
            <li class="tui-list__item">
                ...
                you find inside this package in the {{ tuiMajor }}th major release will be removed in the
        ...
        <tui-accordion>
            ...
            <tui-expand>
                <div class="tui-space_bottom-4">
                    ...
                    memory-intensive. If you encounter this error, try increasing the memory limit for the Node.js
                    process.
                </div>
