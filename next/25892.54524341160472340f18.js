...
(0,tslib_es6/* __decorate */.gn)([(0,cdk/* tuiDefaultProp */.THR)(quantity => Number.isInteger(quantity) && quantity >= 5, `Should be integer number more than min value`)], ExampleTuiDefaultPropDemoComponent.prototype, "quantity", void 0);
...
let ExampleTuiDefaultPropModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiDefaultPropModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, fesm2015_forms/* FormsModule */.u5, core/* TuiLinkModule */.jzK, kit/* TuiInputCountModule */.$HZ, core/* TuiButtonModule */.fNO, public_api/* TuiAddonDocModule */.fV, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiDefaultPropComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiDefaultPropModule, {
    ...
    imports: [common/* CommonModule */.ez, fesm2015_forms/* FormsModule */.u5, core/* TuiLinkModule */.jzK, kit/* TuiInputCountModule */.$HZ, core/* TuiButtonModule */.fNO, public_api/* TuiAddonDocModule */.fV, router/* RouterModule */.Bz],
