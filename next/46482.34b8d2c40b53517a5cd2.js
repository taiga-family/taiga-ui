...
let CustomListComponent = /*#__PURE__*/(() => {
  class CustomListComponent {
    constructor() {
      ...
      this.filter = cdk.TUI_DEFAULT_MATCHER;
    }
    ...
    onKeyDown(key, element) {
      if (element && (0,core.tuiIsEditingKey)(key)) {
        element.focus({
          preventScroll: true
        });
      }
...
let TuiDataListExample2 = /*#__PURE__*/(() => {
  ...
  TuiDataListExample2.ɵfac = function TuiDataListExample2_Factory(t) {
    return new (t || TuiDataListExample2)(fesm2015_core/* ɵɵdirectiveInject */.Y36(core.TuiDialogService));
  };
...
let TuiDataListExample5 = /*#__PURE__*/(() => {
  class TuiDataListExample5 {
    constructor() {
      this.dropdownOpen = false;
      this.dateValue = new cdk.TuiDay(2020, 0, 1);
      ...
      this.rangeValue = new cdk.TuiDayRange(cdk.TuiDay.currentLocal(), cdk.TuiDay.currentLocal().append({
        year: 1
      }));
    }
...
let TuiDataListExample6 = /*#__PURE__*/(() => {
  ...
  TuiDataListExample6.ɵfac = function TuiDataListExample6_Factory(t) {
    return new (t || TuiDataListExample6)(fesm2015_core/* ɵɵdirectiveInject */.Y36(cdk.TUI_IS_MOBILE));
  };
...
let ExampleTuiDataListModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiDataListModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, fesm2015_forms/* FormsModule */.u5, fesm2015_forms/* ReactiveFormsModule */.UX, cdk.TuiLetModule, kit.TuiMultiSelectModule, core.TuiPrimitiveTextfieldModule, kit.TuiSelectModule, core.TuiTextfieldControllerModule, kit.TuiArrowModule, core.TuiNotificationModule, core.TuiDataListModule, kit.TuiDataListDropdownManagerModule, core.TuiSvgModule, core.TuiHostedDropdownModule, core.TuiButtonModule, core.TuiDropdownModule, cdk.TuiActiveZoneModule, public_api/* TuiAddonDocModule */.fV, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiDataListComponent)), cdk.TuiFilterPipeModule, core.TuiCalendarModule, kit.TuiInputModule, kit.TuiInputDateRangeModule, addon_commerce.TuiMoneyModule, core.TuiGroupModule]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiDataListModule, {
    ...
    imports: [common/* CommonModule */.ez, fesm2015_forms/* FormsModule */.u5, fesm2015_forms/* ReactiveFormsModule */.UX, cdk.TuiLetModule, kit.TuiMultiSelectModule, core.TuiPrimitiveTextfieldModule, kit.TuiSelectModule, core.TuiTextfieldControllerModule, kit.TuiArrowModule, core.TuiNotificationModule, core.TuiDataListModule, kit.TuiDataListDropdownManagerModule, core.TuiSvgModule, core.TuiHostedDropdownModule, core.TuiButtonModule, core.TuiDropdownModule, cdk.TuiActiveZoneModule, public_api/* TuiAddonDocModule */.fV, router/* RouterModule */.Bz, cdk.TuiFilterPipeModule, core.TuiCalendarModule, kit.TuiInputModule, kit.TuiInputDateRangeModule, addon_commerce.TuiMoneyModule, core.TuiGroupModule],
