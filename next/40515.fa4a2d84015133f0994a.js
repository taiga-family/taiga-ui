  ...
  class TuiInputDateExample1 {
    constructor() {
      this.testForm = new fesm2015_forms/* FormGroup */.cw({
        testValue: new fesm2015_forms/* FormControl */.NI(new cdk/* TuiDay */.TU1(2017, 0, 15))
      });
    }
...
let TuiInputDateExample2 = /*#__PURE__*/(() => {
  class TuiInputDateExample2 {
    constructor() {
      this.testForm = new fesm2015_forms/* FormGroup */.cw({
        testValue: new fesm2015_forms/* FormControl */.NI(new cdk/* TuiDay */.TU1(2017, 2, 15))
      });
    }
...
let TuiInputDateExample3 = /*#__PURE__*/(() => {
  class TuiInputDateExample3 {
    constructor() {
      this.from = null;
      this.to = null;
      this.min = new cdk/* TuiDay */.TU1(2017, 9, 4);
      this.max = cdk/* TuiDay.currentLocal */.TU1.currentLocal();
      this.items = [new kit/* TuiNamedDay */.AIQ(cdk/* TUI_LAST_DAY.append */.OyN.append({
        year: -1
      }), `Until today`, cdk/* TuiDay.currentLocal */.TU1.currentLocal())];
    }
...
let TuiInputDateExample4 = /*#__PURE__*/(() => {
  class TuiInputDateExample4 {
    constructor() {
      this.control = new fesm2015_forms/* FormControl */.NI(new cdk/* TuiDay */.TU1(2017, 0, 15));
    }
...
let TuiInputDateExample5 = /*#__PURE__*/(() => {
  class TuiInputDateExample5 {
    constructor() {
      ...
      this.defaultControl = new fesm2015_forms/* FormControl */.NI(new cdk/* TuiDay */.TU1(2022, 0, 26));
    }
...
let ExampleTuiInputDateComponent = /*#__PURE__*/(() => {
  class ExampleTuiInputDateComponent extends control/* AbstractExampleTuiControl */.b {
    constructor() {
      ...
      this.maxVariants = [cdk/* TUI_LAST_DAY */.OyN, new cdk/* TuiDay */.TU1(2017, 11, 11), new cdk/* TuiDay */.TU1(2020, 2, 5), new cdk/* TuiDay */.TU1(2300, 0, 1)];
...
let ExampleTuiInputDateModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiInputDateModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[public_api/* TuiAddonDocModule */.fV, inherited_documentation_module/* InheritedDocumentationModule */.f, fesm2015_forms/* ReactiveFormsModule */.UX, fesm2015_forms/* FormsModule */.u5, common/* CommonModule */.ez, core/* TuiLinkModule */.jzK, kit/* TuiRadioListModule */.Ltw, core/* TuiButtonModule */.fNO, kit/* TuiInputDateModule */.hr9, addon_mobile/* TuiMobileCalendarDialogModule */.nw, kit/* TuiUnfinishedValidatorModule */.hsT, core/* TuiTextfieldControllerModule */.cnw, core/* TuiHintModule */.goS, core/* TuiErrorModule */.Shu, kit/* TuiFieldErrorPipeModule */.YuV, core/* TuiNotificationModule */.HiG, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiInputDateComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiInputDateModule, {
    ...
    imports: [public_api/* TuiAddonDocModule */.fV, inherited_documentation_module/* InheritedDocumentationModule */.f, fesm2015_forms/* ReactiveFormsModule */.UX, fesm2015_forms/* FormsModule */.u5, common/* CommonModule */.ez, core/* TuiLinkModule */.jzK, kit/* TuiRadioListModule */.Ltw, core/* TuiButtonModule */.fNO, kit/* TuiInputDateModule */.hr9, addon_mobile/* TuiMobileCalendarDialogModule */.nw, kit/* TuiUnfinishedValidatorModule */.hsT, core/* TuiTextfieldControllerModule */.cnw, core/* TuiHintModule */.goS, core/* TuiErrorModule */.Shu, kit/* TuiFieldErrorPipeModule */.YuV, core/* TuiNotificationModule */.HiG, router/* RouterModule */.Bz],
