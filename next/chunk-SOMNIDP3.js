...
>
    <ng-template pageTab>
        ...
        <tui-doc-example
            id="custom-dropdown"
            description="You can customize dropdown content and even extend its template"
        ...
        >
            <ng-template #mobile>
                @if (!isMobile) {
                    <tui-notification>
                        Open this on a mobile device or enable emulation in DevTools and refresh the page to explore
                        this example!
                    </tui-notification>
                }

                <p>You can use several different approaches to optimize UX on mobile devices when tapping the icon.</p>
                ...
                <tui-notification appearance="warning">
                    ...
                    <div>Native picker supports only 24-hour format.</div>
                </tui-notification>
            </ng-template>
        </tui-doc-example>
