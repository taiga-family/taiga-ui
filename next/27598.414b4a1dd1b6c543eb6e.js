...
let TuiPieChartExample2 = /*#__PURE__*/(() => {
  ...
  TuiPieChartExample2.ɵcmp = /*@__PURE__*/fesm2015_core/* ɵɵdefineComponent */.Xpm({
    ...
    directives: [pie_chart_component/* TuiPieChartComponent */.W, hint_options_directive/* TuiHintOptionsDirective */.b, money_component/* TuiMoneyComponent */.o],
...
let ExampleTuiPieChartComponent = /*#__PURE__*/(() => {
  class ExampleTuiPieChartComponent {
    ...
    getPercent(index) {
      return `${(0,cdk/* tuiRound */.FGw)(100 * this.value[index] / (0,cdk/* tuiSum */.smb)(...this.value), 2)} %`;
    }

    format(index) {
      return `${(0,core/* tuiFormatNumber */.lx_)(this.value[index])} ${(0,addon_commerce/* tuiGetCurrencySymbol */.CE)("RUB"
      /* Ruble */
      )}`;
    }
...
let ExampleTuiPieChartModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiPieChartModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, router/* RouterModule */.Bz, addon_charts/* TuiPieChartModule */.UA, addon_commerce/* TuiMoneyModule */.DC, tinkoff_ng_polymorpheus/* PolymorpheusModule */.wq, public_api/* TuiAddonDocModule */.fV, core/* TuiHintModule */.goS, core/* TuiNotificationModule */.HiG, core/* TuiLinkModule */.jzK, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiPieChartComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiPieChartModule, {
    ...
    imports: [common/* CommonModule */.ez, router/* RouterModule */.Bz, addon_charts/* TuiPieChartModule */.UA, addon_commerce/* TuiMoneyModule */.DC, tinkoff_ng_polymorpheus/* PolymorpheusModule */.wq, public_api/* TuiAddonDocModule */.fV, core/* TuiHintModule */.goS, core/* TuiNotificationModule */.HiG, core/* TuiLinkModule */.jzK, router/* RouterModule */.Bz],
