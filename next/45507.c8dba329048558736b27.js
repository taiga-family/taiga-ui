...
let ExampleTuiReorderModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiReorderModule.ɵinj = /*@__PURE__*/core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, reorder/* TuiReorderModule */.B, public_api/* TuiAddonDocModule */.fV, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiReorderComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiReorderModule, {
    ...
    imports: [common/* CommonModule */.ez, reorder/* TuiReorderModule */.B, public_api/* TuiAddonDocModule */.fV, router/* RouterModule */.Bz],
