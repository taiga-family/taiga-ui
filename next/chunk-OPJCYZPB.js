        ...
        @for (example of examples; track example) {
            ...
            <ng-template #description>
                @switch ($index) {
                    ...
                    @case (6) {
                        On mobile, especially when font scaling is enabled for accessibility, you have limited space and
                        might want to make sure the entire label is visible when the user fills it in. You can enable
                        wrapping so it can wrap onto multiple lines.
                    }
                }
            </ng-template>
        }
    ...
    <ng-template pageTab>
        ...
        <table tuiDocAPI>
            <tr
                ...
                [(value)]="value"
            >
                text value (alternatively use reactive forms)
            </tr>
            <tr
                name="[filler]"
                tuiDocAPIItem
