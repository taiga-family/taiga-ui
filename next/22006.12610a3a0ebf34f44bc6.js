  ...
  class TuiInputTimeExample1 {
    constructor() {
      this.testForm = new fesm2015_forms/* FormGroup */.cw({
        testValue: new fesm2015_forms/* FormControl */.NI(new cdk/* TuiTime */.qDo(12, 30))
      });
    }
...
let TuiInputTimeExample2 = /*#__PURE__*/(() => {
  class TuiInputTimeExample2 {
    constructor() {
      ...
      this.items1 = (0,kit/* tuiCreateTimePeriods */.eNV)();
      this.items2 = (0,kit/* tuiCreateTimePeriods */.eNV)(10, 20, [0, 15, 30, 45]);
    }
...
let TuiInputTimeExample3 = /*#__PURE__*/(() => {
  ...
  TuiInputTimeExample3.ɵcmp = /*@__PURE__*/fesm2015_core/* ɵɵdefineComponent */.Xpm({
    ...
    features: [fesm2015_core/* ɵɵProvidersFeature */._Bn([(0,kit/* tuiInputTimeOptionsProvider */.pkP)({
...
let ExampleTuiInputTimeComponent = /*#__PURE__*/(() => {
  class ExampleTuiInputTimeComponent extends control/* AbstractExampleTuiControl */.b {
    constructor() {
      ...
      this.cleaner = false;
      this.control = new fesm2015_forms/* FormControl */.NI(cdk/* TuiTime.currentLocal */.qDo.currentLocal(), fesm2015_forms/* Validators.required */.kI.required);
      this.disabledItemHandlerVariants = [cdk/* ALWAYS_FALSE_HANDLER */.IyD, item => {
        return String(item) === `06:00` || item > cdk/* TuiTime.currentLocal */.qDo.currentLocal();
      }];
      ...
      this.itemsVariants = [[], (0,kit/* tuiCreateTimePeriods */.eNV)()];
...
let ExampleTuiInputTimeModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiInputTimeModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, fesm2015_forms/* FormsModule */.u5, fesm2015_forms/* ReactiveFormsModule */.UX, kit/* TuiInputTimeModule */.$K_, core/* TuiLinkModule */.jzK, inherited_documentation_module/* InheritedDocumentationModule */.f, core/* TuiButtonModule */.fNO, core/* TuiDropdownModule */.dpK, core/* TuiTextfieldControllerModule */.cnw, core/* TuiHintModule */.goS, kit/* TuiToggleModule */.YMv, public_api/* TuiAddonDocModule */.fV, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiInputTimeComponent)), kit/* TuiUnfinishedValidatorModule */.hsT]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiInputTimeModule, {
    ...
    imports: [common/* CommonModule */.ez, fesm2015_forms/* FormsModule */.u5, fesm2015_forms/* ReactiveFormsModule */.UX, kit/* TuiInputTimeModule */.$K_, core/* TuiLinkModule */.jzK, inherited_documentation_module/* InheritedDocumentationModule */.f, core/* TuiButtonModule */.fNO, core/* TuiDropdownModule */.dpK, core/* TuiTextfieldControllerModule */.cnw, core/* TuiHintModule */.goS, kit/* TuiToggleModule */.YMv, public_api/* TuiAddonDocModule */.fV, router/* RouterModule */.Bz, kit/* TuiUnfinishedValidatorModule */.hsT],
