...
// UNUSED EXPORTS: TUI_STUCK, TUI_STUCK_PROVIDER, TUI_TABLE_PAGINATION_DEFAULT_OPTIONS, TUI_TABLE_PAGINATION_OPTIONS, TUI_TABLE_PROVIDER, TUI_TABLE_PROVIDERS, TuiCellDirective, TuiReorderComponent, TuiResizedDirective, TuiRowDirective, TuiSortByDirective, TuiSortableDirective, TuiTableDirective, TuiTablePaginationComponent, TuiTableSortPipe, TuiTbodyComponent, TuiTdComponent, TuiThComponent, TuiThGroupComponent, TuiTheadDirective, TuiTrComponent
...
let TuiTableModule = /*#__PURE__*/(() => {
  ...
  TuiTableModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, tinkoff_ng_polymorpheus/* PolymorpheusModule */.wq, cdk/* TuiMapperPipeModule */.I1h, core/* TuiSvgModule */.EIu]]
  });
...
let TuiTablePaginationModule = /*#__PURE__*/(() => {
  ...
  TuiTablePaginationModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, core/* TuiButtonModule */.fNO, core/* TuiLinkModule */.jzK, core/* TuiHostedDropdownModule */.jhF, core/* TuiDataListModule */.pcV, core/* TuiSvgModule */.EIu, tinkoff_ng_polymorpheus/* PolymorpheusModule */.wq]]
  });
...
/* harmony export */ });
/* unused harmony export TUI_TABLE_PAGINATION_DEFAULT_OPTIONS */
...
(0,tslib__WEBPACK_IMPORTED_MODULE_13__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_1__/* .tuiDefaultProp */ .THR)()], TuiTablePaginationComponent.prototype, "items", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_13__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_1__/* .tuiDefaultProp */ .THR)()], TuiTablePaginationComponent.prototype, "total", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_13__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_1__/* .tuiDefaultProp */ .THR)()], TuiTablePaginationComponent.prototype, "page", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_13__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_1__/* .tuiDefaultProp */ .THR)()], TuiTablePaginationComponent.prototype, "size", void 0);
...
(0,tslib__WEBPACK_IMPORTED_MODULE_2__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiDefaultProp */ .THR)()], TuiCellDirective.prototype, "tuiCell", void 0);
...
let TuiResizedDirective = /*#__PURE__*/(() => {
  class TuiResizedDirective {
    constructor(documentRef, elementRef, parentRef) {
      ...
      this.tuiResized = (0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiTypedFromEvent */ .mLY)(this.elementRef.nativeElement, `mousedown`).pipe((0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiPreventDefault */ .mp3)(), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__/* .switchMap */ .w)(() => {
        const {
          width,
          right
        } = this.parentRef.nativeElement.getBoundingClientRect();
        return (0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiTypedFromEvent */ .mLY)(this.documentRef, `mousemove`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__/* .distinctUntilChanged */ .x)(), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_4__/* .map */ .U)(({
          clientX
        }) => width + clientX - right), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__/* .takeUntil */ .R)((0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiTypedFromEvent */ .mLY)(this.documentRef, `mouseup`)));
      }));
    }
...
(0,tslib__WEBPACK_IMPORTED_MODULE_2__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiDefaultProp */ .THR)()], TuiRowDirective.prototype, "tuiRowOf", void 0);
...
class TuiSortByDirective {
  constructor(table) {
    this.table = table;
    this.sortables = _taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_QUERY */ .Mmc;
    this.tuiSortBy = null;
...
(0,tslib__WEBPACK_IMPORTED_MODULE_6__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiDefaultProp */ .THR)()], TuiSortByDirective.prototype, "tuiSortBy", void 0);
...
class TuiTableDirective extends _taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .AbstractTuiController */ .QJb {
...
TuiTableDirective.ɵfac = function TuiTableDirective_Factory(t) {
  return new (t || TuiTableDirective)(_angular_core__WEBPACK_IMPORTED_MODULE_4__/* ["ɵɵdirectiveInject"] */ .Y36(_ng_web_apis_intersection_observer__WEBPACK_IMPORTED_MODULE_5__/* .IntersectionObserverService */ .te), _angular_core__WEBPACK_IMPORTED_MODULE_4__/* ["ɵɵdirectiveInject"] */ .Y36(_taiga_ui_core__WEBPACK_IMPORTED_MODULE_1__/* .TUI_MODE */ .Auc), _angular_core__WEBPACK_IMPORTED_MODULE_4__/* ["ɵɵdirectiveInject"] */ .Y36(_providers_stuck_provider__WEBPACK_IMPORTED_MODULE_2__/* .TUI_STUCK */ .I), _angular_core__WEBPACK_IMPORTED_MODULE_4__/* ["ɵɵdirectiveInject"] */ .Y36(_angular_core__WEBPACK_IMPORTED_MODULE_4__/* .ChangeDetectorRef */ .sBO));
};
...
(0,tslib__WEBPACK_IMPORTED_MODULE_6__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiDefaultProp */ .THR)()], TuiTableDirective.prototype, "columns", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_6__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiDefaultProp */ .THR)()], TuiTableDirective.prototype, "size", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_6__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiDefaultProp */ .THR)()], TuiTableDirective.prototype, "direction", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_6__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiDefaultProp */ .THR)()], TuiTableDirective.prototype, "sorter", void 0);
...
(0,tslib__WEBPACK_IMPORTED_MODULE_3__/* .__decorate */ .gn)([_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiPure */ .UMq], TuiTableSortPipe.prototype, "sort", null);
...
const TUI_TABLE_PROVIDER = [_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .TuiDestroyService */ .a31, _pipes_table_sort_pipe__WEBPACK_IMPORTED_MODULE_3__/* .TuiTableSortPipe */ .y, {
  provide: _directives_table_directive__WEBPACK_IMPORTED_MODULE_2__/* .TuiTableDirective */ .c,
  deps: [[new _angular_core__WEBPACK_IMPORTED_MODULE_4__/* .SkipSelf */ .tp0(), _directives_table_directive__WEBPACK_IMPORTED_MODULE_2__/* .TuiTableDirective */ .c], _angular_core__WEBPACK_IMPORTED_MODULE_4__/* .ChangeDetectorRef */ .sBO, _taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .TuiDestroyService */ .a31],
  useFactory: _taiga_ui_core__WEBPACK_IMPORTED_MODULE_1__/* .tuiWatchedControllerFactory */ .wDf
}];
...
const TUI_TABLE_PROVIDERS = [{
  ...
  provide: _taiga_ui_core__WEBPACK_IMPORTED_MODULE_0__/* .TUI_TEXTFIELD_APPEARANCE */ .jtC,
  useValue: "table"
  /* Table */

}, {
  provide: _taiga_ui_core__WEBPACK_IMPORTED_MODULE_0__/* .TUI_TEXTFIELD_LABEL_OUTSIDE */ .rWk,
  useValue: {
    labelOutside: true
  }
}, {
  provide: _taiga_ui_kit__WEBPACK_IMPORTED_MODULE_1__/* .TUI_INPUT_COUNT_OPTIONS */ .lfu,
  deps: [[new _angular_core__WEBPACK_IMPORTED_MODULE_5__/* .SkipSelf */ .tp0(), _taiga_ui_kit__WEBPACK_IMPORTED_MODULE_1__/* .TUI_INPUT_COUNT_OPTIONS */ .lfu]],
  useFactory: options => Object.assign(Object.assign({}, options), {
    hideButtons: true
  })
}, {
  provide: _taiga_ui_core__WEBPACK_IMPORTED_MODULE_0__/* .TUI_TEXTFIELD_SIZE */ .kId,
...
}, _ng_web_apis_intersection_observer__WEBPACK_IMPORTED_MODULE_4__/* .IntersectionObserverService */ .te, _taiga_ui_core__WEBPACK_IMPORTED_MODULE_0__/* .MODE_PROVIDER */ .CV2, _stuck_provider__WEBPACK_IMPORTED_MODULE_3__/* .TUI_STUCK_PROVIDER */ .y];
...
class TuiTbodyComponent {
  constructor(pipe, table) {
    ...
    this.rows = _taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_QUERY */ .Mmc;
...
(0,tslib__WEBPACK_IMPORTED_MODULE_11__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiDefaultProp */ .THR)()], TuiTbodyComponent.prototype, "data", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_11__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiDefaultProp */ .THR)()], TuiTbodyComponent.prototype, "heading", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_11__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiDefaultProp */ .THR)()], TuiTbodyComponent.prototype, "open", void 0);
...
let TuiThGroupComponent = /*#__PURE__*/(() => {
  class TuiThGroupComponent {
    constructor(table) {
      this.table = table;
      this.heads = _taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_QUERY */ .Mmc;
      this.heads$ = null;
    }
...
class TuiThComponent {
  ...
  get key() {
    if (!this.head) {
      throw new _taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_1__/* .TuiTableSortKeyException */ .m2r();
    }
...
TuiThComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_6__/* ["ɵɵdefineComponent"] */ .Xpm({
  ...
  features: [_angular_core__WEBPACK_IMPORTED_MODULE_6__/* ["ɵɵProvidersFeature"] */ ._Bn([{
    provide: _taiga_ui_core__WEBPACK_IMPORTED_MODULE_2__/* .TUI_ELEMENT_REF */ .zPU,
...
(0,tslib__WEBPACK_IMPORTED_MODULE_9__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_1__/* .tuiDefaultProp */ .THR)()], TuiThComponent.prototype, "sorter", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_9__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_1__/* .tuiDefaultProp */ .THR)()], TuiThComponent.prototype, "resizable", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_9__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_1__/* .tuiDefaultProp */ .THR)()], TuiThComponent.prototype, "sticky", void 0);
...
class TuiTrComponent {
  constructor(table, body) {
    this.table = table;
    this.body = body;
    this.cells = _taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .EMPTY_QUERY */ .Mmc;
...
(0,tslib__WEBPACK_IMPORTED_MODULE_10__/* .__decorate */ .gn)([_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiPure */ .UMq], TuiTrComponent.prototype, "$keyof", null);
...
let TuiGenericFilterDirective = /*#__PURE__*/(() => {
  class TuiGenericFilterDirective extends _abstract_table_filter__WEBPACK_IMPORTED_MODULE_1__/* .AbstractTuiTableFilter */ .Y {
    constructor() {
      super(...arguments);
      this.tuiGenericFilter = _taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .ALWAYS_TRUE_HANDLER */ .YeN;
    }
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "tk": () => (/* reexport */ components/* TuiReorderModule */.tk),
  "yt": () => (/* reexport */ TuiTableFiltersModule),
  "jz": () => (/* reexport */ components/* TuiTableModule */.jz),
  "y3": () => (/* reexport */ components/* TuiTablePaginationModule */.y3),
  "A2": () => (/* reexport */ utils/* tuiDefaultSort */.A),
  "PT": () => (/* reexport */ components/* tuiTablePaginationOptionsProvider */.PT)
});

// UNUSED EXPORTS: AbstractTuiTableFilter, TUI_STUCK, TUI_STUCK_PROVIDER, TUI_TABLE_PAGINATION_DEFAULT_OPTIONS, TUI_TABLE_PAGINATION_OPTIONS, TUI_TABLE_PAGINATION_TEXTS, TUI_TABLE_PROVIDER, TUI_TABLE_PROVIDERS, TUI_TABLE_SHOW_HIDE_MESSAGE, TuiCellDirective, TuiGenericFilterDirective, TuiHeadDirective, TuiReorderComponent, TuiResizedDirective, TuiRowDirective, TuiSortByDirective, TuiSortableDirective, TuiTableDirective, TuiTableFilterDirective, TuiTableFiltersDirective, TuiTableFiltersPipe, TuiTablePaginationComponent, TuiTableSortPipe, TuiTbodyComponent, TuiTdComponent, TuiThComponent, TuiThGroupComponent, TuiTheadDirective, TuiTrComponent
...
function tuiDefaultSort(x, y) {
  const a = x instanceof cdk/* TuiDay */.TU1 ? Number(x.toUtcNativeDate()) : x;
  const b = y instanceof cdk/* TuiDay */.TU1 ? Number(y.toUtcNativeDate()) : y;

  if (a === b) {
    return 0;
  }

  if ((0,cdk/* tuiIsString */.Ajw)(a) && (0,cdk/* tuiIsString */.Ajw)(b)) {
