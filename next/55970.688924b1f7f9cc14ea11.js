"use strict";
(self["webpackChunk_taiga_ui_components"] = self["webpackChunk_taiga_ui_components"] || []).push([[55970],{
...
(0,tslib__WEBPACK_IMPORTED_MODULE_4__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiDefaultProp */ .THR)()], TuiCardComponent.prototype, "active", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_4__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiDefaultProp */ .THR)()], TuiCardComponent.prototype, "brandLogo", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_4__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiDefaultProp */ .THR)(({
  length
}) => !length || length === 4, `cardNumber should contain 4 symbols`)], TuiCardComponent.prototype, "cardNumber", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_4__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiDefaultProp */ .THR)()], TuiCardComponent.prototype, "paymentSystem", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_4__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiDefaultProp */ .THR)()], TuiCardComponent.prototype, "size", void 0);
...
/* harmony import */ var _taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(40287);
/* harmony import */ var _taiga_ui_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(66187);
...
/* harmony import */ var _cdk_directives_let_let_directive__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(5723);
...
class TuiInputCardGroupedComponent extends _taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_2__/* .AbstractTuiNullableControl */ .F9l {
  constructor(control, changeDetectorRef, elementRef, mode$, cardGroupedTexts$, appearance) {
    ...
    this.maskCVC = {
      mask: new Array(3).fill(_taiga_ui_core__WEBPACK_IMPORTED_MODULE_3__/* .TUI_DIGIT_REGEXP */ .hW1),
      guide: false
    };
    this.maskCard = {
    ...
    this.maskExpire = {
      mask: [_taiga_ui_core__WEBPACK_IMPORTED_MODULE_3__/* .TUI_DIGIT_REGEXP */ .hW1, _taiga_ui_core__WEBPACK_IMPORTED_MODULE_3__/* .TUI_DIGIT_REGEXP */ .hW1, `/`, _taiga_ui_core__WEBPACK_IMPORTED_MODULE_3__/* .TUI_DIGIT_REGEXP */ .hW1, _taiga_ui_core__WEBPACK_IMPORTED_MODULE_3__/* .TUI_DIGIT_REGEXP */ .hW1],
  ...
  set codeLength(length) {
    ...
    this.maskCVC = {
      mask: new Array(length).fill(_taiga_ui_core__WEBPACK_IMPORTED_MODULE_3__/* .TUI_DIGIT_REGEXP */ .hW1),
      guide: false
    };
  }
  ...
  get focused() {
    return this.open || (0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_2__/* .tuiIsNativeFocusedIn */ .zb4)(this.elementRef.nativeElement);
  }
  ...
  get cardPrefilled() {
    return !!this.card.match(_taiga_ui_core__WEBPACK_IMPORTED_MODULE_3__/* .TUI_NON_DIGIT_REGEXP */ .W6H);
  }

  get cvcPrefilled() {
    return !!this.cvc.match(_taiga_ui_core__WEBPACK_IMPORTED_MODULE_3__/* .TUI_NON_DIGIT_REGEXP */ .W6H);
  }
  ...
  onMouseDown(event) {
    if ((0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_2__/* .tuiIsElement */ .veZ)(event.target) && (0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_2__/* .tuiIsInput */ .LsU)(event.target)) {
      return;
    }
  ...
  onScroll({
    ...
    if ((0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_2__/* .tuiIsElement */ .veZ)(currentTarget)) {
  ...
  get cardFocused() {
    return !!this.inputCard && (0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_2__/* .tuiIsNativeFocused */ .V8W)(this.inputCard.nativeElement);
  }
...
TuiInputCardGroupedComponent.ɵfac = function TuiInputCardGroupedComponent_Factory(t) {
  return new (t || TuiInputCardGroupedComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_15__/* ["ɵɵdirectiveInject"] */ .Y36(_angular_forms__WEBPACK_IMPORTED_MODULE_16__/* .NgControl */ .a5, 10), _angular_core__WEBPACK_IMPORTED_MODULE_15__/* ["ɵɵdirectiveInject"] */ .Y36(_angular_core__WEBPACK_IMPORTED_MODULE_15__/* .ChangeDetectorRef */ .sBO), _angular_core__WEBPACK_IMPORTED_MODULE_15__/* ["ɵɵdirectiveInject"] */ .Y36(_angular_core__WEBPACK_IMPORTED_MODULE_15__/* .ElementRef */ .SBq), _angular_core__WEBPACK_IMPORTED_MODULE_15__/* ["ɵɵdirectiveInject"] */ .Y36(_taiga_ui_core__WEBPACK_IMPORTED_MODULE_3__/* .TUI_MODE */ .Auc), _angular_core__WEBPACK_IMPORTED_MODULE_15__/* ["ɵɵdirectiveInject"] */ .Y36(_input_card_grouped_providers__WEBPACK_IMPORTED_MODULE_4__/* .TUI_INPUT_CARD_GROUPED_TEXTS */ .m), _angular_core__WEBPACK_IMPORTED_MODULE_15__/* ["ɵɵdirectiveInject"] */ .Y36(_taiga_ui_core__WEBPACK_IMPORTED_MODULE_3__/* .TUI_TEXTFIELD_APPEARANCE */ .jtC));
};
...
TuiInputCardGroupedComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_15__/* ["ɵɵdefineComponent"] */ .Xpm({
  ...
  contentQueries: function TuiInputCardGroupedComponent_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_15__/* ["ɵɵcontentQuery"] */ .Suo(dirIndex, _taiga_ui_core__WEBPACK_IMPORTED_MODULE_3__/* .TuiDataListDirective */ .gXS, 5, _angular_core__WEBPACK_IMPORTED_MODULE_15__/* .TemplateRef */ .Rgc);
      _angular_core__WEBPACK_IMPORTED_MODULE_15__/* ["ɵɵcontentQuery"] */ .Suo(dirIndex, _taiga_ui_core__WEBPACK_IMPORTED_MODULE_3__/* .TuiDataListComponent */ .qiE, 5);
    }
  ...
  features: [_angular_core__WEBPACK_IMPORTED_MODULE_15__/* ["ɵɵProvidersFeature"] */ ._Bn([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_2__/* .tuiAsFocusableItemAccessor */ .FTc)(TuiInputCardGroupedComponent), (0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_2__/* .tuiAsControl */ .wBO)(TuiInputCardGroupedComponent), (0,_taiga_ui_core__WEBPACK_IMPORTED_MODULE_3__/* .tuiAsDataListHost */ .oEG)(TuiInputCardGroupedComponent), _taiga_ui_core__WEBPACK_IMPORTED_MODULE_3__/* .MODE_PROVIDER */ .CV2]), _angular_core__WEBPACK_IMPORTED_MODULE_15__/* ["ɵɵInheritDefinitionFeature"] */ .qOj],
  decls: 2,
  vars: 3,
  consts: [["tuiWrapper", "", "tuiDropdownLimitWidth", "fixed", "class", "t-common-wrapper", 3, "appearance", "readOnly", "disabled", "focus", "hover", "invalid", "tuiDropdownManual", "tuiDropdown", "tuiActiveZoneChange", "scroll", "mousedown", 4, "ngIf"], ["tuiWrapper", "", "tuiDropdownLimitWidth", "fixed", 1, "t-common-wrapper", 3, "appearance", "readOnly", "disabled", "focus", "hover", "invalid", "tuiDropdownManual", "tuiDropdown", "tuiActiveZoneChange", "scroll", "mousedown"], [1, "t-wrapper"], ["tuiPreventDefault", "click", 4, "tuiLet"], [1, "t-wrapper", "t-wrapper_expire"], ["tuiPreventDefault", "click"], ["type", "text", "placeholder", "00/00", "automation-id", "tui-input-card-grouped__expire", "inputmode", "numeric", 1, "t-input", 3, "autocomplete", "disabled", "readOnly", "tuiFocusable", "textMask", "ngModel", "ngModelChange", "focus"], ["inputExpire", ""], [1, "t-placeholder"], [1, "t-wrapper", "t-wrapper_cvc"], ["type", "text", "automation-id", "tui-input-card-grouped__cvc", "inputmode", "numeric", 1, "t-input", 3, "placeholder", "disabled", "readOnly", "autocomplete", "textMask", "tuiFocusable", "ngModel", "ngModelChange", "focus"], ["inputCVC", ""], [1, "t-icons"], ["class", "t-icon-outlet", 4, "ngIf"], ["src", "tuiIconCloseLarge", "class", "t-icon", 3, "click", 4, "ngIf"], ["src", "tuiIconChevronDownLarge", "class", "t-icon", 3, "t-icon_rotated", "click", 4, "ngIf"], ["type", "text", "automation-id", "tui-input-card-grouped__card", "inputmode", "numeric", 1, "t-input", "t-input_card", 3, "placeholder", "autocomplete", "disabled", "readOnly", "textMask", "tuiFocusable", "ngModel", "ngModelChange", "focus"], ["inputCard", ""], ["aria-hidden", "true", 1, "t-collapsed"], [1, "t-collapsed-wrapper"], [1, "t-value"], [1, "t-icon-outlet"], ["automation-id", "tui-input-card-grouped__icon", "class", "t-card", 3, "src", 4, "polymorpheusOutlet"], ["automation-id", "tui-input-card-grouped__icon", 1, "t-card", 3, "src"], ["src", "tuiIconCloseLarge", 1, "t-icon", 3, "click"], ["src", "tuiIconChevronDownLarge", 1, "t-icon", 3, "click"]],
...
const TUI_INPUT_CARD_GROUPED_TEXTS = new _angular_core__WEBPACK_IMPORTED_MODULE_3__/* .InjectionToken */ .OlP(`InputCardGrouped texts`, {
  factory: () => {
    ...
    const {
      desktopSmall
    } = (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__/* .inject */ .f3M)(_taiga_ui_core_tokens__WEBPACK_IMPORTED_MODULE_2__/* .TUI_MEDIA */ .J_);
    const media = windowRef.matchMedia(`screen and (min-width: ${(desktopSmall - 1) / 16}em)`);
    return (0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_1__/* .tuiTypedFromEvent */ .mLY)(media, `change`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__/* .startWith */ .O)(null), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__/* .switchMap */ .w)(() => (0,rxjs__WEBPACK_IMPORTED_MODULE_7__/* .combineLatest */ .aj)([(0,rxjs__WEBPACK_IMPORTED_MODULE_8__.of)(Number(media.matches)), cardNumberTexts, expiryTexts, cvcTexts])), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__/* .map */ .U)(([index, cardNumber, expiry, cvcTexts]) => ({
...
class TuiInputCardComponent extends _taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_2__/* .AbstractTuiControl */ .M$T {
...
TuiInputCardComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_9__/* ["ɵɵdefineComponent"] */ .Xpm({
  ...
  viewQuery: function TuiInputCardComponent_Query(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_9__/* ["ɵɵviewQuery"] */ .Gf(_taiga_ui_core__WEBPACK_IMPORTED_MODULE_3__/* .TuiPrimitiveTextfieldComponent */ .ycg, 5);
    }
  ...
  features: [_angular_core__WEBPACK_IMPORTED_MODULE_9__/* ["ɵɵProvidersFeature"] */ ._Bn([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_2__/* .tuiAsFocusableItemAccessor */ .FTc)(TuiInputCardComponent), (0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_2__/* .tuiAsControl */ .wBO)(TuiInputCardComponent)]), _angular_core__WEBPACK_IMPORTED_MODULE_9__/* ["ɵɵInheritDefinitionFeature"] */ .qOj],
...
(0,tslib__WEBPACK_IMPORTED_MODULE_11__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_2__/* .tuiDefaultProp */ .THR)()], TuiInputCardComponent.prototype, "cardSrc", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_11__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_2__/* .tuiDefaultProp */ .THR)()], TuiInputCardComponent.prototype, "autocompleteEnabled", void 0);
...
/* harmony export */ });
/* harmony import */ var _taiga_ui_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(66187);
...
let TuiInputCardDirective = /*#__PURE__*/(() => {
  class TuiInputCardDirective extends _taiga_ui_core__WEBPACK_IMPORTED_MODULE_0__/* .AbstractTuiTextfieldHost */ .D1Q {
    onValueChange(value) {
  ...
  TuiInputCardDirective.ɵdir = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__/* ["ɵɵdefineDirective"] */ .lG2({
    ...
    selectors: [["tui-input-card"]],
    features: [_angular_core__WEBPACK_IMPORTED_MODULE_1__/* ["ɵɵProvidersFeature"] */ ._Bn([(0,_taiga_ui_core__WEBPACK_IMPORTED_MODULE_0__/* .tuiAsTextfieldHost */ .cpA)(TuiInputCardDirective)]), _angular_core__WEBPACK_IMPORTED_MODULE_1__/* ["ɵɵInheritDefinitionFeature"] */ .qOj]
  });
...
const _c0 = ["*"];
class TuiInputCVCComponent extends _taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .AbstractTuiControl */ .M$T {
  constructor(control, changeDetectorRef, textfieldLabelOutside) {
    ...
    this.textMaskOptions = {
      mask: new Array(3).fill(_taiga_ui_core__WEBPACK_IMPORTED_MODULE_1__/* .TUI_DIGIT_REGEXP */ .hW1),
      guide: false
    };
  }
  ...
  set length(length) {
    ...
    this.textMaskOptions = {
      mask: new Array(length).fill(_taiga_ui_core__WEBPACK_IMPORTED_MODULE_1__/* .TUI_DIGIT_REGEXP */ .hW1),
      guide: false
    };
  }
...
TuiInputCVCComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_7__/* ["ɵɵdefineComponent"] */ .Xpm({
  ...
  viewQuery: function TuiInputCVCComponent_Query(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_7__/* ["ɵɵviewQuery"] */ .Gf(_taiga_ui_core__WEBPACK_IMPORTED_MODULE_1__/* .TuiPrimitiveTextfieldComponent */ .ycg, 5);
    }
  ...
  features: [_angular_core__WEBPACK_IMPORTED_MODULE_7__/* ["ɵɵProvidersFeature"] */ ._Bn([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiAsFocusableItemAccessor */ .FTc)(TuiInputCVCComponent), (0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiAsControl */ .wBO)(TuiInputCVCComponent)]), _angular_core__WEBPACK_IMPORTED_MODULE_7__/* ["ɵɵInheritDefinitionFeature"] */ .qOj],
  ngContentSelectors: _c0,
  decls: 3,
  vars: 12,
  consts: [["tuiValueAccessor", "", 1, "t-input", 3, "disabled", "readOnly", "nativeId", "textMask", "invalid", "focusable", "pseudoHover", "pseudoActive", "pseudoFocus", "value", "valueChange", "focusedChange", "copy.prevent"], ["tuiTextfield", "", "inputmode", "numeric"]],
  template: function TuiInputCVCComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_7__/* ["ɵɵattribute"] */ .uIk("autocomplete", ctx.autocomplete)("placeholder", ctx.computedPlaceholder);
    }
  },
...
(0,tslib__WEBPACK_IMPORTED_MODULE_9__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiDefaultProp */ .THR)()], TuiInputCVCComponent.prototype, "autocompleteEnabled", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_9__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiRequiredSetter */ .NH)()], TuiInputCVCComponent.prototype, "length", null);
...
const _c0 = ["*"];
class TuiInputExpireComponent extends _taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_1__/* .AbstractTuiControl */ .M$T {
  constructor(control, changeDetectorRef) {
    super(control, changeDetectorRef);
    this.autocompleteEnabled = false;
    this.textMaskOptions = {
      mask: [_taiga_ui_core__WEBPACK_IMPORTED_MODULE_2__/* .TUI_DIGIT_REGEXP */ .hW1, _taiga_ui_core__WEBPACK_IMPORTED_MODULE_2__/* .TUI_DIGIT_REGEXP */ .hW1, `/`, _taiga_ui_core__WEBPACK_IMPORTED_MODULE_2__/* .TUI_DIGIT_REGEXP */ .hW1, _taiga_ui_core__WEBPACK_IMPORTED_MODULE_2__/* .TUI_DIGIT_REGEXP */ .hW1],
...
TuiInputExpireComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_8__/* ["ɵɵdefineComponent"] */ .Xpm({
  ...
  viewQuery: function TuiInputExpireComponent_Query(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_8__/* ["ɵɵviewQuery"] */ .Gf(_taiga_ui_core__WEBPACK_IMPORTED_MODULE_2__/* .TuiPrimitiveTextfieldComponent */ .ycg, 5);
    }
  ...
  features: [_angular_core__WEBPACK_IMPORTED_MODULE_8__/* ["ɵɵProvidersFeature"] */ ._Bn([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_1__/* .tuiAsFocusableItemAccessor */ .FTc)(TuiInputExpireComponent), (0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_1__/* .tuiAsControl */ .wBO)(TuiInputExpireComponent)]), _angular_core__WEBPACK_IMPORTED_MODULE_8__/* ["ɵɵInheritDefinitionFeature"] */ .qOj],
  ngContentSelectors: _c0,
  decls: 3,
  vars: 10,
...
(0,tslib__WEBPACK_IMPORTED_MODULE_10__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_1__/* .tuiDefaultProp */ .THR)()], TuiInputExpireComponent.prototype, "autocompleteEnabled", void 0);
...
/* harmony export */ });
/* unused harmony exports TUI_MONEY_DEFAULT_DEFAULT_OPTIONS, tuiMoneyOptionsProvider */
...
const TUI_MONEY_OPTIONS = new _angular_core__WEBPACK_IMPORTED_MODULE_0__/* .InjectionToken */ .OlP(`Default parameters for money component`, {
...
/* harmony import */ var _pipes_fraction_part_pipe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(88346);
...
class TuiMoneyComponent {
  ...
  get red() {
    return this.colored && (this.signSymbol === _taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .CHAR_MINUS */ .emD || this.value < 0 && this.sign !== `force-positive`);
  }

  get green() {
    return this.colored && (this.signSymbol === _taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .CHAR_PLUS */ .kUW || this.value > 0 && this.sign !== `force-negative`);
  }
...
(0,tslib__WEBPACK_IMPORTED_MODULE_8__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiDefaultProp */ .THR)()], TuiMoneyComponent.prototype, "value", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_8__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiDefaultProp */ .THR)()], TuiMoneyComponent.prototype, "decimal", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_8__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiDefaultProp */ .THR)()], TuiMoneyComponent.prototype, "currency", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_8__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiDefaultProp */ .THR)()], TuiMoneyComponent.prototype, "sign", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_8__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiDefaultProp */ .THR)()], TuiMoneyComponent.prototype, "colored", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_8__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiDefaultProp */ .THR)()], TuiMoneyComponent.prototype, "precision", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_8__/* .__decorate */ .gn)([(0,_taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .tuiDefaultProp */ .THR)()], TuiMoneyComponent.prototype, "singleColor", void 0);
...
__webpack_require__.d(__webpack_exports__, {
  "A": () => (/* binding */ TuiFractionPartPipe)
});

// EXTERNAL MODULE: ./projects/core/index.ts + 68 modules
var core = __webpack_require__(66187);
;// CONCATENATED MODULE: ./projects/addon-commerce/components/money/utils/format-fraction-part.ts
...
;// CONCATENATED MODULE: ./projects/addon-commerce/components/money/pipes/fraction-part.pipe.ts
...
let TuiFractionPartPipe = /*#__PURE__*/(() => {
  ...
  TuiFractionPartPipe.ɵfac = function TuiFractionPartPipe_Factory(t) {
    return new (t || TuiFractionPartPipe)(fesm2015_core/* ɵɵdirectiveInject */.Y36(core/* TUI_NUMBER_FORMAT */.HOy, 16));
  };

  TuiFractionPartPipe.ɵpipe = /*@__PURE__*/fesm2015_core/* ɵɵdefinePipe */.Yjl({
...
let TuiIntegerPartPipe = /*#__PURE__*/(() => {
  class TuiIntegerPartPipe {
    ...
    transform(value, precision) {
      return (0,_taiga_ui_core__WEBPACK_IMPORTED_MODULE_0__/* .tuiFormatNumber */ .lx_)(Math.floor(Math.abs(Number(value.toFixed(precision)))), this.numberFormat);
    }

  }

  TuiIntegerPartPipe.ɵfac = function TuiIntegerPartPipe_Factory(t) {
    return new (t || TuiIntegerPartPipe)(_angular_core__WEBPACK_IMPORTED_MODULE_1__/* ["ɵɵdirectiveInject"] */ .Y36(_taiga_ui_core__WEBPACK_IMPORTED_MODULE_0__/* .TUI_NUMBER_FORMAT */ .HOy, 16));
  };
...
function tuiFormatSignSymbol(value, sign) {
  ...
  if (sign === `force-negative` || value < 0 && sign !== `force-positive`) {
    return _taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .CHAR_MINUS */ .emD;
  }

  return _taiga_ui_cdk__WEBPACK_IMPORTED_MODULE_0__/* .CHAR_PLUS */ .kUW;
}
...
const cardHolderMask = (0,core/* tuiCreateCorrectionMask */.Y26)(ALLOWED_REGEXP, toEnglishUppercase);
...
const TUI_CARD_MASK = [core/* TUI_DIGIT_REGEXP */.hW1, core/* TUI_DIGIT_REGEXP */.hW1, core/* TUI_DIGIT_REGEXP */.hW1, core/* TUI_DIGIT_REGEXP */.hW1, ` `, core/* TUI_DIGIT_REGEXP */.hW1, core/* TUI_DIGIT_REGEXP */.hW1, core/* TUI_DIGIT_REGEXP */.hW1, core/* TUI_DIGIT_REGEXP */.hW1, ` `, core/* TUI_DIGIT_REGEXP */.hW1, core/* TUI_DIGIT_REGEXP */.hW1, core/* TUI_DIGIT_REGEXP */.hW1, core/* TUI_DIGIT_REGEXP */.hW1, ` `, core/* TUI_DIGIT_REGEXP */.hW1, core/* TUI_DIGIT_REGEXP */.hW1, core/* TUI_DIGIT_REGEXP */.hW1, core/* TUI_DIGIT_REGEXP */.hW1, ` `, core/* TUI_DIGIT_REGEXP */.hW1, core/* TUI_DIGIT_REGEXP */.hW1, core/* TUI_DIGIT_REGEXP */.hW1];
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "RC": () => (/* reexport */ TuiCardModule),
  "wc": () => (/* reexport */ TuiCurrencyPipeModule),
  "xL": () => (/* reexport */ TuiInputCVCModule),
  "SE": () => (/* reexport */ TuiInputCardGroupedModule),
  "S9": () => (/* reexport */ TuiInputCardModule),
  "uL": () => (/* reexport */ TuiInputExpireModule),
  "DC": () => (/* reexport */ TuiMoneyModule),
  "rp": () => (/* reexport */ tuiCardExpireValidator),
  "n9": () => (/* reexport */ tuiCardNumberValidator),
  "nM": () => (/* reexport */ tuiCreateLuhnValidator),
  "CE": () => (/* reexport */ utils/* tuiGetCurrencySymbol */.CE),
  "Vn": () => (/* reexport */ utils/* tuiGetPaymentSystem */.Vn)
});

// UNUSED EXPORTS: TUI_CARD_CVC_TEXTS, TUI_CARD_EXPIRY_TEXTS, TUI_CARD_MASK, TUI_CARD_NUMBER_TEXTS, TUI_INPUT_CARD_GROUPED_TEXTS, TUI_MONEY_DEFAULT_DEFAULT_OPTIONS, TUI_MONEY_OPTIONS, TuiCardComponent, TuiCurrency, TuiCurrencyCode, TuiCurrencyPipe, TuiFormatCardModule, TuiFormatCardPipe, TuiFractionPartPipe, TuiInputCVCComponent, TuiInputCardComponent, TuiInputCardDirective, TuiInputCardGroupedComponent, TuiInputExpireComponent, TuiIntegerPartPipe, TuiMoneyComponent, TuiSignSymbolPipe, cardHolderMask, tuiCreateAutoCorrectedExpirePipe, tuiDefaultCardValidator, tuiFormatCurrency, tuiFormatFractionPart, tuiFormatSignSymbol, tuiIsCardLengthValid, tuiIsCardNumberValid, tuiIsElectron, tuiIsExpireValid, tuiIsMaestro, tuiIsMastercard, tuiIsMir, tuiIsVisa, tuiMoneyOptionsProvider
...
let TuiCardModule = /*#__PURE__*/(() => {
  ...
  TuiCardModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, core/* TuiSvgModule */.EIu]]
  });
...
let TuiInputCardModule = /*#__PURE__*/(() => {
  ...
  TuiInputCardModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[kit/* TextMaskModule */.QAp, core/* TuiPrimitiveTextfieldModule */.KWI, core/* TuiTextfieldControllerModule */.cnw, kit/* TuiValueAccessorModule */.SCC]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(TuiInputCardModule, {
    ...
    imports: [kit/* TextMaskModule */.QAp, core/* TuiPrimitiveTextfieldModule */.KWI, core/* TuiTextfieldControllerModule */.cnw, kit/* TuiValueAccessorModule */.SCC],
    exports: [input_card_component/* TuiInputCardComponent */.z, input_card_directive/* TuiInputCardDirective */.a, core/* TuiTextfieldComponent */.MBc]
  });
})();
...
let TuiInputCardGroupedModule = /*#__PURE__*/(() => {
  ...
  TuiInputCardGroupedModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, fesm2015_forms/* FormsModule */.u5, kit/* TextMaskModule */.QAp, cdk/* TuiFocusableModule */.udY, core/* TuiSvgModule */.EIu, core/* TuiWrapperModule */.WUl, cdk/* TuiActiveZoneModule */.Ah6, cdk/* TuiMapperPipeModule */.I1h, core/* TuiDropdownModule */.dpK, cdk/* TuiPreventDefaultModule */.Zpk, tinkoff_ng_polymorpheus/* PolymorpheusModule */.wq, cdk/* TuiLetModule */.WDk, TuiFormatCardModule]]
  });
...
// EXTERNAL MODULE: ./projects/addon-commerce/components/money/pipes/fraction-part.pipe.ts + 1 modules
var fraction_part_pipe = __webpack_require__(88346);
...
function tuiCardExpireValidator({
  ...
  return ((_a = value === null || value === void 0 ? void 0 : value.expire) === null || _a === void 0 ? void 0 : _a.length) === 5 && !(0,utils/* tuiIsExpireValid */.Sr)(value === null || value === void 0 ? void 0 : value.expire) ? {
    expire: new cdk/* TuiValidationError */.T8v(`Expire date`)
  } : null;
}
...
function tuiCardNumberValidator({
  ...
  return (value === null || value === void 0 ? void 0 : value.card) && !(0,utils/* tuiIsCardNumberValid */.Tb)(value.card) ? {
    card: new cdk/* TuiValidationError */.T8v(`Invalid card number`)
  } : null;
}
...
function tuiCreateLuhnValidator(message) {
  return ({
    ...
    return (0,utils/* tuiIsCardNumberValid */.Tb)(value) ? null : {
      luhn: new cdk/* TuiValidationError */.T8v(message)
    };
  };
}
...
const TUI_CARD_NUMBER_TEXTS = new core/* InjectionToken */.OlP(`Number and card number i18n`, {
  factory: (0,i18n/* tuiExtractI18n */.vv)(`cardNumber`)
});
const TUI_CARD_EXPIRY_TEXTS = new core/* InjectionToken */.OlP(`Expiry and card expiry i18n`, {
  factory: (0,i18n/* tuiExtractI18n */.vv)(`cardExpiry`)
});
const TUI_CARD_CVC_TEXTS = new core/* InjectionToken */.OlP(`Card CVC number text`, {
...
// UNUSED EXPORTS: tuiIsElectron, tuiIsMaestro, tuiIsMastercard, tuiIsMir, tuiIsVisa
...
function tuiCreateAutoCorrectedExpirePipe() {
  return (conformedValue, {
    ...
    if (rawValue.length > 7 && rawValue.length < 11 && TUI_EXP_SAFARI.test(rawValue)) {
      const array = rawValue.split(core/* TUI_NON_DIGIT_REGEXP */.W6H);
      const month = array[1];
...
function stringifyCurrency(currency) {
  return currency === null || (0,cdk/* tuiIsString */.Ajw)(currency) ? currency || `` : String(currency).padStart(3, `0`);
}
...
function tuiIsCardNumberValid(value) {
  const cardNumber = String(value).replace(core/* TUI_NON_DIGITS_REGEXP */.R3j, ``);
  const {
    length
  } = cardNumber;
