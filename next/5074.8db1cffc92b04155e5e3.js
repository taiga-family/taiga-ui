...
let TuiTooltipExample1 = /*#__PURE__*/(() => {
  class TuiTooltipExample1 {
    constructor(destroy$, changeDetectorRef) {
      this.loader = true;
      this.text = ``;
      (0,interval/* interval */.F)(2000).pipe((0,cdk/* tuiWatch */.NAr)(changeDetectorRef), (0,takeUntil/* takeUntil */.R)(destroy$)).subscribe(() => {
  ...
  TuiTooltipExample1.ɵfac = function TuiTooltipExample1_Factory(t) {
    return new (t || TuiTooltipExample1)(fesm2015_core/* ɵɵdirectiveInject */.Y36(cdk/* TuiDestroyService */.a31), fesm2015_core/* ɵɵdirectiveInject */.Y36(fesm2015_core/* ChangeDetectorRef */.sBO));
  };
...
let TuiTooltipExample4 = /*#__PURE__*/(() => {
  ...
  TuiTooltipExample4.ɵcmp = /*@__PURE__*/fesm2015_core/* ɵɵdefineComponent */.Xpm({
    ...
    features: [fesm2015_core/* ɵɵProvidersFeature */._Bn([(0,core/* tuiHintOptionsProvider */.pt2)({
...
let ExampleTuiTooltipComponent = /*#__PURE__*/(() => {
  class ExampleTuiTooltipComponent {
    constructor() {
      ...
      this.directionVariants = core/* TUI_HINT_DIRECTIONS */.FwI;
...
let ExampleTuiTooltipModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiTooltipModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[core/* TuiTooltipModule */.QA7, core/* TuiHintModule */.goS, core/* TuiLinkModule */.jzK, kit/* TuiAvatarModule */.JmR, core/* TuiLoaderModule */.dSp, kit/* TuiInputModule */.QfL, tinkoff_ng_polymorpheus/* PolymorpheusModule */.wq, core/* TuiModeModule */.zw7, public_api/* TuiAddonDocModule */.fV, common/* CommonModule */.ez, fesm2015_forms/* FormsModule */.u5, core/* TuiTextfieldControllerModule */.cnw, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiTooltipComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiTooltipModule, {
    ...
    imports: [core/* TuiTooltipModule */.QA7, core/* TuiHintModule */.goS, core/* TuiLinkModule */.jzK, kit/* TuiAvatarModule */.JmR, core/* TuiLoaderModule */.dSp, kit/* TuiInputModule */.QfL, tinkoff_ng_polymorpheus/* PolymorpheusModule */.wq, core/* TuiModeModule */.zw7, public_api/* TuiAddonDocModule */.fV, common/* CommonModule */.ez, fesm2015_forms/* FormsModule */.u5, core/* TuiTextfieldControllerModule */.cnw, router/* RouterModule */.Bz],
