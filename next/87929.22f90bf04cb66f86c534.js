...
// EXTERNAL MODULE: ./projects/kit/components/multi-select/multi-select.component.ts + 1 modules
var multi_select_component = __webpack_require__(67724);
...
class TuiMultiSelectExample1 {
  ...
  filter(search) {
    return ITEMS.filter(item => (0,cdk/* TUI_DEFAULT_MATCHER */.LQM)(item, search || ``));
  }
...
(0,tslib_es6/* __decorate */.gn)([cdk/* tuiPure */.UMq], TuiMultiSelectExample1.prototype, "filter", null);
  ...
  class TuiMultiSelectExample4 {
    constructor() {
      ...
      this.items$ = this.search$.pipe((0,startWith/* startWith */.O)(``), (0,switchMap/* switchMap */.w)(search => this.server$.pipe((0,map/* map */.U)(items => items.filter(({
        name
      }) => (0,cdk/* TUI_DEFAULT_MATCHER */.LQM)(name, search)).map(({
        id
      ...
      this.stringify$ = this.server$.pipe((0,map/* map */.U)(items => new Map(items.map(({
        id,
        name
      }) => [id, name]))), (0,startWith/* startWith */.O)(new Map()), (0,map/* map */.U)(map => id => ((0,cdk/* tuiIsNumber */.dtH)(id) ? map.get(id) : map.get(id.$implicit)) || `Loading...`));
...
let TuiMultiSelectExample9 = /*#__PURE__*/(() => {
  ...
  TuiMultiSelectExample9.ɵfac = function TuiMultiSelectExample9_Factory(t) {
    return new (t || TuiMultiSelectExample9)(fesm2015_core/* ɵɵdirectiveInject */.Y36(core/* TuiDialogService */.ROA));
  };
...
let ExampleTuiMultiSelectComponent = /*#__PURE__*/(() => {
  class ExampleTuiMultiSelectComponent extends control/* AbstractExampleTuiControl */.b {
    constructor() {
      ...
      this.disabledItemHandlerVariants = [cdk/* ALWAYS_FALSE_HANDLER */.IyD, item => item.balance < 300];
...
let ExampleTuiMultiSelectModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiMultiSelectModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, fesm2015_forms/* FormsModule */.u5, fesm2015_forms/* ReactiveFormsModule */.UX, scrolling/* ScrollingModule */.Cl, core/* TuiScrollbarModule */.Jyu, kit/* TuiMultiSelectModule */.lmA, kit/* TuiRadioListModule */.Ltw, core/* TuiButtonModule */.fNO, core/* TuiLinkModule */.jzK, kit/* TuiAvatarModule */.JmR, core/* TuiDataListModule */.pcV, kit/* TuiDataListWrapperModule */.zXW, cdk/* TuiLetModule */.WDk, core/* TuiDropdownModule */.dpK, core/* TuiHintModule */.goS, core/* TuiTextfieldControllerModule */.cnw, inherited_documentation_module/* InheritedDocumentationModule */.f, public_api/* TuiAddonDocModule */.fV, core/* TuiLabelModule */.U8r, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiMultiSelectComponent)), tinkoff_ng_polymorpheus/* PolymorpheusModule */.wq]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiMultiSelectModule, {
    ...
    imports: [common/* CommonModule */.ez, fesm2015_forms/* FormsModule */.u5, fesm2015_forms/* ReactiveFormsModule */.UX, scrolling/* ScrollingModule */.Cl, core/* TuiScrollbarModule */.Jyu, kit/* TuiMultiSelectModule */.lmA, kit/* TuiRadioListModule */.Ltw, core/* TuiButtonModule */.fNO, core/* TuiLinkModule */.jzK, kit/* TuiAvatarModule */.JmR, core/* TuiDataListModule */.pcV, kit/* TuiDataListWrapperModule */.zXW, cdk/* TuiLetModule */.WDk, core/* TuiDropdownModule */.dpK, core/* TuiHintModule */.goS, core/* TuiTextfieldControllerModule */.cnw, inherited_documentation_module/* InheritedDocumentationModule */.f, public_api/* TuiAddonDocModule */.fV, core/* TuiLabelModule */.U8r, router/* RouterModule */.Bz, tinkoff_ng_polymorpheus/* PolymorpheusModule */.wq],
