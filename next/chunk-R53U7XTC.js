...
>
    <ng-template pageTab>
        ...
        <tui-doc-example
            ...
            [content]="2 | tuiExample: 'html,ts' : example2"
        />
        ...
        <tui-doc-example
            ...
            [content]="7 | tuiExample: 'html,ts' : example7"
        />
        ...
        <tui-doc-example
            ...
            [content]="9 | tuiExample: 'html,ts,less' : example9"
        />
    ...
    <ng-template pageTab>
        ...
        >
            @if (size === 'xl') {
                <h2>Template can be customized</h2>
            }
            <p>
                Dialog has
                <code>Observer</code>
            ...
            <tui-accordion class="container">
                <button tuiAccordion>Dynamic height change</button>
                <tui-expand>
                    ...
                    eligendi esse minima nobis! Assumenda debitis, delectus dicta dolore eos explicabo fuga id inventore
                    maiores, nihil, nobis nostrum quasi quo unde!
                </tui-expand>
            </tui-accordion>
            <button
                size="m"
