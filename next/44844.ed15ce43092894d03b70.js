...
class TuiLineDaysChartExample1 {
  constructor(months$) {
    this.months$ = months$;
    this.range = new cdk/* TuiDayRange */.VRe(cdk/* TuiDay.currentLocal */.TU1.currentLocal(), cdk/* TuiDay.currentLocal */.TU1.currentLocal().append({
      year: 1
    }));
    this.maxLength = {
      month: 12
  ...
  computeLabels$({
    ...
    return this.months$.pipe((0,map/* map */.U)(months => Array.from({
      length: cdk/* TuiMonth.lengthBetween */.qld.lengthBetween(from, to) + 1
  ...
  computeValue({
    ...
    return new Array(cdk/* TuiDay.lengthBetween */.TU1.lengthBetween(from, to) + 1).fill(0).reduce((array, _, i) => [...array, [from.append({
      day: i
...
TuiLineDaysChartExample1.ɵfac = function TuiLineDaysChartExample1_Factory(t) {
  return new (t || TuiLineDaysChartExample1)(fesm2015_core/* ɵɵdirectiveInject */.Y36(core/* TUI_MONTHS */.$Rv));
};
...
(0,tslib_es6/* __decorate */.gn)([cdk/* tuiPure */.UMq], TuiLineDaysChartExample1.prototype, "computeLabels$", null);

(0,tslib_es6/* __decorate */.gn)([cdk/* tuiPure */.UMq], TuiLineDaysChartExample1.prototype, "computeValue", null);
...
let LabelsPipe = /*#__PURE__*/(() => {
  class LabelsPipe {
    ...
    transform({
      ...
      const length = cdk/* TuiDay.lengthBetween */.TU1.lengthBetween(from, to);
  ...
  LabelsPipe.ɵfac = function LabelsPipe_Factory(t) {
    return new (t || LabelsPipe)(fesm2015_core/* ɵɵdirectiveInject */.Y36(core/* TUI_MONTHS */.$Rv, 16));
  };
...
class TuiLineDaysChartExample2 {
  constructor() {
    this.data = new cdk/* TuiDayRange */.VRe(cdk/* TuiDay.currentLocal */.TU1.currentLocal(), cdk/* TuiDay.currentLocal */.TU1.currentLocal().append({
      month: 5
    }));
    this.show = this.data;
    ...
    this.toNumbers = (days, {
      from
    }) => days.map(([day, value]) => [cdk/* TuiDay.lengthBetween */.TU1.lengthBetween(from, day), value]);
  }
  ...
  getWidth({
    ...
    return cdk/* TuiDay.lengthBetween */.TU1.lengthBetween(from, to);
  }

  getDate(day, date) {
    return day instanceof cdk/* TuiDay */.TU1 ? day : date.append({
      day
    });
  }
  ...
  computeRange(range) {
    ...
    const mondaysLength = cdk/* TuiDay.lengthBetween */.TU1.lengthBetween(mondayFrom, mondayTo);

    if (length > 60) {
      return new cdk/* TuiDayRange */.VRe(mondayFrom, mondayTo.append({
        day: mondaysLength % 14
      }));
    }

    if (length > 14) {
      return new cdk/* TuiDayRange */.VRe(mondayFrom, mondayTo);
    }

    if (length > 7) {
      return new cdk/* TuiDayRange */.VRe(from, to.append({
        day: length % 2
      }));
    }
...
(0,tslib_es6/* __decorate */.gn)([cdk/* tuiPure */.UMq], TuiLineDaysChartExample2.prototype, "getWidth", null);

(0,tslib_es6/* __decorate */.gn)([cdk/* tuiPure */.UMq], TuiLineDaysChartExample2.prototype, "getDate", null);

(0,tslib_es6/* __decorate */.gn)([cdk/* tuiPure */.UMq], TuiLineDaysChartExample2.prototype, "computeRange", null);

(0,tslib_es6/* __decorate */.gn)([cdk/* tuiPure */.UMq], TuiLineDaysChartExample2.prototype, "computeData", null);
...
let ExampleTuiLineDaysChartComponent = /*#__PURE__*/(() => {
  class ExampleTuiLineDaysChartComponent {
    constructor(months$) {
      ...
      this.valueVariants = [new Array(91).fill(0).reduce((array, _, i) => [...array, [new cdk/* TuiDay */.TU1(2020, 0, 1).append({
        day: i
      }), (i ? array[i - 1][1] : 100) + Math.random() * 20 - 10]], []), [[new cdk/* TuiDay */.TU1(2020, 1, 10), 10], [new cdk/* TuiDay */.TU1(2020, 1, 15), 150], [new cdk/* TuiDay */.TU1(2020, 1, 17), 10], [new cdk/* TuiDay */.TU1(2020, 1, 20), 10], [new cdk/* TuiDay */.TU1(2020, 1, 25), 150], [new cdk/* TuiDay */.TU1(2020, 1, 27), 10]]];
  ...
  ExampleTuiLineDaysChartComponent.ɵfac = function ExampleTuiLineDaysChartComponent_Factory(t) {
    return new (t || ExampleTuiLineDaysChartComponent)(fesm2015_core/* ɵɵdirectiveInject */.Y36(core/* TUI_MONTHS */.$Rv));
  };
...
let ExampleTuiLineDaysChartModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiLineDaysChartModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, fesm2015_forms/* FormsModule */.u5, addon_charts/* TuiAxesModule */.Ep, kit/* TuiSelectModule */.Jyo, addon_charts/* TuiLineChartModule */.I2, cdk/* TuiMapperPipeModule */.I1h, core/* TuiNotificationModule */.HiG, cdk/* TuiFilterPipeModule */.pLW, addon_charts/* TuiLineDaysChartModule */.SX, kit/* TuiInputDateRangeModule */.sR_, public_api/* TuiAddonDocModule */.fV, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiLineDaysChartComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiLineDaysChartModule, {
    ...
    imports: [common/* CommonModule */.ez, fesm2015_forms/* FormsModule */.u5, addon_charts/* TuiAxesModule */.Ep, kit/* TuiSelectModule */.Jyo, addon_charts/* TuiLineChartModule */.I2, cdk/* TuiMapperPipeModule */.I1h, core/* TuiNotificationModule */.HiG, cdk/* TuiFilterPipeModule */.pLW, addon_charts/* TuiLineDaysChartModule */.SX, kit/* TuiInputDateRangeModule */.sR_, public_api/* TuiAddonDocModule */.fV, router/* RouterModule */.Bz],
