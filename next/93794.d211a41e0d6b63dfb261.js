...
class TuiInputPhoneExample3 {
  ...
  request(query) {
    return (0,of.of)(DATA.filter(item => (0,cdk/* TUI_DEFAULT_MATCHER */.LQM)(item, query) || (0,cdk/* TUI_DEFAULT_MATCHER */.LQM)(item.phone, query))).pipe((0,share/* share */.B)());
  }
...
(0,tslib_es6/* __decorate */.gn)([cdk/* tuiPure */.UMq], TuiInputPhoneExample3.prototype, "request", null);
...
let ExampleTuiInputPhoneModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiInputPhoneModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, fesm2015_forms/* FormsModule */.u5, fesm2015_forms/* ReactiveFormsModule */.UX, tinkoff_ng_polymorpheus/* PolymorpheusModule */.wq, cdk/* TuiLetModule */.WDk, core/* TuiDataListModule */.pcV, core/* TuiButtonModule */.fNO, core/* TuiSvgModule */.EIu, kit/* TuiAvatarModule */.JmR, core/* TuiDropdownModule */.dpK, core/* TuiTextfieldControllerModule */.cnw, core/* TuiHintModule */.goS, kit/* TuiInputPhoneModule */.Kjg, core/* TuiLinkModule */.jzK, core/* TuiNotificationModule */.HiG, inherited_documentation_module/* InheritedDocumentationModule */.f, public_api/* TuiAddonDocModule */.fV, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiInputPhoneComponent))]]
  });
