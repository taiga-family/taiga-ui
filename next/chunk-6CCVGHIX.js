import"./chunk-42JZD6NG.js";var i=`<tui-doc-page header="Server Side Rendering (SSR)">
    <h2>Tokens</h2>
    <p>
    ...
    <p>
        Taiga UI uses modern JavaScript with classes that might be not available in server side environment. To add
        mocks for those classes you can also use
        <code>&#64;ng-web-apis/universal</code>
        package (see
        <a
            href="https://github.com/taiga-family/ng-web-apis/blob/main/libs/universal/README.md#mocks"
            rel="noreferrer noopener"
            target="_blank"
            tuiLink
        >
