  ...
  class TuiInputDateRangeExample1 {
    constructor() {
      this.testForm = new fesm2015_forms/* FormGroup */.cw({
        testValue: new fesm2015_forms/* FormControl */.NI(new cdk.TuiDayRange(new cdk.TuiDay(2018, 2, 10), new cdk.TuiDay(2018, 3, 20)))
      });
      this.min = new cdk.TuiDay(2000, 2, 20);
      this.max = new cdk.TuiDay(2040, 2, 20);
    }
...
let TuiInputDateRangeExample2 = /*#__PURE__*/(() => {
  class TuiInputDateRangeExample2 {
    constructor() {
      this.control = new fesm2015_forms/* FormControl */.NI(new cdk.TuiDayRange(new cdk.TuiDay(2018, 2, 10), new cdk.TuiDay(2018, 3, 20)));
    }
...
class ExampleDateRangeTransformer {
  ...
  fromControlValue(controlValue) {
    ...
    return from && to && new cdk.TuiDayRange(from, to);
  }
...
let TuiInputDateRangeExample4 = /*#__PURE__*/(() => {
  ...
  TuiInputDateRangeExample4.ɵcmp = /*@__PURE__*/fesm2015_core/* ɵɵdefineComponent */.Xpm({
    ...
    features: [fesm2015_core/* ɵɵProvidersFeature */._Bn([{
      ...
      provide: kit.TUI_DATE_RANGE_VALUE_TRANSFORMER,
      deps: [kit.TUI_DATE_VALUE_TRANSFORMER],
...
let ExampleTuiInputDateRangeComponent = /*#__PURE__*/(() => {
  class ExampleTuiInputDateRangeComponent extends control/* AbstractExampleTuiControl */.b {
    constructor() {
      ...
      this.exampleHtml = __webpack_require__.e(/* import() */ 41413).then(__webpack_require__.t.bind(__webpack_require__, 41413, 17));
      ...
      this.dayVariants = [cdk.TUI_FIRST_DAY, new cdk.TuiDay(2021, 2, 5), new cdk.TuiDay(1900, 0, 1), new cdk.TuiDay(2300, 0, 1), cdk.TUI_LAST_DAY];
...
let ExampleTuiInputDateRangeModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiInputDateRangeModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, kit.TuiInputDateRangeModule, fesm2015_forms/* ReactiveFormsModule */.UX, inherited_documentation_module/* InheritedDocumentationModule */.f, core.TuiButtonModule, core.TuiLinkModule, addon_mobile.TuiMobileCalendarDialogModule, core.TuiTextfieldControllerModule, core.TuiHintModule, core.TuiNotificationModule, public_api/* TuiAddonDocModule */.fV, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiInputDateRangeComponent)), kit.TuiUnfinishedValidatorModule]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiInputDateRangeModule, {
    ...
    imports: [common/* CommonModule */.ez, kit.TuiInputDateRangeModule, fesm2015_forms/* ReactiveFormsModule */.UX, inherited_documentation_module/* InheritedDocumentationModule */.f, core.TuiButtonModule, core.TuiLinkModule, addon_mobile.TuiMobileCalendarDialogModule, core.TuiTextfieldControllerModule, core.TuiHintModule, core.TuiNotificationModule, public_api/* TuiAddonDocModule */.fV, router/* RouterModule */.Bz, kit.TuiUnfinishedValidatorModule],
