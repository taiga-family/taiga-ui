...
let TuiSliderExample6 = /*#__PURE__*/(() => {
  class TuiSliderExample6 {
    ...
    change(step) {
      this.value = (0,cdk/* tuiClamp */.Kiv)(this.value + step, this.min, this.max);
    }
...
let ExampleTuiSliderModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiSliderModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, public_api/* TuiAddonDocModule */.fV, kit/* TuiSliderModule */.c2K, fesm2015_forms/* FormsModule */.u5, fesm2015_forms/* ReactiveFormsModule */.UX, core/* TuiLinkModule */.jzK, core/* TuiNotificationModule */.HiG, core/* TuiModeModule */.zw7, core/* TuiButtonModule */.fNO, core/* TuiHintModule */.goS, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiSliderComponent))]]
  });
