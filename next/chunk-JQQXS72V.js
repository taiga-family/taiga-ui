import"./chunk-HU6DUUP4.js";var e=`<header tuiNavigationHeader>
    ...
    >
        <button
            ...
            type="button"
        >
            Keep dropdowns color?
        </button>
        <ol
            *tuiDropdown
            tuiList="s"
            [style.padding-inline.rem]="1"
        >
            <li>Wrap your button in another tag</li>
            <li>Move dropdown directives to that tag</li>
            <li>
                Reset navigation appearance by
                <code>tuiDropdownAppearance=""</code>
            </li>
            <li>
                Set
                <code>tuiTheme="dark"</code>
                on the button so it fits the header
            </li>
            <li>
                Get app theme:
                <code>readonly dark = inject(TUI_DARK_MODE)</code>
            </li>
            <li>
