...
>
    <ng-template pageTab>
        ...
        <!-- TODO: change order of examples in separate PR -->
        <!-- (otherwise, snapshots of every previous examples will fail \u2013 easy to miss real bug) -->
        <tui-doc-example
            id="bigint-type-control-value"
        ...
        <tui-doc-example
            id="large-int-decimal-parts"
            heading="Large integer + large decimal parts"
