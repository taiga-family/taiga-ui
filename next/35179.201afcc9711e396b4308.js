"use strict";
(self["webpackChunk_taiga_ui_components"] = self["webpackChunk_taiga_ui_components"] || []).push([[35179],{
...
let TuiCalendarExample2 = /*#__PURE__*/(() => {
  class TuiCalendarExample2 {
    constructor() {
      this.value = null;
      this.firstMonth = cdk/* TuiMonth.currentLocal */.qld.currentLocal();
      this.middleMonth = cdk/* TuiMonth.currentLocal */.qld.currentLocal().append({
        month: 1
      });
      this.lastMonth = cdk/* TuiMonth.currentLocal */.qld.currentLocal().append({
        month: 2
      });
    ...
    onDayClick(day) {
      if (this.value === null || !this.value.isSingleDay) {
        this.value = new cdk/* TuiDayRange */.VRe(day, day);
      }

      this.value = cdk/* TuiDayRange.sort */.VRe.sort(this.value.from, day);
    }
...
function ExampleTuiCalendarComponent_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    fesm2015_core/* ɵɵi18nStart */.tHW(8, 4);
    fesm2015_core/* ɵɵelementStart */.TgZ(9, "code");
    fesm2015_core/* ɵɵelement */._UZ(10, "strong");
    fesm2015_core/* ɵɵelementEnd */.qZA();
    fesm2015_core/* ɵɵelementStart */.TgZ(11, "p");
    fesm2015_core/* ɵɵelement */._UZ(12, "tui-doc-code", 5);
    fesm2015_core/* ɵɵelementEnd */.qZA();
    fesm2015_core/* ɵɵi18nEnd */.N_p();
    fesm2015_core/* ɵɵelementEnd */.qZA();
    fesm2015_core/* ɵɵelementStart */.TgZ(13, "tui-doc-example", 6);
    fesm2015_core/* ɵɵelement */._UZ(14, "tui-calendar-example-1");
    fesm2015_core/* ɵɵelementEnd */.qZA();
    fesm2015_core/* ɵɵelementStart */.TgZ(15, "tui-doc-example", 7);
    fesm2015_core/* ɵɵelement */._UZ(16, "tui-calendar-example-2");
    fesm2015_core/* ɵɵelementEnd */.qZA();
    fesm2015_core/* ɵɵelementStart */.TgZ(17, "tui-doc-example", 8);
    fesm2015_core/* ɵɵelement */._UZ(18, "tui-calendar-example-3");
    fesm2015_core/* ɵɵelementEnd */.qZA();
  }
  ...
  if (rf & 2) {
    ...
    fesm2015_core/* ɵɵproperty */.Q6J("routerLink", fesm2015_core/* ɵɵpureFunction0 */.DdM(6, _c8));
    fesm2015_core/* ɵɵadvance */.xp6(3);
    fesm2015_core/* ɵɵproperty */.Q6J("routerLink", fesm2015_core/* ɵɵpureFunction0 */.DdM(7, _c9));
    fesm2015_core/* ɵɵadvance */.xp6(7);
    fesm2015_core/* ɵɵproperty */.Q6J("code", ctx_r0.firstDayOfWeekToken);
    fesm2015_core/* ɵɵadvance */.xp6(1);
...
function ExampleTuiCalendarComponent_ng_template_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    fesm2015_core/* ɵɵlistener */.NdJ("monthChange", function ExampleTuiCalendarComponent_ng_template_2_Template_tui_calendar_monthChange_1_listener($event) {
      ...
      return ctx_r16.hoveredItem = $event;
    ...
    fesm2015_core/* ɵɵlistener */.NdJ("documentationPropertyValueChange", function ExampleTuiCalendarComponent_ng_template_2_Template_ng_template_documentationPropertyValueChange_4_listener($event) {
      ...
      return ctx_r19.showAdjacent = $event;
    });
    ...
    fesm2015_core/* ɵɵlistener */.NdJ("documentationPropertyValueChange", function ExampleTuiCalendarComponent_ng_template_2_Template_ng_template_documentationPropertyValueChange_6_listener($event) {
      ...
      return ctx_r21.markerHandler = $event;
    });
...
let ExampleTuiCalendarComponent = /*#__PURE__*/(() => {
  class ExampleTuiCalendarComponent {
    constructor(alertService) {
      ...
      this.firstDayOfWeekToken = __webpack_require__.e(/* import() */ 43288).then(__webpack_require__.t.bind(__webpack_require__, 43288, 17));
      this.example1 = {
      ...
      this.maxVariants = [cdk/* TUI_LAST_DAY */.OyN, new cdk/* TuiDay */.TU1(2020, 3, 30), new cdk/* TuiDay */.TU1(2300, 0, 1)];
      this.max = this.maxVariants[0];
      this.minViewedMonthVariants = [new cdk/* TuiMonth */.qld(0, 0), new cdk/* TuiMonth */.qld(2017, 2), new cdk/* TuiMonth */.qld(1900, 0)];
      this.minViewedMonth = this.minViewedMonthVariants[0];
      this.maxViewedMonthVariants = [cdk/* TUI_LAST_DAY */.OyN, new cdk/* TuiMonth */.qld(2020, 3), new cdk/* TuiMonth */.qld(2300, 0)];
      ...
      this.markerHandlerVariants = [core/* TUI_DEFAULT_MARKER_HANDLER */.zE9, day => day.day % 2 === 0 ? calendar_component_TWO_DOTS : calendar_component_ONE_DOT];
      this.markerHandler = this.markerHandlerVariants[0];
      this.valueVariants = [cdk/* TuiDay.currentLocal */.TU1.currentLocal(), new cdk/* TuiDayRange */.VRe(cdk/* TuiDay.currentLocal */.TU1.currentLocal(), cdk/* TuiDay.currentLocal */.TU1.currentLocal().append({
        day: 3
      })), new cdk/* TuiDay */.TU1(2020, 3, 21)];
      this.value = null;
      this.month = cdk/* TuiMonth.currentLocal */.qld.currentLocal();
      this.hoveredItem = null;
    }
  ...
  ExampleTuiCalendarComponent.ɵfac = function ExampleTuiCalendarComponent_Factory(t) {
    return new (t || ExampleTuiCalendarComponent)(fesm2015_core/* ɵɵdirectiveInject */.Y36(core/* TuiAlertService */.J9F));
  };
  ...
  ExampleTuiCalendarComponent.ɵcmp = /*@__PURE__*/fesm2015_core/* ɵɵdefineComponent */.Xpm({
    ...
    consts: function () {
      ...
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG_EXTERNAL_4402714714780180362$$PROJECTS_DEMO_SRC_MODULES_COMPONENTS_CALENDAR_CALENDAR_COMPONENT_TS__1 = goog.getMsg(" Use {$startTagCode}{$startTagStrong}TUI_FIRST_DAY_OF_WEEK{$closeTagStrong}{$closeTagCode} token if you need to change start day of the week (Monday by default): {$startParagraph}{$startTagTuiDocCode}{$closeTagTuiDocCode}{$closeParagraph}", {
          "startTagCode": "\uFFFD#9\uFFFD",
          "startTagStrong": "\uFFFD#10\uFFFD",
          "closeTagStrong": "\uFFFD/#10\uFFFD",
          "closeTagCode": "\uFFFD/#9\uFFFD",
          "startParagraph": "\uFFFD#11\uFFFD",
          "startTagTuiDocCode": "\uFFFD#12\uFFFD",
          "closeTagTuiDocCode": "\uFFFD/#12\uFFFD",
          "closeParagraph": "\uFFFD/#11\uFFFD"
        });
        i18n_0 = MSG_EXTERNAL_4402714714780180362$$PROJECTS_DEMO_SRC_MODULES_COMPONENTS_CALENDAR_CALENDAR_COMPONENT_TS__1;
      } else {
      ...
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG_EXTERNAL_8643289769990675407$$PROJECTS_DEMO_SRC_MODULES_COMPONENTS_CALENDAR_CALENDAR_COMPONENT_TS__3 = goog.getMsg("Basic");
        i18n_2 = MSG_EXTERNAL_8643289769990675407$$PROJECTS_DEMO_SRC_MODULES_COMPONENTS_CALENDAR_CALENDAR_COMPONENT_TS__3;
      } else {
      ...
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG_EXTERNAL_8823844911216143942$$PROJECTS_DEMO_SRC_MODULES_COMPONENTS_CALENDAR_CALENDAR_COMPONENT_TS__5 = goog.getMsg("range");
        i18n_4 = MSG_EXTERNAL_8823844911216143942$$PROJECTS_DEMO_SRC_MODULES_COMPONENTS_CALENDAR_CALENDAR_COMPONENT_TS__5;
      } else {
        i18n_4 = $localize`:␟0ed6cbeb3b69bb940c9e3365663a6bff540311e7␟8823844911216143942:range`;
      }

      let i18n_6;

      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG_EXTERNAL_5871122953070556647$$PROJECTS_DEMO_SRC_MODULES_COMPONENTS_CALENDAR_CALENDAR_COMPONENT_TS__7 = goog.getMsg("With markers");
        i18n_6 = MSG_EXTERNAL_5871122953070556647$$PROJECTS_DEMO_SRC_MODULES_COMPONENTS_CALENDAR_CALENDAR_COMPONENT_TS__7;
      } else {
        i18n_6 = $localize`:␟f0ad0067675751d24dcae9afde2a56fe3ecf3c45␟5871122953070556647:With markers`;
      }
    ...
    directives: [page_component/* TuiDocPageComponent */.q, page_tab_directive/* TuiDocPageTabConnectorDirective */.n, link_component/* TuiLinkComponent */.V, router/* RouterLinkWithHref */.yS, notification_component/* TuiNotificationComponent */.L, code_component/* TuiDocCodeComponent */.c, example_component/* TuiDocExampleComponent */.f, TuiCalendarExample1, TuiCalendarExample2, TuiCalendarExample3, demo_component/* TuiDocDemoComponent */.F, calendar_component/* TuiCalendarComponent */.a, documentation_component/* TuiDocDocumentationComponent */.z, documentation_property_connector_directive/* TuiDocDocumentationPropertyConnectorDirective */.B],
    encapsulation: 2,
    changeDetection: 0
  });
...
let ExampleTuiCalendarModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiCalendarModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, router/* RouterModule */.Bz, core/* TuiLinkModule */.jzK, core/* TuiCalendarModule */.vVq, public_api/* TuiAddonDocModule */.fV, core/* TuiNotificationModule */.HiG, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiCalendarComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiCalendarModule, {
    declarations: [ExampleTuiCalendarComponent, TuiCalendarExample1, TuiCalendarExample2, TuiCalendarExample3],
    imports: [common/* CommonModule */.ez, router/* RouterModule */.Bz, core/* TuiLinkModule */.jzK, core/* TuiCalendarModule */.vVq, public_api/* TuiAddonDocModule */.fV, core/* TuiNotificationModule */.HiG, router/* RouterModule */.Bz],
