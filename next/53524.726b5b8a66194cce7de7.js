  ...
  class PortalsComponent {
    constructor() {
      ...
      this.example1 = {
        ...
        HTML: __webpack_require__.e(/* import() */ 91068).then(__webpack_require__.t.bind(__webpack_require__, 98913, 17)),
...
let PortalsModule = /*#__PURE__*/(() => {
  ...
  PortalsModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, _ustom_host_module/* CustomHostModule */.T, core/* TuiButtonModule */.fNO, kit/* TuiAvatarModule */.JmR, public_api/* TuiAddonDocModule */.fV, core/* TuiSvgModule */.EIu, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(PortalsComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(PortalsModule, {
    ...
    imports: [common/* CommonModule */.ez, _ustom_host_module/* CustomHostModule */.T, core/* TuiButtonModule */.fNO, kit/* TuiAvatarModule */.JmR, public_api/* TuiAddonDocModule */.fV, core/* TuiSvgModule */.EIu, router/* RouterModule */.Bz],
