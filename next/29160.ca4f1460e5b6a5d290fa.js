...
class TuiAxesExample2 {
  constructor() {
    ...
    this.horizontalLinesHandler = addon_charts/* TUI_ALWAYS_DASHED */.oG;
    this.verticalLinesHandler = addon_charts/* TUI_ALWAYS_NONE */.BK;
  }
  ...
  getMax(value) {
    return (0,cdk/* tuiCeil */.BrH)(value.reduce((max, value) => Math.max(...value, max), 0), -1);
  }
...
TuiAxesExample2.ɵcmp = /*@__PURE__*/fesm2015_core/* ɵɵdefineComponent */.Xpm({
  ...
  directives: [axes_component/* TuiAxesComponent */.v, bar_chart_component/* TuiBarChartComponent */.g, hint_options_directive/* TuiHintOptionsDirective */.b, common/* NgForOf */.sg, money_component/* TuiMoneyComponent */.o],
...
(0,tslib_es6/* __decorate */.gn)([cdk/* tuiPure */.UMq], TuiAxesExample2.prototype, "getMax", null);
...
let ExampleTuiAxesComponent = /*#__PURE__*/(() => {
  class ExampleTuiAxesComponent {
    constructor() {
      ...
      this.handlerVariants = [addon_charts/* TUI_ALWAYS_SOLID */.Fy, addon_charts/* TUI_ALWAYS_DASHED */.oG, index => index % 2 ? `dashed` : `solid`];
...
let ExampleTuiAxesModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiAxesModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, router/* RouterModule */.Bz, addon_charts/* TuiAxesModule */.Ep, addon_charts/* TuiBarChartModule */.dd, core/* TuiHintModule */.goS, tinkoff_ng_polymorpheus/* PolymorpheusModule */.wq, addon_commerce/* TuiMoneyModule */.DC, public_api/* TuiAddonDocModule */.fV, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiAxesComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiAxesModule, {
    ...
    imports: [common/* CommonModule */.ez, router/* RouterModule */.Bz, addon_charts/* TuiAxesModule */.Ep, addon_charts/* TuiBarChartModule */.dd, core/* TuiHintModule */.goS, tinkoff_ng_polymorpheus/* PolymorpheusModule */.wq, addon_commerce/* TuiMoneyModule */.DC, public_api/* TuiAddonDocModule */.fV, router/* RouterModule */.Bz],
