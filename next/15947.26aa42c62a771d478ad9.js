...
let BreakpointsModule = /*#__PURE__*/(() => {
  ...
  BreakpointsModule.ɵinj = /*@__PURE__*/core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, public_api/* TuiAddonDocModule */.fV, addon_table/* TuiTableModule */.jz, public_api/* TuiDocCopyModule */.k7, clipboard/* ClipboardModule */.Iq, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(BreakpointsComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && core/* ɵɵsetNgModuleScope */.kYT(BreakpointsModule, {
    ...
    imports: [common/* CommonModule */.ez, public_api/* TuiAddonDocModule */.fV, addon_table/* TuiTableModule */.jz, public_api/* TuiDocCopyModule */.k7, clipboard/* ClipboardModule */.Iq, router/* RouterModule */.Bz],
