...
let ExampleTuiArcChartModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiArcChartModule.ɵinj = /*@__PURE__*/core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, router/* RouterModule */.Bz, fesm2015_forms/* FormsModule */.u5, kit/* TuiInputCountModule */.$HZ, addon_charts/* TuiArcChartModule */.Or, addon_commerce/* TuiMoneyModule */.DC, public_api/* TuiAddonDocModule */.fV, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiArcChartComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiArcChartModule, {
    ...
    imports: [common/* CommonModule */.ez, router/* RouterModule */.Bz, fesm2015_forms/* FormsModule */.u5, kit/* TuiInputCountModule */.$HZ, addon_charts/* TuiArcChartModule */.Or, addon_commerce/* TuiMoneyModule */.DC, public_api/* TuiAddonDocModule */.fV, router/* RouterModule */.Bz],
