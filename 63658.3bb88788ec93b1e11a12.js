"use strict";
(self["webpackChunk_taiga_ui_components"] = self["webpackChunk_taiga_ui_components"] || []).push([[63658],{
...
;// CONCATENATED MODULE: ./node_modules/linkifyjs/dist/linkify.module.js
/**
...
var SYM = 'SYM';
var linkify_module_text = /*#__PURE__*/Object.freeze({
  __proto__: null,
  DOMAIN: DOMAIN,
  LOCALHOST: LOCALHOST,
  TLD: TLD,
...
function init$2() {
  var customProtocols = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : []; // Frequently used states
...
function autolink(options) {
  return new dist/* Plugin */.Sy({
    key: new dist/* PluginKey */.H$('autolink'),
    appendTransaction: (transactions, oldState, newState) => {
      ...
      const transform = (0,tiptap_core_esm.combineTransactionSteps)(oldState.doc, [...transactions]);
      const {
        mapping
      } = transform;
      const changes = (0,tiptap_core_esm.getChangedRanges)(transform);
      changes.forEach(({
        oldRange,
        newRange
      }) => {
        // at first we check if we have to remove links
        (0,tiptap_core_esm.getMarksBetween)(oldRange.from, oldRange.to, oldState.doc).filter(item => item.mark.type === options.type).forEach(oldMark => {
          const newFrom = mapping.map(oldMark.from);
          const newTo = mapping.map(oldMark.to);
          const newMarks = (0,tiptap_core_esm.getMarksBetween)(newFrom, newTo, newState.doc).filter(item => item.mark.type === options.type);
...
function clickHandler(options) {
  return new dist/* Plugin */.Sy({
    key: new dist/* PluginKey */.H$('handleClickLink'),
    props: {
      handleClick: (view, pos, event) => {
        var _a;

        const attrs = (0,tiptap_core_esm.getAttributes)(view.state, options.type.name);
...
function pasteHandler(options) {
  return new dist/* Plugin */.Sy({
    key: new dist/* PluginKey */.H$('handlePasteLink'),
    props: {
...
const Link = tiptap_core_esm.Mark.create({
  name: 'link',
  priority: 1000,
  keepOnSplit: false,
  ...
  renderHTML({
    ...
    return ['a', (0,tiptap_core_esm.mergeAttributes)(this.options.HTMLAttributes, HTMLAttributes), 0];
  },
  ...
  addPasteRules() {
    return [(0,tiptap_core_esm.markPasteRule)({
