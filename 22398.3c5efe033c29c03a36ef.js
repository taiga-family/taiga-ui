...
let ShadowsComponent = /*#__PURE__*/(() => {
  ...
  ShadowsComponent.ɵcmp = /*@__PURE__*/core/* ɵɵdefineComponent */.Xpm({
    ...
    styles: [".example[_ngcontent-%COMP%]{display:flex;flex:1;flex-wrap:wrap;padding:1.25rem}.item[_ngcontent-%COMP%]{transition-property:box-shadow;transition-duration:var(--tui-duration, .3s);transition-timing-function:ease-in-out;display:flex;align-items:center;justify-content:center;margin-top:2.5rem;margin-left:2.5rem;width:17.5rem;height:5rem;border-radius:var(--tui-radius-m);color:var(--tui-text-03);cursor:pointer;text-align:center}.item_default[_ngcontent-%COMP%]{box-shadow:0 .25rem 1.5rem rgba(0,0,0,.12)}.item_default[_ngcontent-%COMP%]:hover{box-shadow:0 .75rem 2.25rem rgba(0,0,0,.2)}.item_dropdown[_ngcontent-%COMP%]{box-shadow:0 1.5rem 1rem rgba(0,0,0,.03),0 .75rem .75rem rgba(0,0,0,.04),0 .25rem .375rem rgba(0,0,0,.05)}.item_modal[_ngcontent-%COMP%]{box-shadow:0 1.125rem 1.875rem rgba(0,0,0,.48)}.item_sidebar[_ngcontent-%COMP%]{box-shadow:.25rem 0 1.5rem rgba(0,0,0,.12)}.item_navigation[_ngcontent-%COMP%]{box-shadow:0 .125rem 1rem rgba(0,0,0,.08)}.item_mobile[_ngcontent-%COMP%]{box-shadow:0 -1rem 1.75rem rgba(0,0,0,.24)}"],
    changeDetection: 0
  });
