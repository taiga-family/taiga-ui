...
let TuiCardExample3 = /*#__PURE__*/(() => {
  ...
  TuiCardExample3.ɵcmp = /*@__PURE__*/core/* ɵɵdefineComponent */.Xpm({
    ...
    directives: [card_component/* TuiCardComponent */.S],
    styles: ["@keyframes spinCard{0%{transform:rotateY(0);box-shadow:0 0 rgba(0,0,0,.3)}12%{transform:rotateY(90deg) rotate(6deg) scale(1.7);box-shadow:0 .25rem .5rem rgba(0,0,0,.3)}25%{transform:rotateY(180deg);box-shadow:0 0 rgba(0,0,0,.3)}50%{transform:rotateY(180deg);box-shadow:0 0 rgba(0,0,0,.3)}62%{transform:rotateY(270deg) rotate(-8deg) scale(1.7);box-shadow:0 .25rem .5rem rgba(0,0,0,.3)}80%{transform:rotateY(720deg);box-shadow:0 0 rgba(0,0,0,.3)}to{transform:rotateY(720deg);box-shadow:0 0 rgba(0,0,0,.3)}}[_nghost-%COMP%]{perspective:50rem}.logo[_ngcontent-%COMP%]{color:var(--tui-base-01);background-color:#7c48c3;background-image:linear-gradient(45deg,#c86dd7 0%,#3023ae 100%);margin-bottom:1rem;animation:spinCard 5s infinite}"],
    changeDetection: 0
  });
...
let ExampleTuiCardComponent = /*#__PURE__*/(() => {
  class ExampleTuiCardComponent {
    constructor() {
      ...
      this.exampleHtml = __webpack_require__.e(/* import() */ 4526).then(__webpack_require__.t.bind(__webpack_require__, 11966, 17));
