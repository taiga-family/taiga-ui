            ...
            <ng-template #description>
                @switch ($index) {
                    ...
                    @case (3) {
                        ...
                        . If you prefer to use anything else, like a string you can provide custom transformer in
                        options to store value in different format in form control
                    }
                    @case (4) {
