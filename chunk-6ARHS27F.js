import"./chunk-HU6DUUP4.js";var t=`<img
    alt="taiga"
    loading="lazy"
...
<section
    ...
    class="components"
    [class.components_first]="current === 1"
    [class.components_second]="current === 2"
>
    ...
    <div class="customize">
        ...
        >
            <path
                d="M94 0L87.9795 9.85325L99.5229 10.1406L94 0ZM1.093 109.996C18.1038 108.407 40.5258 102.765 59.2087 87.6932C77.927 72.5926 92.7921 48.1045 94.775 9.04005L92.7775 8.93866C90.821 47.4838 76.1912 71.4232 57.9529 86.1366C39.6791 100.879 17.6828 106.437 0.907002 108.004L1.093 109.996Z"
                fill="white"
            />
        </svg>
    </div>
    @if (current === 2) {
        <div
            tuiAnimated
            class="container container_dark animated"
        >
            <h2 class="opensource">It\u2019s open source</h2>
            <p class="contributions">
                We use these components in our work ourselves, so we often release updates. Contributions are welcome \u2014
                <a
