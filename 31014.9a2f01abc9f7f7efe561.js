...
let ExampleTuiPanModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiPanModule.ɵinj = /*@__PURE__*/core/* ɵɵdefineInjector */.cJS({
    imports: [[common/* CommonModule */.ez, cdk.TuiPanModule, public_api/* TuiAddonDocModule */.fV, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiPanComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiPanModule, {
    ...
    imports: [common/* CommonModule */.ez, cdk.TuiPanModule, public_api/* TuiAddonDocModule */.fV, router/* RouterModule */.Bz],
