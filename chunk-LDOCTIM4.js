            ...
            <ng-template #description>
                @switch ($index) {
                    ...
                    @case (1) {
                        By default,
                        <code>strict</code>
                        mode is enabled. This means the input value must match one of the options from the data list. If
                        the value doesn't match, the form control is not updated and the input is cleared on blur.

                        <p>
                            In non-strict mode, the form control can contain any value \u2014 even if it doesn\u2019t match any
                    ...
                    @case (10) {
                        ...
                        <p class="tui-space_top-0">
                            ...
                            <strong>on\xA0mobile\xA0devices.</strong>
                        </p>
                    ...
                    @case (12) {
                        Provide your custom directive as a proxy value handler using
                        <code>tuiAsTextfieldAccessor</code>
                        if you need some custom logic upon picking an item.
                    }
                }
            </ng-template>
        }
