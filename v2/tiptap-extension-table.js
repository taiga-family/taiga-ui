(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tiptap-extension-table"],{

/***/ "../../node_modules/@tiptap/extension-table/dist/tiptap-extension-table.esm.js":
/*!*******************************************************************************************************************!*\
  !*** /home/runner/work/taiga-ui/taiga-ui/node_modules/@tiptap/extension-table/dist/tiptap-extension-table.esm.js ***!
  \*******************************************************************************************************************/
/*! exports provided: Table, createTable, default */
...
/* harmony import */ var prosemirror_tables_contently__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! prosemirror-tables-contently */ "../../node_modules/prosemirror-tables-contently/dist/index.es.js");
...
function isCellSelection(value) {
    return value instanceof prosemirror_tables_contently__WEBPACK_IMPORTED_MODULE_2__["CellSelection"];
}
...
const deleteTableWhenAllCellsSelected = ({ editor }) => {
    ...
    let cellCount = 0;
    const table = Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__["findParentNodeClosestToPos"])(selection.ranges[0].$from, node => {
...
const Table = _tiptap_core__WEBPACK_IMPORTED_MODULE_0__["Node"].create({
    name: 'table',
    // @ts-ignore
    addOptions() {
        return {
    ...
    renderHTML({ HTMLAttributes }) {
        return ['table', Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__["mergeAttributes"])(this.options.HTMLAttributes, HTMLAttributes), ['tbody', 0]];
    },
    addCommands() {
        return {
            insertTable: ({ rows = 3, cols = 3, withHeaderRow = true } = {}) => ({ tr, dispatch, editor }) => {
                ...
                if (dispatch) {
                    ...
                    tr.replaceSelectionWith(node)
                        .scrollIntoView()
                        .setSelection(prosemirror_state__WEBPACK_IMPORTED_MODULE_1__["TextSelection"].near(tr.doc.resolve(offset)));
                }
                return true;
            },
            addColumnBefore: () => ({ state, dispatch }) => {
                return Object(prosemirror_tables_contently__WEBPACK_IMPORTED_MODULE_2__["addColumnBefore"])(state, dispatch);
            },
            addColumnAfter: () => ({ state, dispatch }) => {
                return Object(prosemirror_tables_contently__WEBPACK_IMPORTED_MODULE_2__["addColumnAfter"])(state, dispatch);
            },
            deleteColumn: () => ({ state, dispatch }) => {
                return Object(prosemirror_tables_contently__WEBPACK_IMPORTED_MODULE_2__["deleteColumn"])(state, dispatch);
            },
            addRowBefore: () => ({ state, dispatch }) => {
                return Object(prosemirror_tables_contently__WEBPACK_IMPORTED_MODULE_2__["addRowBefore"])(state, dispatch);
            },
            addRowAfter: () => ({ state, dispatch }) => {
                return Object(prosemirror_tables_contently__WEBPACK_IMPORTED_MODULE_2__["addRowAfter"])(state, dispatch);
            },
            deleteRow: () => ({ state, dispatch }) => {
                return Object(prosemirror_tables_contently__WEBPACK_IMPORTED_MODULE_2__["deleteRow"])(state, dispatch);
            },
            deleteTable: () => ({ state, dispatch }) => {
                return Object(prosemirror_tables_contently__WEBPACK_IMPORTED_MODULE_2__["deleteTable"])(state, dispatch);
            },
            mergeCells: () => ({ state, dispatch }) => {
                return Object(prosemirror_tables_contently__WEBPACK_IMPORTED_MODULE_2__["mergeCells"])(state, dispatch);
            },
            splitCell: () => ({ state, dispatch }) => {
                return Object(prosemirror_tables_contently__WEBPACK_IMPORTED_MODULE_2__["splitCell"])(state, dispatch);
            },
            toggleHeaderColumn: () => ({ state, dispatch }) => {
                return Object(prosemirror_tables_contently__WEBPACK_IMPORTED_MODULE_2__["toggleHeader"])('column')(state, dispatch);
            },
            toggleHeaderRow: () => ({ state, dispatch }) => {
                return Object(prosemirror_tables_contently__WEBPACK_IMPORTED_MODULE_2__["toggleHeader"])('row')(state, dispatch);
            },
            toggleHeaderCell: () => ({ state, dispatch }) => {
                return Object(prosemirror_tables_contently__WEBPACK_IMPORTED_MODULE_2__["toggleHeaderCell"])(state, dispatch);
            },
            mergeOrSplit: () => ({ state, dispatch }) => {
                if (Object(prosemirror_tables_contently__WEBPACK_IMPORTED_MODULE_2__["mergeCells"])(state, dispatch)) {
                    return true;
                }
                return Object(prosemirror_tables_contently__WEBPACK_IMPORTED_MODULE_2__["splitCell"])(state, dispatch);
            },
            setCellAttribute: (name, value) => ({ state, dispatch }) => {
                return Object(prosemirror_tables_contently__WEBPACK_IMPORTED_MODULE_2__["setCellAttr"])(name, value)(state, dispatch);
            },
            goToNextCell: () => ({ state, dispatch }) => {
                return Object(prosemirror_tables_contently__WEBPACK_IMPORTED_MODULE_2__["goToNextCell"])(1)(state, dispatch);
            },
            ...
            fixTables: () => ({ state, dispatch }) => {
                if (dispatch) {
                    Object(prosemirror_tables_contently__WEBPACK_IMPORTED_MODULE_2__["fixTables"])(state);
                }
                return true;
            },
            setCellSelection: position => ({ tr, dispatch }) => {
                if (dispatch) {
                    const selection = prosemirror_tables_contently__WEBPACK_IMPORTED_MODULE_2__["CellSelection"].create(tr.doc, position.anchorCell, position.headCell);
                    // @ts-ignore
    ...
    addProseMirrorPlugins() {
        ...
        return [
            ...(isResizable ? [Object(prosemirror_tables_contently__WEBPACK_IMPORTED_MODULE_2__["columnResizing"])({
            ...
            Object(prosemirror_tables_contently__WEBPACK_IMPORTED_MODULE_2__["tableEditing"])({
    ...
    extendNodeSchema(extension) {
        ...
        return {
            tableRole: Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__["callOrReturn"])(Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__["getExtensionField"])(extension, 'tableRole', context)),
        };
    },
});
...
/*!******************************************************************************************************!*\
  !*** /home/runner/work/taiga-ui/taiga-ui/node_modules/prosemirror-tables-contently/dist/index.es.js ***!
  \******************************************************************************************************/
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "columnResizingPluginKey", function() { return key; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "tableEditingKey", function() { return key$1; });
...
/* harmony import */ var prosemirror_transform__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! prosemirror-transform */ "../../node_modules/prosemirror-transform/dist/index.js");
...
const key$1 = new prosemirror_state__WEBPACK_IMPORTED_MODULE_0__["PluginKey"]('selectingCells');
...
class CellSelection extends prosemirror_state__WEBPACK_IMPORTED_MODULE_0__["Selection"] {
  ...
  replace(tr, content = prosemirror_model__WEBPACK_IMPORTED_MODULE_1__["Slice"].empty) {
    ...
    let sel = prosemirror_state__WEBPACK_IMPORTED_MODULE_0__["Selection"].findFrom(tr.doc.resolve(tr.mapping.slice(mapFrom).map(this.to)), -1);
...
function drawCellSelection(state) {
  ...
  state.selection.forEachCell((node, pos) => {
    cells.push(prosemirror_view__WEBPACK_IMPORTED_MODULE_3__["Decoration"].node(pos, pos + node.nodeSize, {
      class: 'selectedCell'
    }));
  });
...
function fitSlice(nodeType, slice) {
  ...
  let tr = new prosemirror_transform__WEBPACK_IMPORTED_MODULE_4__["Transform"](node).replace(0, node.content.size, slice);
  return tr.doc;
...
function growTable(tr, map, table, start, width, height, mapFrom) {
  ...
  if (height > map.height) {
    ...
    let emptyRow = types.row.create(null, prosemirror_model__WEBPACK_IMPORTED_MODULE_1__["Fragment"].from(cells)),
        rows = [];
...
const handleKeyDown = Object(prosemirror_keymap__WEBPACK_IMPORTED_MODULE_2__["keydownHandler"])({
...
const fixTablesKey = new prosemirror_state__WEBPACK_IMPORTED_MODULE_0__["PluginKey"]('fix-tables'); // Helper for iterating through the nodes in a document that changed
...
function mergeCells(state, dispatch) {
  ...
  if (dispatch) {
    let tr = state.tr,
        seen = {},
        content = prosemirror_model__WEBPACK_IMPORTED_MODULE_1__["Fragment"].empty,
        mergedPos,
        mergedCell;
...
const key = new prosemirror_state__WEBPACK_IMPORTED_MODULE_0__["PluginKey"]('tableColumnResizing');
...
//# sourceMappingURL=tiptap-extension-table.js.map