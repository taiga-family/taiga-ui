(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tiptap-extension-link"],{

/***/ "../../node_modules/@tiptap/extension-link/dist/tiptap-extension-link.esm.js":
/*!*****************************************************************************************************************!*\
  !*** /home/runner/work/taiga-ui/taiga-ui/node_modules/@tiptap/extension-link/dist/tiptap-extension-link.esm.js ***!
  \*****************************************************************************************************************/
...
function autolink(options) {
    return new prosemirror_state__WEBPACK_IMPORTED_MODULE_2__["Plugin"]({
        key: new prosemirror_state__WEBPACK_IMPORTED_MODULE_2__["PluginKey"]('autolink'),
        appendTransaction: (transactions, oldState, newState) => {
            ...
            const { tr } = newState;
            const transform = Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__["combineTransactionSteps"])(oldState.doc, [...transactions]);
            const { mapping } = transform;
            const changes = Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__["getChangedRanges"])(transform);
            changes.forEach(({ oldRange, newRange }) => {
                // at first we check if we have to remove links
                Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__["getMarksBetween"])(oldRange.from, oldRange.to, oldState.doc)
                    .filter(item => item.mark.type === options.type)
                    .forEach(oldMark => {
                    const newFrom = mapping.map(oldMark.from);
                    const newTo = mapping.map(oldMark.to);
                    const newMarks = Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__["getMarksBetween"])(newFrom, newTo, newState.doc)
                        .filter(item => item.mark.type === options.type);
                    if (!newMarks.length) {
                        return;
                    }
                    ...
                    const wasLink = Object(linkifyjs__WEBPACK_IMPORTED_MODULE_1__["test"])(oldLinkText);
                    const isLink = Object(linkifyjs__WEBPACK_IMPORTED_MODULE_1__["test"])(newLinkText);
                ...
                Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__["findChildrenInRange"])(newState.doc, newRange, node => node.isTextblock)
                    .forEach(textBlock => {
                    ...
                    Object(linkifyjs__WEBPACK_IMPORTED_MODULE_1__["find"])(text)
...
function clickHandler(options) {
    return new prosemirror_state__WEBPACK_IMPORTED_MODULE_2__["Plugin"]({
        key: new prosemirror_state__WEBPACK_IMPORTED_MODULE_2__["PluginKey"]('handleClickLink'),
        props: {
            handleClick: (view, pos, event) => {
                var _a;
                const attrs = Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__["getAttributes"])(view.state, options.type.name);
...
function pasteHandler(options) {
    return new prosemirror_state__WEBPACK_IMPORTED_MODULE_2__["Plugin"]({
        key: new prosemirror_state__WEBPACK_IMPORTED_MODULE_2__["PluginKey"]('handlePasteLink'),
        props: {
            handlePaste: (view, event, slice) => {
                ...
                const link = Object(linkifyjs__WEBPACK_IMPORTED_MODULE_1__["find"])(textContent).find(item => item.isLink && item.value === textContent);
                if (!textContent || !link) {
                    return false;
                }
...
const Link = _tiptap_core__WEBPACK_IMPORTED_MODULE_0__["Mark"].create({
    ...
    keepOnSplit: false,
    onCreate() {
        this.options.protocols.forEach(linkifyjs__WEBPACK_IMPORTED_MODULE_1__["registerCustomProtocol"]);
    },
    inclusive() {
    ...
    addPasteRules() {
        return [
            Object(_tiptap_core__WEBPACK_IMPORTED_MODULE_0__["markPasteRule"])({
                find: text => Object(linkifyjs__WEBPACK_IMPORTED_MODULE_1__["find"])(text)
                    .filter(link => {
...
/*!*****************************************************************************************!*\
  !*** /home/runner/work/taiga-ui/taiga-ui/node_modules/linkifyjs/dist/linkify.module.js ***!
  \*****************************************************************************************/
...
//# sourceMappingURL=tiptap-extension-link.js.map