import"./chunk-42JZD6NG.js";var i=`<!-- Ignore this part, it is only here to position drawer inside the example block -->
    ...
    >
        <header>
            ...
            >
                ...
                <ng-template #hint>
                    <span tuiFade>A very very long product name</span>
                    <tui-badge appearance="accent">Alpha</tui-badge>
                </ng-template>
            </button>
        </header>
        <button
