...
let TuiTreeExample3 = /*#__PURE__*/(() => {
  class TuiTreeExample3 {
    constructor() {
      ...
      this.handler = item => item.children || cdk.EMPTY_ARRAY;
    }
...
let FoldersComponent = /*#__PURE__*/(() => {
  class FoldersComponent extends kit.TuiTreeItemContentComponent {
    get icon() {
...
let TuiTreeExample7 = /*#__PURE__*/(() => {
  ...
  TuiTreeExample7.ɵfac = function TuiTreeExample7_Factory(t) {
    return new (t || TuiTreeExample7)(fesm2015_core/* ɵɵdirectiveInject */.Y36(kit.TUI_TREE_LOADING), fesm2015_core/* ɵɵdirectiveInject */.Y36(kit.TuiTreeService));
  };

  TuiTreeExample7.ɵcmp = /*@__PURE__*/fesm2015_core/* ɵɵdefineComponent */.Xpm({
    type: TuiTreeExample7,
    selectors: [["tui-tree-example-7"]],
    features: [fesm2015_core/* ɵɵProvidersFeature */._Bn([kit.TuiTreeService, {
      provide: kit.TUI_TREE_START,
      useValue: {
        text: `Topmost`
      }
    }, {
      provide: kit.TUI_TREE_LOADER,
      useClass: TreeLoader
    }])],
    decls: 4,
    vars: 7,
...
let ExampleTuiTreeModule = /*#__PURE__*/(() => {
  ...
  ExampleTuiTreeModule.ɵinj = /*@__PURE__*/fesm2015_core/* ɵɵdefineInjector */.cJS({
    imports: [[kit.TuiTreeModule, core.TuiSvgModule, core.TuiButtonModule, core.TuiLinkModule, kit.TuiCheckboxLabeledModule, cdk.TuiMapperPipeModule, core.TuiLoaderModule, fesm2015_forms/* FormsModule */.u5, common/* CommonModule */.ez, public_api/* TuiAddonDocModule */.fV, router/* RouterModule.forChild */.Bz.forChild((0,public_api/* tuiGenerateRoutes */.Ve)(ExampleTuiTreeComponent))]]
  });
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && fesm2015_core/* ɵɵsetNgModuleScope */.kYT(ExampleTuiTreeModule, {
    ...
    imports: [kit.TuiTreeModule, core.TuiSvgModule, core.TuiButtonModule, core.TuiLinkModule, kit.TuiCheckboxLabeledModule, cdk.TuiMapperPipeModule, core.TuiLoaderModule, fesm2015_forms/* FormsModule */.u5, common/* CommonModule */.ez, public_api/* TuiAddonDocModule */.fV, router/* RouterModule */.Bz],
