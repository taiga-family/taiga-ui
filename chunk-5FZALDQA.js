import"./chunk-HU6DUUP4.js";var s=`<tui-doc-page [header]="\`Github App \${botName}\`">
    <strong>
        Try our
        <a
            target="_blank"
        ...
        for your screenshots testing in CI.
    </strong>
        ...
        <ol class="steps">
            <li>
                <a
                    target="_blank"
                    tuiLink
                    [href]="\`\${botAppLink}/installations/new\`"
                >
                    Invite him
                </a>
                to you repo.
