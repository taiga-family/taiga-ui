                ...
                @switch ($index) {
                    @case (0) {
                        <p class="tui-space_top-0">
                            ...
                            <code>
                                ...
                                <ng-template #metadataDefinition>
                                    ...
                                    to refer to all information about phone numbering in a particular country - what the
                                    country code, international and national dialling prefixes are, what carrier codes
                                    are operational, which phone numbers are possible or valid for a particular country,
                                    how to optimally format them, which prefixes represent a particular geographical
                                    area, etc.
                                </ng-template>
                            </code>
                            .
                        ...
                        <p>
                            ...
                            provides different "metadata" sets to provides a way to optimize bundle size by choosing
                            between
                            <code>max</code>
                            ,
                            <code>min</code>
                    ...
                    @case (1) {
                        ...
                        >
                            <strong>Note:</strong>
                            Importing utilities directly from the root of
                            <code>libphonenumber-js</code>
                            automatically includes the default (min) metadata in your bundle. To optimize bundle size
                            and ensure consistency, it is recommended to import from specific entry points like
                            <code>libphonenumber-js/min</code>
                            ,
                            <code>libphonenumber-js/max</code>
                            , or
                            <code>libphonenumber-js/mobile</code>
                            . Alternatively, you can use
                            <code>libphonenumber-js/core</code>
                            and provide the required metadata explicitly to the utility functions.
                        </div>
