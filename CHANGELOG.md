...
- **core:** rename css variables (#13251)
...
- **kit:** `Badge` drop tui-badge selector (#12895)
...
- add `TUI_BREAKPOINT` token, drop `TuiBreakpointService` service (#12642)
  ([288a8d3](https://github.com/taiga-family/taiga-ui/commit/288a8d3f383ebcc16e5517de90079710cb2e135f))
- `Table` drop legacy (#12626)
  ([2d23c87](https://github.com/taiga-family/taiga-ui/commit/2d23c871f348773f5ba41fe86ab65cd0dd6a8eea))
...
- **core:** drop Angular animations (#12688)
...
- `Amount`, `Decimal` pipes refactor to signal (#12594)
  ([6308a08](https://github.com/taiga-family/taiga-ui/commit/6308a0810b580dfb8fe76ffad85074b1ce25d1cd))
- `InputRange`, `InputMonthRange`, `InputDateTime`, `InputNumber`, `Input` delete legacy components (#12590)
  ([342f03d](https://github.com/taiga-family/taiga-ui/commit/342f03dbbd152cc8924b2072b10f28ed3585eb51))
- `InputSlider` delete legacy component (#12576)
  ([eb01404](https://github.com/taiga-family/taiga-ui/commit/eb014041e518948f26d7a495333c0fa881d70493))
...
- resolve valid base href (#12569)
  ([64f3e60](https://github.com/taiga-family/taiga-ui/commit/64f3e60310c7ba7c5a0571c4a909a6588425da59))
- `Multiselect`, `InputTag`, `Tag`, `Textarea` delete legacy components (#12556)
  ([c261eff](https://github.com/taiga-family/taiga-ui/commit/c261efff341d97ff510957802df62637d9c88782))
- **core:** load icons relative to the base href (#12432)
  ([82ae6ac](https://github.com/taiga-family/taiga-ui/commit/82ae6ac6559f419c2753a33072883449dbe01f63))
- `FormatNumber` pipe refactor to signal (#12441)
  ([a49d2bf](https://github.com/taiga-family/taiga-ui/commit/a49d2bf81a77cbabcde5cf5ac64d192f01cfca27))
- **core:** `Dialogs` remove the wrapper (#12448)
  ([788720e](https://github.com/taiga-family/taiga-ui/commit/788720e2e2e98d322934cf797f1884ecfdea89ea))
- `TUI_NUMBER_FORMAT` refactor to signals (#12397)
  ([e10379c](https://github.com/taiga-family/taiga-ui/commit/e10379c837d0894601a472867f8b525864ab0788))
- `TUI_DATE_FORMAT` refactor to signals (#12373)
  ([9806e91](https://github.com/taiga-family/taiga-ui/commit/9806e912e30ca7a6cde7e082b4b9cc0db907e6c3))
- **core:** `tui-loader[showLoader]` renamed to `tui-loader[loading]` (#12215)
  ([b4afe74](https://github.com/taiga-family/taiga-ui/commit/b4afe7471d716cf2752e0ffc5320bbeeb147293b))
- **core:** `Modal` add new component to move dialogs to master portal (#12275)
  ([49e5936](https://github.com/taiga-family/taiga-ui/commit/49e59360d32e563adbc327e0248f08f0e7bbe1b0))
...
- **core:** `Alerts` drop dedicated portal and related infrastructure (#12213)
  ([a9c5030](https://github.com/taiga-family/taiga-ui/commit/a9c5030ce7dbb2b798e8c2f77d2cb291fc199fc9))
- **core:** `Popups` use single portal container for dropdowns, alerts and push notifications (#12195)
  ([0574645](https://github.com/taiga-family/taiga-ui/commit/057464561bae50279d5a2eb81f61ad2eb3f6d22d))
- **kit:** slider controls drop backward compatibility for legacy approach of `keySteps` (#12154)
  ([76276ca](https://github.com/taiga-family/taiga-ui/commit/76276ca9aa43e3e971281aabf958522fb2e282a2))
...
- **kit:** `tui-slider-ticks-labels` remove backward compatibility for legacy controls (#12065)
  ([94ba9bd](https://github.com/taiga-family/taiga-ui/commit/94ba9bd46be09ccf2575e86c9005439ecc012068))
...
- **core:** `Dialog` use experimental version, move old to legacy (#12127)
  ([62eda27](https://github.com/taiga-family/taiga-ui/commit/62eda27f95587fb9481ce2b7d9499837f29a672a))
- new browser support (#12133)
  ([11934ca](https://github.com/taiga-family/taiga-ui/commit/11934ca498cb92146279507a2286056e75fb2e88))
- **kit:** replace `Accordion` and `Expand` with new implementations (#12115)
  ([7b16f44](https://github.com/taiga-family/taiga-ui/commit/7b16f44cb1d59703bd4cfa89b29625dc32809393))
- **layout:** move `Cell` & `Header` to core, add appearance to `Card`, drop it from `Surface` (#12116)
...
- **kit:** `Avatar` drop component selector (#11920)
...
- **addon-doc:** defer syntax highlighting until browser idle (#13567)
  ([ad3f224](https://github.com/taiga-family/taiga-ui/commit/ad3f224f34e566271d0c08407d3d45a38810a920))
...
- **kit:** `tui-calendar-range` add period list size config (#13531)
  ([7c1609c](https://github.com/taiga-family/taiga-ui/commit/7c1609c62dba77f0fef42d491d774b2d5b384b92))
- **cdk:** add `tuiTruncate` (#12467)
  ([2db505c](https://github.com/taiga-family/taiga-ui/commit/2db505ce0dde8b9eae3d36d606d1fba0f25cfae0))
...
- **kit:** `Avatar` with badge supports RTL (#13496)
  ([87e0cab](https://github.com/taiga-family/taiga-ui/commit/87e0cab8132ed3fc910f250b6bdf2a268a54e5a9))
- **kit:** `Accordion` improve accessibility (#13486)
  ([9708ee4](https://github.com/taiga-family/taiga-ui/commit/9708ee4bf01e89fa84d4ceed3e26fcec7ec39c08))
- **kit:** `Pin` supports RTL (#13491)
  ([640f169](https://github.com/taiga-family/taiga-ui/commit/640f169a218d5ac8c0267c70682a6c8569074c80))
- **addon-commerce:** `ThumbnailCard` supports RTL (#13485)
  ([64f7a74](https://github.com/taiga-family/taiga-ui/commit/64f7a743c47c1ca4a163781b461c37816065ef01))
- **kit:** `Switch` supports RTL (#13482)
  ([9fe8825](https://github.com/taiga-family/taiga-ui/commit/9fe8825b913fe066db24bad3d897a24ef8553e94))
- **kit:** `ShrinkWrap` add component (#13441)
  ([0bf2dcf](https://github.com/taiga-family/taiga-ui/commit/0bf2dcf54446f663d944d28df89e986cef795535))
...
- **kit:** add `tui-counter` (#13289)
  ([696c030](https://github.com/taiga-family/taiga-ui/commit/696c030d0a2022a07be478e0000cb85b497328b2))
- **core:** `DropdownA11y` add directive (#13326)
  ([efd526e](https://github.com/taiga-family/taiga-ui/commit/efd526ec9bff87fa31b03890b10795a14a8a8c6c))
- **cdk:** make `tuiSum` safe for decimal arithmetic (#13350)
  ([2cd1bd2](https://github.com/taiga-family/taiga-ui/commit/2cd1bd23f80c23a6d68f32af97bfc6284ca56ce3))
...
- **kit:** `InputChip` make chip hoverable in disabled mode (#13279)
  ([e41c90a](https://github.com/taiga-family/taiga-ui/commit/e41c90a435f39fca591e542acaac2dc4f9698cf9))
- **addon-mobile:** `SheetDialog` add button to closable string content (#13261)
  ([9e4c2af](https://github.com/taiga-family/taiga-ui/commit/9e4c2af61a275c62e27ed77795dce79039ed050f))
- **core:** dropdown aligned to host with root html zoom (#13232)
  ([17f9494](https://github.com/taiga-family/taiga-ui/commit/17f94942963f3b78a0cf6c1eb6650c36395036bb))
- **kit:** compatibility `tuiInputNumber` with zoneless (#13230)
  ([93fa843](https://github.com/taiga-family/taiga-ui/commit/93fa84327cc806d31ce8f515eeda2c7263bba1ea))
- **core:** add `--tui-font-ui-2xs` (#12877)
  ([673e95b](https://github.com/taiga-family/taiga-ui/commit/673e95b4178444910ec77012a3e864b7ae7cefc6))
...
- **core:** `Loader` use display: grid (#13192)
  ([cd2d862](https://github.com/taiga-family/taiga-ui/commit/cd2d8624fc96992f1e105604a2f24d0cf4ecd0b6))
- **cdk:** `tuiFontSizeWatcher` support `env(preferred-text-scale)` (#13205)
...
- **layout:** use signals in `tui-elastic-container` (#13163)
  ([585c3dc](https://github.com/taiga-family/taiga-ui/commit/585c3dca33f13ed5c28002080c253a116fce5b9c))
- **addon-mobile:** `SwipeAction` add onboarding animation (#13157)
  ([2280631](https://github.com/taiga-family/taiga-ui/commit/22806312f9492d108ba3cf7b182fae9ddb74e3aa))
- **addon-mobile:** `SwipeActions` disable right-side overscroll (#13156)
  ([ef7aa84](https://github.com/taiga-family/taiga-ui/commit/ef7aa84f3cc9be86606e795c8c26478f287a7e34))
- **kit:** improve tabs underline performance (#11932)
  ([06f29db](https://github.com/taiga-family/taiga-ui/commit/06f29db709aef188c8843c60ee211bdeeb575912))
- **kit:** add `tuiButtonCopy` (#12989)
  ([256659f](https://github.com/taiga-family/taiga-ui/commit/256659f910c91beaf81c8bf8be0fb00d960fda78))
- **kit:** add ability to use copy directive with textfield multi (#13096)
  ([7bb8125](https://github.com/taiga-family/taiga-ui/commit/7bb8125e87093afb6b789b3b04827d09c94232d3))
- **core:** implement version encapsulation for global styles (#13075)
  ([439e40f](https://github.com/taiga-family/taiga-ui/commit/439e40fa0cfd9460b6befd3b3aeb6ad0b740c487))
...
- **core:** add ability to copy multiselect content (#13039)
  ([adce1c3](https://github.com/taiga-family/taiga-ui/commit/adce1c37e938c922267f0cbb9a2fd2127dc95c49))
- **kit:** add `tuiList` directive (#12830)
  ([1db2ca0](https://github.com/taiga-family/taiga-ui/commit/1db2ca04a69d3eeb5a55b0a0db08a91fffaa53cd))
- **addon-doc:** add Table of Contents component (#13002)
  ([f7d01f7](https://github.com/taiga-family/taiga-ui/commit/f7d01f741ef5260488e1e50a6fab4aea9542ec59))
- **i18n:** `Back` add (#13045)
  ([beb8cb7](https://github.com/taiga-family/taiga-ui/commit/beb8cb70e093e33225d5e252d454bddcabbc1500))
- **core:** add cell `:active` state on mobile (#12854)
  ([93e20cc](https://github.com/taiga-family/taiga-ui/commit/93e20cc7ee51b612a62d9c382a56e002333c10ba))
...
- **core:** make line height grow with increased font size (#12756)
  ([b6d5720](https://github.com/taiga-family/taiga-ui/commit/b6d5720c787cd2b963953c7be098a6eedd981b67))
- **core:** add `TUI_FONT_OFFSET` signal token (#12690)
  ([74fae71](https://github.com/taiga-family/taiga-ui/commit/74fae71f00131f6ca9d00812cc528bd9b54b5f41))
- **core:** `Hint` make offset configurable (#12689) (#12753)
  ([c75d2d8](https://github.com/taiga-family/taiga-ui/commit/c75d2d8262facd3dfa8c32d7d0e45f92c7ae38ad))
...
- **cdk:** milliseconds just be a non-negative integer (#12712)
  ([1e6195f](https://github.com/taiga-family/taiga-ui/commit/1e6195fcb9da807f96e6470269e70c8e408210c5))
- **addon-doc:** new design for header component (#12673)
  ([7749612](https://github.com/taiga-family/taiga-ui/commit/77496122c5a4df7b4d56b74d54aa2ba9311b6516))
...
- **kit:** add screen reader support to preview-zoom component (#12517)
  ([8ad595d](https://github.com/taiga-family/taiga-ui/commit/8ad595dd2b4cbcfa1cb82fb7ec26abee85f4a627))
...
- **kit:** `ButtonSelect` add ability to work with array (#12530)
  ([0587392](https://github.com/taiga-family/taiga-ui/commit/0587392bfbb52a59cdbe748ed57a4f5d4ebe7cdb))
...
- **kit:** align close button to top for closable preset in tuiCell (#12360)
  ([366c036](https://github.com/taiga-family/taiga-ui/commit/366c0364e7a66429917e7234a85383c1816014c5))
- **core:** `Hint` move into popups portal (#12218)
  ([6ce304e](https://github.com/taiga-family/taiga-ui/commit/6ce304ec9c0735b11ece99df1b491ce50672170f))
- **kit:** update chip according to specs (#12176)
...
- **core:** support empty appearance (#12197)
  ([a83c038](https://github.com/taiga-family/taiga-ui/commit/a83c0386a40545497ca1fad0faa791749bc541c8))
...
- **kit:** `InputRange` has new appearance for readonly/disabled state (#12122)
  ([c11bf51](https://github.com/taiga-family/taiga-ui/commit/c11bf512ce0da0ab0b7b15bdb1b4bdc8cceadb31))
- **addon-mobile:** `DropdownMobile` use `SheetDialog` (#12129)
  ([3de52cb](https://github.com/taiga-family/taiga-ui/commit/3de52cb662c33a6a33d8be73b7f1b1c61e3bcb90))
- **kit:** `Toast` add new component (#12104)
  ([c898818](https://github.com/taiga-family/taiga-ui/commit/c8988189fd68d9adff70cfc699b50fc081a24da6))
- **kit:** `InputSlider` has new paddings for slider track (#12063)
  ([e3083f8](https://github.com/taiga-family/taiga-ui/commit/e3083f8c288231489f53cc3d99ca753387cf1e65))
- **kit:** `InputSlider` hides slider for non-interactive state (#12061)
  ([772404b](https://github.com/taiga-family/taiga-ui/commit/772404b42aadbef38664a7bd84fdeb38aab92f80))
- **kit:** `ConfirmService` allow component customization (#12053)
  ([75221b0](https://github.com/taiga-family/taiga-ui/commit/75221b069d9e80a4529026f118c3e25d2f2cd230))
- **kit:** `Rating` add `filled` to icon context and allow background customization (#12046)
  ([a9dfd7a](https://github.com/taiga-family/taiga-ui/commit/a9dfd7a2f116f882310ef5e89b89964afdc30a59))
...
- **kit:** more intuitive way for users to remove input chips by backspace (#12039)
  ([be60adc](https://github.com/taiga-family/taiga-ui/commit/be60adc2f7eb4e3a7db010c7b88979dc36b7bc39))
- **core:** `Dialogs` auto attach to current active zone (#12018)
  ([73db449](https://github.com/taiga-family/taiga-ui/commit/73db4496f389554b476c93f2af7924aeb6ecac1a))
...
- **addon-commerce:** `InputCardGroup` add 'm' size (#11948)
  ([4b19e42](https://github.com/taiga-family/taiga-ui/commit/4b19e42dd351a736879ce94d8d385796124014c3))
...
- **demo-playwright:** add scrollbar & dropdown performance tests (#11653)
  ([e1d8095](https://github.com/taiga-family/taiga-ui/commit/e1d809564d7129682c6b8a7e592abbaca85cf418))
- **addon-mobile:** `SheetDialog` add basic HTML support (#11857)
  ([186d969](https://github.com/taiga-family/taiga-ui/commit/186d969250e25f2b8fee7e54c71b65c330ab509a))
...
- **core:** `ModalService` throws SSR error `TypeError: el?.getAnimations is not a function` (#13687)
  ([233f1cd](https://github.com/taiga-family/taiga-ui/commit/233f1cd0dd507763534ac952226be7e910abfc9f))
- **kit:** `InputPhoneInternational` use imports from libphonenumber-js/core (#13678)
...
- **kit:** `tuiConnected` vertical line gap on android/ios (#13665)
...
- **kit:** fix text `Skeleton` (#13656)
  ([2aef133](https://github.com/taiga-family/taiga-ui/commit/2aef1337e4cf3f48fe5bfb42006f6077b3323abb))
- **layout:** `Card` fix styles (#13650)
  ([1f97be1](https://github.com/taiga-family/taiga-ui/commit/1f97be1d13c7d98b72b0e72705d3d290724320b2))
- **kit:** `TuiConnected` padding 1rem for `tuiCell` (#13659)
  ([9bb6cf2](https://github.com/taiga-family/taiga-ui/commit/9bb6cf20b2b83aefcb0f01b94f02fe0002f77383))
- **layout:** `Card` fix title gap on mobile (#13660)
  ([8272109](https://github.com/taiga-family/taiga-ui/commit/827210981ca213943d9ef15cbb805581801937d5))
- **core:** use child combinator for hover mode to prevent nested scrollbar activation (#13651)
  ([7fbd06b](https://github.com/taiga-family/taiga-ui/commit/7fbd06b61ad90b771378643ebc76ac6bb6fe823f))
- **core:** `Notification` fix mobile styles according to specs (#13654)
  ([7e5844f](https://github.com/taiga-family/taiga-ui/commit/7e5844fe6feae84578eaa918450f3d4646538ad9))
- **kit:** `ProgressBar` + `ProgressColorSegments` has jittering segments (#13610)
  ([5076a29](https://github.com/taiga-family/taiga-ui/commit/5076a29abfead9b9ad48307919c4bb6b685d82de))
- **kit:** numeric names causes badge visibility with same number (#13388) (#13442)
  ([f104550](https://github.com/taiga-family/taiga-ui/commit/f1045504d6d66a19da6b30fa62575cdaae3c575c))
- **core:** `tuiDropdownHover` closes immediately when hovered and clicked simultaneously (#13581)
  ([41d6aa0](https://github.com/taiga-family/taiga-ui/commit/41d6aa03094c213ce70c7f30cfd6e456a541bd5f))
- **core:** ensure textfield filler respects RTL mode (#13556)
  ([43c3553](https://github.com/taiga-family/taiga-ui/commit/43c3553bb9c574a3bdc7d39ebacfbb2d4048cf52))
- **core:** prevent overscroll bounce in modal and sheet-dialog (#13541)
  ([59c26bb](https://github.com/taiga-family/taiga-ui/commit/59c26bbb64b87603b0bbbe12447ac1d884d83ad8))
- **layout:** `FloatingContainer` fix jank when address bar showing in Firefox mobile (#13557)
  ([7731bc9](https://github.com/taiga-family/taiga-ui/commit/7731bc92c0aaa8681f57a2e74413c4ee901c1b1f))
- **cdk:** `Transitioned` fix the order of applying styles (#13560)
  ([694ceca](https://github.com/taiga-family/taiga-ui/commit/694ceca176030affeae9fcdb11ac7e1db93f6952))
...
- **kit:** update `tui-line-clamp` properly when toggling between empty and non-empty content (#13528)
  ([c476a50](https://github.com/taiga-family/taiga-ui/commit/c476a50ed6b70adc1d8c8a817ba62edf9786830a))
- **kit:** fix `toArray` in files validators to filter empty formats from trailing comma (#13526)
  ([06c96e4](https://github.com/taiga-family/taiga-ui/commit/06c96e4b5c816efae775cb44ee9face328ffc73b))
- **core:** `TextfieldMulti` fix ghost memory leak (#13529)
  ([68329fd](https://github.com/taiga-family/taiga-ui/commit/68329fd6e0268f2cf7c7781a603a1690e4a1c229))
- pin all peer dependency versions (#13481)
  ([f068d8d](https://github.com/taiga-family/taiga-ui/commit/f068d8d972c707e02a9ebfe2d6baf288c7e5023d))
- **kit:** `Input{Date,DateTime,Month,Time}` have broken native picker (#13407)
  ([7f80262](https://github.com/taiga-family/taiga-ui/commit/7f802625d6bab7ba3c44dd55fc9be59ab030fb9a))
- **schematics:** remove no more required explicit install of `@taiga-ui/event-plugins` for `ng add` (#13424)
  ([2f662cc](https://github.com/taiga-family/taiga-ui/commit/2f662cccfc9cf0a4600866356a467d979e90cf6b))
- **styles:** use relative imports inside (#13410)
  ([54dea89](https://github.com/taiga-family/taiga-ui/commit/54dea898338c149e21bf29e1cb29fe6ed22406ce))
- **kit:** make `InputNumber` with `[step]` safe for decimal arithmetic (#13353)
  ([5353654](https://github.com/taiga-family/taiga-ui/commit/535365405615330f0814110d83998d432060ae0e))
- **addon-mobile:** `DropdownMobile` fix visibility of inactive textfield (#13292)
  ([a49f686](https://github.com/taiga-family/taiga-ui/commit/a49f68615fdfb7c36b5d626c495ccfac74723e75))
- **cdk:** watch font size only on root (#13301)
  ([0e3bb94](https://github.com/taiga-family/taiga-ui/commit/0e3bb9439c26378f5752ef4a14ed623a777b0a0f))
- **cdk:** add `@taiga-ui/styles` to `ng-update.packageGroup` of `@taiga-ui/cdk` (#13311)
  ([3ff6780](https://github.com/taiga-family/taiga-ui/commit/3ff6780170e242c013334347f3d64fcbbd9a7597))
...
- **kit:** increase delay before scroll on `tuiInputChip` (#13299)
  ([96b20b0](https://github.com/taiga-family/taiga-ui/commit/96b20b0f2208422a6109563bf1136b919fdb1286))
- **addon-doc:** do not show content below content (#13272)
  ([bfe4a82](https://github.com/taiga-family/taiga-ui/commit/bfe4a8259091b108a62765f7752fa887d1344ee7))
- **core:** `Alert` fix simultaneous animations (#13278)
  ([bff5e5c](https://github.com/taiga-family/taiga-ui/commit/bff5e5cd651891519d04e4527722253148ecf5f4))
- **core:** selected text is not in the visible area, but the dropdown is still shown (#13270)
  ([a92246b](https://github.com/taiga-family/taiga-ui/commit/a92246b1b79fcff7af0ffc624c47620a00b140f1))
- **core:** `Hint` fix flicker on iOS (#13257)
  ([c1b28c8](https://github.com/taiga-family/taiga-ui/commit/c1b28c86cd786cd96a3e320008996474d3d8ade7))
- **core:** incorrect browser render on `tuiFade` (#13216)
  ([c8de585](https://github.com/taiga-family/taiga-ui/commit/c8de585e18b1a5a0bf5e75bb5e047e27b001b212))
...
- **core:** `TuiError` doesn't display error for already touched control (#13215)
  ([0158a11](https://github.com/taiga-family/taiga-ui/commit/0158a11ebffb899318905526e44d09bfb7016178))
- **core:** do not emit onChange on initialization of TuiItemsHandlersValidator (#13176)
  ([56e7f38](https://github.com/taiga-family/taiga-ui/commit/56e7f388300f7437138bd68bfee8ca458c3304df))
- **cdk:** `Transitioned` fix transition flicker (#13214)
  ([ef32cc3](https://github.com/taiga-family/taiga-ui/commit/ef32cc3dea648a920b687cdc2a270eeb0e419914))
- **core:** revert wrong display on `tui-textfield-item` (#13212)
  ([f997369](https://github.com/taiga-family/taiga-ui/commit/f9973699dfdf4598173f09cb112a18e03659f6e4))
- **kit:** `InputChip` fix pasting value with newlines (#13133)
  ([6f20ea3](https://github.com/taiga-family/taiga-ui/commit/6f20ea3607c519ba2a51087b3ecd7ea150f051df))
- **core:** tui-textfield still has `_disabled` class after enabling a control (#13193)
  ([9a26d61](https://github.com/taiga-family/taiga-ui/commit/9a26d619e848efdd6ae8161bca030ec38bd35e67))
...
- **addon-doc:** conditionally render line numbers for highlightAuto (#13185)
  ([34ba3da](https://github.com/taiga-family/taiga-ui/commit/34ba3da501e94805592b12e8f881cd993ba4ee81))
...
- **kit:** support zoneless for `tuiInputNumber` step (#13166)
  ([2164964](https://github.com/taiga-family/taiga-ui/commit/2164964aca629ec663200d3da5ad1127aed7203a))
...
- **core:** gaps between input chips are collapsing (#13147)
  ([97ade3b](https://github.com/taiga-family/taiga-ui/commit/97ade3bb9eb7926571423c80eecbeb7fd5b28fa9))
- **kit:** input chip filter should ignore empty stringified values (#13135)
  ([7b30b53](https://github.com/taiga-family/taiga-ui/commit/7b30b539670f83b8048f059d8b566fdba9db75df))
...
- **core:** hide webkit spin buttons (#13115)
  ([4343b47](https://github.com/taiga-family/taiga-ui/commit/4343b47695dcb42524a10e5a31f5df9192dd826a))
...
- **core:** update data-list paddings according to specs (#13033)
  ([09ee6d1](https://github.com/taiga-family/taiga-ui/commit/09ee6d1130eef68f7f169599a7eed32b8a4cb008))
- **kit:** `InputRange` not updating on blur (#13036)
  ([13f6957](https://github.com/taiga-family/taiga-ui/commit/13f6957fb261fad6157d0306cefe1acb7e8155cc))
- **layout:** new behavior for horizontal boundary of a scrolling area (#13022)
  ([c06b532](https://github.com/taiga-family/taiga-ui/commit/c06b5321567dd29a1a2a278899b10cc9c14441c3))
- **kit:** `InputChip` fix pasting with whitespace separator, fix caret position (#13020)
  ([26e65fa](https://github.com/taiga-family/taiga-ui/commit/26e65faa242a1874120cfc6fb949f51de8f453bb))
- **kit:** do not use `tuiFade` for sheet dialog (#12993)
  ([798c8dd](https://github.com/taiga-family/taiga-ui/commit/798c8dd64dbfa47c7a7c6ce3539dd2102848b9e4))
- **kit:** added zero blur padding for InputDateTime (#12944)
  ([953b6aa](https://github.com/taiga-family/taiga-ui/commit/953b6aa9b96cadb33545f22c1bfc2336d25abed0))
- **kit:** `InputChip` make chip hoverable in readonly mode (#12984)
  ([69a8b70](https://github.com/taiga-family/taiga-ui/commit/69a8b706e1e3bdabda3e105c610544d8abdb89d2))
- **cdk:** migration fails with `JavaScript heap out of memory` because of `allure-results` directory (#12931)
  ([92aade7](https://github.com/taiga-family/taiga-ui/commit/92aade78eeb6b66e8846dae54cd8fa8d4750c3fc))
- **kit:** `InputRange` with `size` = `m`/`s` has unexpected shift for `[content]` (#12857)
  ([2e92594](https://github.com/taiga-family/taiga-ui/commit/2e92594026d652ce2ba2ea70ad81d905d31613ab))
- **kit:** `Select` should ignore `Backspace`/`Delete` keyboard keys if cleaner is disabled (#12865)
  ([15491f6](https://github.com/taiga-family/taiga-ui/commit/15491f6200f0a7933b1cea66e20b097c97679010))
- **kit:** `TabsWithMore` duplicates tabs on client hydration (#12862)
  ([53dc649](https://github.com/taiga-family/taiga-ui/commit/53dc649a155940210a61e2c8e5b817728fe84bce))
- **addon-doc:** infer typing from `TuiRawLoaderContent` (#12845)
  ([9c7b1f0](https://github.com/taiga-family/taiga-ui/commit/9c7b1f037cff5b3fbe4ab877edf7cea5f498c53a))
- **kit:** `InputRange` with `[content]=[..., end]` has always invisible end textfield (#12848)
  ([7d2b68f](https://github.com/taiga-family/taiga-ui/commit/7d2b68f9a095a659b5c010218f48d762a1c117ea))
- **kit:** confirm content receives dialog context (#12831)
  ([fa846af](https://github.com/taiga-family/taiga-ui/commit/fa846af8c11d88a0eb26ff351405f5a8fd39b6ac))
- **addon-mobile:** center `ProgressBar` inside `AppBar` on android (#12731)
  ([217a686](https://github.com/taiga-family/taiga-ui/commit/217a686e15ca5e1b998f589af5f45600a2ced185))
- **core:** hover event from `TuiHint` faster than hover event of `TuiHintPointer` (#12780)
  ([1af8c92](https://github.com/taiga-family/taiga-ui/commit/1af8c92951518907614116645e7056689b2e6b73))
- **core:** add fallback for css variable `--t-side` (it is not defined during SSR) (#12783)
  ([763e67d](https://github.com/taiga-family/taiga-ui/commit/763e67d406f50410c8c2687f027af72e3fb1ef0f))
- update arc chart value input handling (#12250)
  ([2aba33b](https://github.com/taiga-family/taiga-ui/commit/2aba33b9a7326c9ae9e7ce7b774b695448f548d8))
- **layout:** `AppBarBack` fix font size on desktop (#12764)
  ([9319b3f](https://github.com/taiga-family/taiga-ui/commit/9319b3fb1913b7f8f08aa88706a3676fc48db311))
- **addon-table:** `Td` subtract 1px from padding to accommodate border (#12757)
  ([889bbb3](https://github.com/taiga-family/taiga-ui/commit/889bbb3e7290833db46e1020df027554057da234))
- **kit:** `Switch` fix icon position according to specs (#12747)
  ([aaaaa35](https://github.com/taiga-family/taiga-ui/commit/aaaaa354dd84bdd595c1c8dfe9dba7e567c80b8c))
- **core:** `Link` restyle according to the specs, drop [pseudo] input (#12691)
  ([e53e79e](https://github.com/taiga-family/taiga-ui/commit/e53e79e756f91682ab9fc62bb482a12a513337be))
- **addon-table:** `TableControl` fix empty list view (#12693)
  ([7d1c549](https://github.com/taiga-family/taiga-ui/commit/7d1c549900cae802d197cdead84dc7e648c8ff7f))
- **addon-commerce:** use logical css properties for `tui-input-card-group` (#12658)
  ([d64684b](https://github.com/taiga-family/taiga-ui/commit/d64684b212db1cd452d78b9ae49ed96cf7239190))
- all `Input*` throws `'imports' must be an array of components, directives, pipes, or NgModules` (#12671)
  ([ec64b51](https://github.com/taiga-family/taiga-ui/commit/ec64b51ca244dea1dec10c3f33feaf0a96010208))
- **kit:** use logical css properties for `tui-segmented` (#12652)
  ([d06fa6a](https://github.com/taiga-family/taiga-ui/commit/d06fa6aff36bc9471124faf9c62bac85495fd93e))
- **kit:** `Select` with native picker has invalid appearance for initial value (#12639)
  ([a49f012](https://github.com/taiga-family/taiga-ui/commit/a49f01258ee263faccff45be79bdf8dc40bab3ca))
- **kit:** impossible to select the first option in native `Select` without placeholder (#12526)
  ([5b08309](https://github.com/taiga-family/taiga-ui/commit/5b0830978a6aac046c3f9d29b1eed3efa553f146))
- **kit:** `inputChip` - add special character clearing (#12430)
  ([806702c](https://github.com/taiga-family/taiga-ui/commit/806702cc4024525dcc9c80a3303da99c215b1214))
- **kit:** `TuiTransitioned` matches multiple times (#12614)
  ([b2dd2c7](https://github.com/taiga-family/taiga-ui/commit/b2dd2c76cd3bcd4b95b0cb95689ea442bb6a4cc0))
- **layout:** support html in hint aside (#12610)
  ([d26c8e4](https://github.com/taiga-family/taiga-ui/commit/d26c8e4287fe61a0cdb8263eb3d240132cd24b85))
- **addon-table:** remove generic type constraint from `TuiTableSortPipe` (#12558)
  ([5bc418f](https://github.com/taiga-family/taiga-ui/commit/5bc418fb0b8f9a29af25d1d4d587320b0879fcfb))
- **cdk:** fix append month in backward direction for the last day of month in TuiDay (#12545)
  ([0581bae](https://github.com/taiga-family/taiga-ui/commit/0581baed3123f502c57e3f9028656dd8ac61e0a2))
- **layout:** `CardLarge` is not compatible with `Header` (font has CSS specificity problem) (#12544)
  ([3bc3141](https://github.com/taiga-family/taiga-ui/commit/3bc3141a648ec5d090742d787c32689db0c940da))
- **kit:** `InputNumber` with long `[prefix]`/`[postfix]` has invalid input length restriction (#12514)
  ([158b19f](https://github.com/taiga-family/taiga-ui/commit/158b19fdca3e719c861dd18a189c8da0051c7814))
- **layout:** fix app-bar-back padding inside dialog on desktop (#12499)
  ([675cb73](https://github.com/taiga-family/taiga-ui/commit/675cb734898f2b3e43283d45c5af213639c1faa0))
- **addon-charts:** line-chart shouldn't re-render when it goes out of viewport (#12505)
  ([c41655f](https://github.com/taiga-family/taiga-ui/commit/c41655f4471d1c1f1eca7f55d6122d47b86693a2))
- **layout:** app bar button font weight and style (#12504)
  ([ec61fc5](https://github.com/taiga-family/taiga-ui/commit/ec61fc53e26079c128818cb90dc8b2447438c151))
- **addon-mobile:** `BottomSheet` fix reacting to scroll in ios26 (#12482)
  ([23e2197](https://github.com/taiga-family/taiga-ui/commit/23e219770c179b4c36d2e69352fd2ce880bd15f1))
- `Present` workaround for ios26 (#12479)
  ([4276c99](https://github.com/taiga-family/taiga-ui/commit/4276c99e98ea715df57969e04e0132402cebd15e))
- **core:** `tuiLink` with `iconStart` has double transition (#12491)
  ([a43fa04](https://github.com/taiga-family/taiga-ui/commit/a43fa0480839954644022b0921d32cde3b3cc9df))
- **kit:** broken routable dialogs (#12442)
  ([3c029dd](https://github.com/taiga-family/taiga-ui/commit/3c029ddb8d52849497353bc0d5ee00e9626e3596))
- **addon-commerce:** introduce collapsed offset variables (#12409)
  ([fc8c064](https://github.com/taiga-family/taiga-ui/commit/fc8c06455210376c090b69415e55a6e5bbc5d231))
- **kit:** correct tooltip hint inside tui-textfield on iOS (#12331)
  ([7ef504e](https://github.com/taiga-family/taiga-ui/commit/7ef504e36b6c1ab4d512deddf8eb2d59f3efcffc))
- **kit:** `ProgressColorSegments` color misaligned with `ProgressSegmented` (#11946)
  ([491d107](https://github.com/taiga-family/taiga-ui/commit/491d107e2180ee36c57c90eb8ffca04208d7c643))
- **addon-doc:** `tuiRawLoad` is incompatible with esbuild loaders (#12269)
  ([03cd156](https://github.com/taiga-family/taiga-ui/commit/03cd1566c161bd6b80a1cb015d7c07857d187d9c))
- **cdk:** rename to correct migration warning for illustrations (#12248)
  ([46625cf](https://github.com/taiga-family/taiga-ui/commit/46625cf06dd104f01f45b96fca27fce3ccdecb26))
...
- **cdk:** `TuiDay` incorrectly appends month in backward direction (#12068)
  ([ac8d488](https://github.com/taiga-family/taiga-ui/commit/ac8d4886885cb1363f2656355a700e56b839f29c))
- **kit:** `InputSlider` has broken drag behavior for slider in Firefox (#12083)
  ([bca55f4](https://github.com/taiga-family/taiga-ui/commit/bca55f4d7253cde074b9acbfe50d279fe947b8f4))
- **cdk:** `Obscured` properly handle offscreen case (#12134)
  ([a2d045d](https://github.com/taiga-family/taiga-ui/commit/a2d045d4471b18257b89af7cd89932d5ae17ff27))
- **kit:** increase style specificity for disabled state (#12086)
  ([025ab6d](https://github.com/taiga-family/taiga-ui/commit/025ab6d5116627804e7a180d9f04d344ecc13ab4))
- **kit:** `MultiSelectGroup` fix empty view (#12076)
  ([29538eb](https://github.com/taiga-family/taiga-ui/commit/29538eb588319e0964ef69e839f6d99b5f9707be))
- **addon-mobile:** ensure default sorter always has a unique reference (#12080)
  ([519afd3](https://github.com/taiga-family/taiga-ui/commit/519afd38eebe8cca9460816016a91bf209283e84))
- **kit:** `TuiQuantumValueTransformer` has invalid default value (#12059)
  ([d0903ad](https://github.com/taiga-family/taiga-ui/commit/d0903ad0b823d097117fa625deae4f4552b7dd10))
- **addon-mobile:** close sheet dialog when navigating to a new route (#12038)
  ([49bed77](https://github.com/taiga-family/taiga-ui/commit/49bed773b73ec8288bb808195f975b93af55124d))
- **experimental:** `Dialog` fix `label` (#12027)
  ([36b5af3](https://github.com/taiga-family/taiga-ui/commit/36b5af3738c5c3eab592e3eb6a41e343de056875))
- **kit:** update pager by new specification (#11935)
  ([38dfc57](https://github.com/taiga-family/taiga-ui/commit/38dfc57886e5dd3665b177108249048d1ada7bdf))
- **cdk:** `Animated` fix memory leak (#11984)
  ([3a46f3f](https://github.com/taiga-family/taiga-ui/commit/3a46f3ff8ff6657e89edede4d3a24dbc02ca964b))
- **addon-mobile:** update button's spec (#11930)
  ([6819a49](https://github.com/taiga-family/taiga-ui/commit/6819a496ffb239593defae523a129def83593a3a))
- **kit:** `InputNumber` updateOn: "blur" (#11900)
  ([cc8f25d](https://github.com/taiga-family/taiga-ui/commit/cc8f25d3a43443e05bac98facf48dc6164bdce0c))
...
- **kit:** Safari bug where line clamp ellipsis doesn't hide properly (#11880)
  ([39f1dc7](https://github.com/taiga-family/taiga-ui/commit/39f1dc7fd4e6820a54aab333b5ad7264cf9c5663))
- **cdk:** `Transitioned` fix for `Textfield` and `Switch` (#11873)
  ([9d04fce](https://github.com/taiga-family/taiga-ui/commit/9d04fce9c994aef986b3ff82e2d607838e50e533))
- **core:** `TUI_DARK_MODE` factory effect in reactive context (#11852)
  ([c7296ca](https://github.com/taiga-family/taiga-ui/commit/c7296cad76a53a505abf3308d146eb55eb7c9923))
- **core:** `Fullscreen` add scroll (#11855)
  ([ffa8452](https://github.com/taiga-family/taiga-ui/commit/ffa84524081833af83a26bbe1fccc8846dad8809))
- **addon-commerce:** `InputCardGroup` label raised on first focus (#11830)
  ([394337e](https://github.com/taiga-family/taiga-ui/commit/394337ec68d537824535c74573ea0c3c891fbab8))

### ♻️ Refactoring

- **kit:** remove excessive `distinctUntilChanged` (#13627)
  ([ce71707](https://github.com/taiga-family/taiga-ui/commit/ce71707ae38348848a33218fb825683a436e6831))
- **cdk:** remove polymorpheus v5 workaround in TuiPortals (#13602)
  ([6d02856](https://github.com/taiga-family/taiga-ui/commit/6d028564b0372c572be9a831cf652af7fd89eabf))
- **addon-doc:** drop optional (#13564)
  ([7c8ed16](https://github.com/taiga-family/taiga-ui/commit/7c8ed16073803625c96b814dc6d60eff292a80a1))
- **legacy:** move deleted `taiga-ui-global.less` to `@taiga-ui/legacy` (#13576)
  ([b8a8ae8](https://github.com/taiga-family/taiga-ui/commit/b8a8ae8034946e508d7e187efa84beb6e5dd4a6a))
- use unique metadata in decorators (#13571)
  ([770d87d](https://github.com/taiga-family/taiga-ui/commit/770d87d10d6c286224eb2f7658fa47984b8920a4))
- **kit:** `CalendarRange` uses signal inputs (#13500)
  ([07d26f7](https://github.com/taiga-family/taiga-ui/commit/07d26f79fa736ca059102c37cfcebe833a9668ab))
- use logical css properties `inset-block-*` & `inset-inline-*` (#13479)
  ([b406e1c](https://github.com/taiga-family/taiga-ui/commit/b406e1c6d4d8d99ab00f528649c86e9fe6577313))
- use `viewChild` signal (#13483)
  ([28c97e3](https://github.com/taiga-family/taiga-ui/commit/28c97e31f705ddde1910ee80e899683446d6ab8d))
- remove `parameterName/newParameterName` and use `parameters` array (#13439)
  ([8ad47db](https://github.com/taiga-family/taiga-ui/commit/8ad47db2bd4bd4033c68560f1ee80fabb7bd1003))
- **core:** `CalendarMonth` uses signal inputs (#13405)
  ([985b538](https://github.com/taiga-family/taiga-ui/commit/985b5385b47190858d9630490fed07cf94aecc41))
- **core:** `Calendar` uses signal inputs (#13400)
  ([ea55f29](https://github.com/taiga-family/taiga-ui/commit/ea55f29fae59c357e6dd1817119284ca887a22fb))
- **core:** use signal inputs for `min`/`max` props in `Calendar{Range}` (#13364)
  ([c7cce16](https://github.com/taiga-family/taiga-ui/commit/c7cce161422e44d8298c76e5830208cde2d8596b))
- **core:** use signal inputs in `CalendarSpin` (#13332)
  ([163e385](https://github.com/taiga-family/taiga-ui/commit/163e3854f1e70f62aabebdc9b9f80a0d255380b9))
- **styles:** increase XS font size (#13384)
  ([b1aa42a](https://github.com/taiga-family/taiga-ui/commit/b1aa42ac705329dfaa426e375a64d58f7edba4d0))
- default value is useless because the property is not optional (#13328)
  ([8a85eeb](https://github.com/taiga-family/taiga-ui/commit/8a85eeb355af8ee202834ae0bf373f216a2d3dd8))
- **core:** use signal inputs in `CalendarYear` (#13325)
  ([cac8f52](https://github.com/taiga-family/taiga-ui/commit/cac8f528ebbcff0f667fff252b430346bc2958cb))
- **core:** use signal inputs in `CalendarSheet` (#13323)
  ([eabaf55](https://github.com/taiga-family/taiga-ui/commit/eabaf553ecb058efb61ec68063a670b0ada5f01b))
- reuse ghost element (#13284)
  ([7357491](https://github.com/taiga-family/taiga-ui/commit/73574916ae3bd907bf9898cdf69063b963f4b155))
- **core:** `Textfield` refactor icons according to the specs (#13123)
  ([662d82d](https://github.com/taiga-family/taiga-ui/commit/662d82d17a339f05761189772d4893d93d63518d))
- implement TODO in `tuiAppBarSize` (#13116)
  ([cf464ed](https://github.com/taiga-family/taiga-ui/commit/cf464ed5e72b597424f30fdf33b50b8357fd57db))
- Safari 14 doesn't support logical properties for float (#13113)
  ([d0b07a4](https://github.com/taiga-family/taiga-ui/commit/d0b07a49e92a83e3f208a1ad51960c54547222fb))
- compat with `@taiga-ui/configs` (#12964)
  ([d4c4dbe](https://github.com/taiga-family/taiga-ui/commit/d4c4dbe9194d2b088f31cd89dd7c4a2249b368ad))
- use `@angular/build` (#12886)
  ([ec3889b](https://github.com/taiga-family/taiga-ui/commit/ec3889b673b6c41f4901f7ff05f1f9537055e947))
- fix stretch (#12872)
  ([faf5d4c](https://github.com/taiga-family/taiga-ui/commit/faf5d4cfeea4ff741da0af126ff562b201b0f2f8))
- drop @shouldCall (#12860)
  ([49cc36f](https://github.com/taiga-family/taiga-ui/commit/49cc36ffb20b46dfd392cb44537ac5d8edee1e1c))
- **kit:** `ButtonClose` rename to `ButtonX` and move to core (#12853)
  ([4752788](https://github.com/taiga-family/taiga-ui/commit/47527885dfeecb12c21d3640d46d0814498b796e))
- drop `Pure` from most places (#12846)
  ([40d4ad8](https://github.com/taiga-family/taiga-ui/commit/40d4ad8544561b7dec937794fce5789e22c60b79))
- **experimental:** refactor to signals (#12841)
  ([7c53ccc](https://github.com/taiga-family/taiga-ui/commit/7c53ccc7acf5e2ccf3cd902ce78fb3e01aad248f))
- drop overcomplicated union helper (#12659)
  ([77b84e7](https://github.com/taiga-family/taiga-ui/commit/77b84e710e3f206de1ba18b3a11424b6d709b02d))
- refine chart inset shorthand placements (#12811)
  ([c42c416](https://github.com/taiga-family/taiga-ui/commit/c42c4168e42dd451b8854e99a0181ff8fea907eb))
- drop @tuiPure from some places (#12828)
  ([6665561](https://github.com/taiga-family/taiga-ui/commit/6665561a5e9c7aa26f1953fd92dac9d55dda8981))
- **kit:** finish rewriting to signals (#12823)
  ([8e11e01](https://github.com/taiga-family/taiga-ui/commit/8e11e0187103e2123f78035ba4662db9cdbbbe09))
- **addon-mobile:** `components` & `directives` use signal input (#12335)
  ([aeea546](https://github.com/taiga-family/taiga-ui/commit/aeea5468a18e98d70321155044a416b7c771f8d5))
- `Stepper` use cell (#12761)
  ([57f398e](https://github.com/taiga-family/taiga-ui/commit/57f398ea7f4c882fbce5f30affaf05c75cd760dd))
- **kit:** refactor children to signals (#12799)
  ([9505f2c](https://github.com/taiga-family/taiga-ui/commit/9505f2c984f7bd565b36d4acdfd8e9908fcb9013))
- **core:** rework table appearance (#12807)
  ([4fd5cf7](https://github.com/taiga-family/taiga-ui/commit/4fd5cf7766ff0156b3373071f321b759019540fc))
- **core:** `Textfield` move appearance to `tui-textfield` (#12710)
  ([1c4473a](https://github.com/taiga-family/taiga-ui/commit/1c4473a725b0e666a39bf6c87dcbc029627a6a50))
- **core:** migrate notification markup to directive (#12735)
  ([49575ff](https://github.com/taiga-family/taiga-ui/commit/49575ff549e66af761e3e6f5cc87fd5046ea960c))
- camelCase pattern for animation name (#12748)
  ([44fc911](https://github.com/taiga-family/taiga-ui/commit/44fc9118ef75f7d749bfac6c8fb16348b21a8c35))
- adjust font variable renames only (#12759)
  ([a501f88](https://github.com/taiga-family/taiga-ui/commit/a501f886c716e3454974fea8deddbbbf853d3839))
- **kit:** finalize directives and cleanup contribution (#12789)
  ([6c28851](https://github.com/taiga-family/taiga-ui/commit/6c28851285943c5e4b8a7f747b49b27547485098))
- **kit:** `components` uses signal (Part 1) (#12531)
  ([15d7347](https://github.com/taiga-family/taiga-ui/commit/15d7347289ce33d36c27917396d35fa40e3d9c90))
- `TuiAxes` uses signal inputs (#12278)
  ([4cf1458](https://github.com/taiga-family/taiga-ui/commit/4cf1458a12e12ebde29bd4590d7fd9ec7f3d4977))
- **kit:** `directives` use signals [final] (#12529)
  ([b9024aa](https://github.com/taiga-family/taiga-ui/commit/b9024aafb03469a437590c2149f067acb69438a6))
- **core:** drop positioning from table appearance (#12740)
  ([e35bcf1](https://github.com/taiga-family/taiga-ui/commit/e35bcf1a478023e9ff963f0e75d6e96169522653))
- **core:** `TextfieldMulti` change items height computation (#12743)
  ([24d6a1d](https://github.com/taiga-family/taiga-ui/commit/24d6a1dac35cf2ca39d80d6813b1604e10fe8967))
- **core:** `Cell` use in `Option` as host directive (#12666)
  ([00af578](https://github.com/taiga-family/taiga-ui/commit/00af5780505a68387e8dca66af324369655b6918))
- use short name (#12650)
  ([2cac9a6](https://github.com/taiga-family/taiga-ui/commit/2cac9a621513eb2e13608c9daf7e61a4a253aa39))
- **core:** `Textfield` rename base case to `Input` (#12643)
  ([5175ca2](https://github.com/taiga-family/taiga-ui/commit/5175ca2dc783575ef798ad0a053f8866ba2e67d3))
- signal (#12593) ([be37976](https://github.com/taiga-family/taiga-ui/commit/be3797605f36d61bf7326ef6f36856ed8cfcf661))
- **core:** first run over Core package (#12620)
  ([816db07](https://github.com/taiga-family/taiga-ui/commit/816db074b013b91e3060576241b805983f5c355f))
- **core:** `directives` use signals (#12384)
  ([7134684](https://github.com/taiga-family/taiga-ui/commit/7134684a537ea50f69553f24cb661f37e00d5c54))
- **core:** drop legacy options (#12613)
  ([b3b275a](https://github.com/taiga-family/taiga-ui/commit/b3b275aabd86a4d3fe27fb17ffe7d113a50a6728))
- no new array (#12605)
  ([811ffeb](https://github.com/taiga-family/taiga-ui/commit/811ffeb6d2a3b7740bf987368c94c1abb044f782))
- **addon-table:** `components` & `directives` use signal (#12351)
  ([4df95fb](https://github.com/taiga-family/taiga-ui/commit/4df95fb56dd7880bd5db1bc6f846e14407686243))
- **cdk:** remove dependency on animations (#12604)
  ([1bd9b2a](https://github.com/taiga-family/taiga-ui/commit/1bd9b2a1e6938b5092cf872501f5741b875bde4d))
- **core:** `Textfield` refactor to signals (#12592)
  ([6ee9658](https://github.com/taiga-family/taiga-ui/commit/6ee96585f57f66ada9e849618c138cd4bb18b9d6))
- switch some query lists to signals (#12580)
  ([e5a6c28](https://github.com/taiga-family/taiga-ui/commit/e5a6c288b2c06657f3163304b4a30753538f0c32))
- **cdk:** move some things around (#12581)
  ([02e3dbc](https://github.com/taiga-family/taiga-ui/commit/02e3dbc10f0bdd427605fa0383ddde9143a6250a))
- **cdk:** `Transitioned` optimize (#12183)
  ([4def5a6](https://github.com/taiga-family/taiga-ui/commit/4def5a69bf76be46f692493c5ed4c5b8db4df564))
- **core:** `Datalist` uses signal inputs & queries (#12318)
  ([7ce63ba](https://github.com/taiga-family/taiga-ui/commit/7ce63bac74c64aac76e3413deff8e725602df299))
- **kit:** `Stepper` refactor to signal (#12578)
  ([de1f096](https://github.com/taiga-family/taiga-ui/commit/de1f09640ee4d69501ce1c8953bb0b838e242024))
- move `TuiPreviewDialogDirective` to `TuiPreview` (#12539)
  ([6a523d0](https://github.com/taiga-family/taiga-ui/commit/6a523d0de99933a62d9b7729ddd100214d7bc7f4))
- migrate option tokens to tuiCreateOptions (#12510)
  ([2fa3dd5](https://github.com/taiga-family/taiga-ui/commit/2fa3dd5a5826f880b56f2db1198e9614761fb947))
- **addon-doc:** uses input signals (#12357)
  ([c037e94](https://github.com/taiga-family/taiga-ui/commit/c037e941b1427739eaa37402876c7044d0dee2c2))
- **addon commerce:** `InputCardGroup` uses signal input (#12323)
  ([e7dae1f](https://github.com/taiga-family/taiga-ui/commit/e7dae1f7c2390835a96383b3b03c888ee4b6b8fb))
- **cdk:** `directives` use signal inputs (final changes) (#12383)
  ([22b30e3](https://github.com/taiga-family/taiga-ui/commit/22b30e315faf2be72f124a7e7a53123ce11219f0))
- **addon-mobile:** `SheetDialog` refactor to support header styles in template (#12466)
  ([39c57da](https://github.com/taiga-family/taiga-ui/commit/39c57dad6ffd403d220064d761be85304af85572))
- move alert demo to notification page (#12481)
  ([bda6650](https://github.com/taiga-family/taiga-ui/commit/bda6650cc13d17850c9c57dd7cb7da6f093ee2b7))
- **core:** drop dependency on `Header` (#12464)
  ([b17c7eb](https://github.com/taiga-family/taiga-ui/commit/b17c7ebb16033e2dfe9b2d5590d6d3e6c535f798))
- **kit:** fix circular dependency for `TUI_TREE_CONTENT` (#12461)
  ([bda8a13](https://github.com/taiga-family/taiga-ui/commit/bda8a1344361f629758a460293e8b86f2de7f444))
- **core:** fix circular dependency `DropdownDirective` <=> `DropdownPosition` (#12435)
  ([6d59235](https://github.com/taiga-family/taiga-ui/commit/6d592359065d644f835da004fb22512654036dfc))
- **core:** fix circular dependency `HintDirective` <=> `HintPosition` (#12438)
  ([64a706b](https://github.com/taiga-family/taiga-ui/commit/64a706b5cfe30c396a53138b099ca7c7cbaddf17))
- **kit:** `InputNumber` uses signal inputs (#12298)
  ([800c179](https://github.com/taiga-family/taiga-ui/commit/800c179f877c0de8678114cadbae4a517623e4fd))
- **core:** `tuiScrollbar` uses signal inputs (#12317)
  ([d8cdd40](https://github.com/taiga-family/taiga-ui/commit/d8cdd40cc5c7ba0832b3ae30ea9ca484beacbb0e))
- **cdk:** switch `Tuilet` to `@let` (#12302)
  ([a2b0059](https://github.com/taiga-family/taiga-ui/commit/a2b00591219ea8c38d400c1c54a22ae03f75fdd9))
- **kit:** `FluidTypography` uses Signal Inputs (#12220)
  ([e4a03e1](https://github.com/taiga-family/taiga-ui/commit/e4a03e1ff8d33ba32db157db1858b38bdfa935cf))
- **core:** `TuiNotification` uses signal inputs (#12316)
  ([6a5d370](https://github.com/taiga-family/taiga-ui/commit/6a5d3708fe2c33c0368159b4afbcabfe5c363457))
- **cdk:** remove `tuiIsApple` and `TuiiOS` (#12282)
  ([717264b](https://github.com/taiga-family/taiga-ui/commit/717264bb37f671a0eb2d410f9644199b10d56a1a))
- **kit:** `NativeSelect` uses signal inputs (#12226)
  ([90aed1b](https://github.com/taiga-family/taiga-ui/commit/90aed1bb3b9b02d8ba20b597e0a2f1206b3cc0a0))
- **core:** `Textfield` uses Signal Inputs (#12217)
  ([d69ec59](https://github.com/taiga-family/taiga-ui/commit/d69ec59f6bcece7768a7f00aba14f8b815557af2))
- **core:** `TuiLink` uses signal inputs (#12319)
  ([bc5f7aa](https://github.com/taiga-family/taiga-ui/commit/bc5f7aa8c8cf21b093cfd97d909050afc986842c))
- **core:** `SpinButton` uses Signal Inputs (#12216)
  ([55f3817](https://github.com/taiga-family/taiga-ui/commit/55f3817aa6d2967b2c26d802f6cc62a2ae47b8d0))
- **kit:** `Range` uses signal inputs (#12221)
  ([24b9889](https://github.com/taiga-family/taiga-ui/commit/24b98893436802b2ab095fcc2122dcd6df868278))
- **kit:** `InputTime` uses signal inputs (#12228)
  ([7025791](https://github.com/taiga-family/taiga-ui/commit/702579110f940b4a3f07d1a9f9929962b05edf0b))
- **core:** `Textfield` refactor options to signal inputs (#12170)
  ([eb5ffe3](https://github.com/taiga-family/taiga-ui/commit/eb5ffe3c6b56eef02964684bffaf99cb51aebce8))
- **kit:** convert textarea-limit inputs to Signal Inputs (#12227)
  ([949b4e9](https://github.com/taiga-family/taiga-ui/commit/949b4e90ef7ba8c8008d81ad8942400fcb398e38))
- **cdk:** remove TUI_ALLOW_SIGNAL_WRITES (#12251)
  ([c6aecba](https://github.com/taiga-family/taiga-ui/commit/c6aecba79b0cc518c2ff72a885c1448187f8ce70))
- enable `@angular-eslint/consistent-component-styles` eslint rule (#12192)
  ([c335cab](https://github.com/taiga-family/taiga-ui/commit/c335cab2bfec2e241b844b3e5d7070a72e09afd5))
- **cdk:** simplify portals (#12180)
  ([efab715](https://github.com/taiga-family/taiga-ui/commit/efab715a96b1a1cc49885372a387ac762cdaba2f))
- **core:** `*tuiTextfieldDropdown` rename to `*tuiDropdown` (#12155)
  ([e0c84fd](https://github.com/taiga-family/taiga-ui/commit/e0c84fdf65969fdd754da734e693c90059220cee))
- change some inputs to signals
  ([8943eb6](https://github.com/taiga-family/taiga-ui/commit/8943eb6fad427ce8bca5b3802748a5db86d6f8f7))
- rename tuiIsNativeFocused, tuiIsNativeFocusedIn, tuiGetNativeFocused functions (#12012)
  ([ef2d937](https://github.com/taiga-family/taiga-ui/commit/ef2d9375053d4f229cea0d20fc3cde93cdf2e831))
- **kit:** refactor all toggles to use `Icons` directive (#11966)
  ([664cf21](https://github.com/taiga-family/taiga-ui/commit/664cf21b25a8739afd8c7330985fd0436020c201))
- **core:** `Icon` use `Icons` host directive (#11893)
  ([012ee57](https://github.com/taiga-family/taiga-ui/commit/012ee57d9e5a9ee21f2aa5e763a9f3aebb0829cc))
- drop `any` keyword in mobile calendar dropdown (#11716)
  ([c358688](https://github.com/taiga-family/taiga-ui/commit/c358688c27e5051d8c6706fe3091617806e9500b))
- drop `any` from addon-table (#11717)
  ([afa7c81](https://github.com/taiga-family/taiga-ui/commit/afa7c8196e01c43e33b89b120f0aa630f33c4c50))
