 ...
 */
/** @type {?} */
var PREBOOT_NONCE = new InjectionToken('PrebootNonce');
...
var EventReplayer = /** @class */ (function () {
    ...
    function (appData, prebootEvent) {
        ...
        /** @type {?} */
        var event = (/** @type {?} */ (prebootEvent.event));
        /** @type {?} */
...
function getEventRecorderCode() {
    ...
    for (var funcName in eventRecorder) {
        if (eventRecorder.hasOwnProperty(funcName)) {
            /** @type {?} */
            var fn = ((/** @type {?} */ (eventRecorder)))[funcName].toString();
            /** @type {?} */
...
function getInlineDefinition(customOptions) {
    /** @type {?} */
    var opts = (/** @type {?} */ (assign({}, defaultOptions, customOptions)));
...
/** @type {?} */
var PREBOOT_OPTIONS = new InjectionToken('PrebootOptions');
/**
 * @param {?} doc
 * @param {?} nonce
 * @param {?} inlineCode
...
function PREBOOT_FACTORY(doc, prebootOpts, nonce, platformId, appRef, eventReplayer) {
    return function () {
        ...
        if (isPlatformBrowser(platformId)) {
            ...
            if (replay) {
                appRef.isStable
                    .pipe(filter(function (stable) { return stable; }), take(1)).subscribe(function () {
...
//# sourceMappingURL=preboot.es5.js.map
