...
class EventReplayer {
    ...
    replayEvent(appData, prebootEvent) {
        ...
        /** @type {?} */
        const event = (/** @type {?} */ (prebootEvent.event));
        /** @type {?} */
...
function initAll(opts, win) {
    /** @type {?} */
    const theWindow = (/** @type {?} */ ((win || window)));
    // Add the preboot options to the preboot data and then add the data to
    // the window so it can be used later by the client.
    // Only set new options if they're not already set - we may have multiple app roots
    // and each of them invokes the init function separately.
    /** @type {?} */
    const data = (theWindow.prebootData = (/** @type {?} */ ({
        opts: opts,
        apps: [],
        listeners: []
    })));
...
function start(prebootData, win) {
    ...
    const theWindow = (/** @type {?} */ ((win || window)));
    /** @type {?} */
    const _document = (/** @type {?} */ ((theWindow.document || {})));
    ...
    /** @type {?} */
    const opts = prebootData.opts || ((/** @type {?} */ ({})));
    /** @type {?} */
    ...
    /** @type {?} */
    const appData = (/** @type {?} */ ({ root: appRoot, events: [] }));
    if (prebootData.apps) {
 ...
 * @return {?} ServerClientRoot An array of root info for the current app
 */
...
function createListenHandler(_document, prebootData, eventSelector, appData) {
    ...
    return function (event) {
        ...
        if (opts && !opts.disableOverlay && eventSelector.freeze) {
            /** @type {?} */
            const overlay = (/** @type {?} */ (root.overlay));
            // show the overlay
...
function createBuffer(root) {
    ...
    /** @type {?} */
    const rootClientNode = (/** @type {?} */ (serverNode.cloneNode(false)));
...
function getEventRecorderCode() {
    ...
    for (const funcName in eventRecorder) {
        if (eventRecorder.hasOwnProperty(funcName)) {
            /** @type {?} */
            const fn = ((/** @type {?} */ (eventRecorder)))[funcName].toString();
            /** @type {?} */
 ...
 * @return {?} Generated inline preboot code with just functions definitions
 * to be used separately
 */
function getInlineDefinition(customOptions) {
    /** @type {?} */
    const opts = (/** @type {?} */ (assign({}, defaultOptions, customOptions)));
 ...
 *
 * @return {?} Generated inline preboot code with just invocations of functions from
 * getInlineDefinition
 */
...
export { getNodeKeyForPreboot, PREBOOT_NONCE, _window, EventReplayer, initAll, start, createOverlay, getAppRoot, handleEvents, createListenHandler, getSelection, createBuffer, getEventRecorderCode, getInlineDefinition, getInlineInvocation, validateOptions, assign, stringifyWithFunctions, initFunctionName, defaultOptions, PrebootModule, PREBOOT_FACTORY as ɵb, PREBOOT_OPTIONS as ɵa, PREBOOT_PROVIDER as ɵc };
