...
MarkdownService.ɵfac = function MarkdownService_Factory(t) { return new (t || MarkdownService)(ɵngcc0.ɵɵinject(PLATFORM_ID), ɵngcc0.ɵɵinject(ɵngcc1.HttpClient, 8), ɵngcc0.ɵɵinject(ɵngcc2.DomSanitizer), ɵngcc0.ɵɵinject(MarkedOptions)); };
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(MarkdownService, [{
        type: Injectable
                ...
                type: Optional
            }] }, { type: ɵngcc2.DomSanitizer }, { type: MarkedOptions }]; }, null); })();
...
MarkdownComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: MarkdownComponent, selectors: [["markdown"], ["", "markdown", ""]], inputs: { katex: "katex", lineNumbers: "lineNumbers", lineHighlight: "lineHighlight", data: "data", src: "src", katexOptions: "katexOptions", start: "start", line: "line", lineOffset: "lineOffset" }, outputs: { error: "error", load: "load", ready: "ready" }, features: [ɵngcc0.ɵɵNgOnChangesFeature], ngContentSelectors: _c0, decls: 1, vars: 0, template: function MarkdownComponent_Template(rf, ctx) { if (rf & 1) {
