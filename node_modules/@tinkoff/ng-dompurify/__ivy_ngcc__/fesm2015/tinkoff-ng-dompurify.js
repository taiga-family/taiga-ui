...
NgDompurifySanitizer.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: NgDompurifySanitizer, factory: NgDompurifySanitizer.ɵfac, providedIn: 'root' });
/** @nocollapse */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NgDompurifySanitizer, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
...
NgDompurifyPipe.ɵfac = function NgDompurifyPipe_Factory(t) { return new (t || NgDompurifyPipe)(ɵngcc0.ɵɵdirectiveInject(NgDompurifySanitizer), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.DomSanitizer)); };
NgDompurifyPipe.ɵpipe = ɵngcc0.ɵɵdefinePipe({ name: "dompurify", type: NgDompurifyPipe, pure: true });
/** @nocollapse */
NgDompurifyPipe.ctorParameters = () => [
    { type: NgDompurifySanitizer },
    { type: DomSanitizer }
];
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NgDompurifyPipe, [{
        type: Pipe,
        args: [{ name: 'dompurify' }]
...
NgDompurifyModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: NgDompurifyModule });
NgDompurifyModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function NgDompurifyModule_Factory(t) { return new (t || NgDompurifyModule)(); } });
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NgDompurifyModule, [{
        type: NgModule,
        args: [{
